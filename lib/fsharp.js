    ...
    var __ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg4)
    {
      ...
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _4738 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _4738 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _4738;
          var _4748;
          ...
          else
          {
            if (flag) 
            {
              _4748 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").last()).find(" span.word-container .word")).text());
            }
            else
            {
              _4748 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").first()).find(" span.word-container .word")).text());
            };
          };
          var text = _4748;
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              {
                _3888 = dist((___i - 1))((___j - 1));
              }
              else
              {
                _3888 = AutocompleteProvider__min3$Int32_Int32((dist((___i - 1))(___j) + 1), (dist(___i)((___j - 1)) + 1), (dist((___i - 1))((___j - 1)) + 1));
              };
              var dval = _3888;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _4119;
      return Seq__Enumerator$Completion_Completion_(f(_4119));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _4290;
      return Seq__Enumerator$Object_Object_(f(_4290));
    }));
});
