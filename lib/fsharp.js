...
AutocompleteProvider__create$ = (function(unitVar0)
{
    var ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg1)
    {
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        ...
        var handler = (function(_unitVar0)
        {
          var selected = ViewsHelpers__jq$("li.selected span.word-container .word");
          var text = (selected.text());
          LanguageService__helptext$(text);
        });
        var _ignored0 = (e.on("did-select-next", handler));
        var __ignored0 = (e.on("did-select-previous", handler));
        ...
        if (((AutocompleteProvider__isForced || Option__IsNone$CompletionResult_CompletionResult_(AutocompleteProvider__lastResult)) || (options.prefix == "."))) 
        {
          Events__once$Object__Unit_Object__Unit_((new EventType__Errors()), (function(_arg1)
          {
            Events__once$CompletionResult__Unit_CompletionResult__Unit_((new EventType__Completion()), (function(result)
            {
              ...
              return resolve(Seq__ToArray$Object_Object_(Seq__Map$Completion__Object_Completion__Object_((function(t)
              {
...
ErrorPanel__createRow$ = (function(editor,e)
{
    ...
    })(e.StartLine)(e.StartColumn)(e.Message)(e.Severity)(e.Subcategory));
    return (t.click((function(x)
    {
      return (editor.setCursorBufferPosition([(e.StartLine - 1), (e.StartColumn - 1)]));
    })));
});
...
Events__emitEmpty$String_1String = (function(t,s)
{
    ...
    var _307;
    return (Events__emitter.emit(name, _307));
});
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      ...
      {
        _4709 = "highlight-symboluse-declaration";
      }
      else
      {
        _4709 = "highlight-symboluse";
      };
      var cls = _4709;
...
HighlighterHandler__handle$ = (function(o)
{
    ...
    var action = (function(item)
    {
      ...
      {
        _1337 = "highlight-warning";
      }
      else
      {
        _1337 = "highlight-error";
      };
      var cls = _1337;
...
Interactive__handleLocation$ = (function(n)
{
    ...
    if (Process__isWin$()) 
    {
      _4352 = (path.join(n.Data, "fsi.exe"));
    }
    else
    {
      _4352 = "fsharpi";
    };
    Interactive__fsipath = _4352;
...
Process__notice$ = (function(currentNotification,isError,text,details)
{
    ...
    if ((matchValue.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _2864 = (((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true))));
      }
      else
      {
        _2864 = (((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true))));
      };
      var n = _2864;
...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _4374 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _4374;
...
Process__spawnWithNotifications$ = (function(location,linuxCmd,cmd)
{
    ...
    {
      _2661 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _2661;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
    var _2677;
    if (Process__isWin$()) 
    {
      _2677 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _2677 = (child_process.spawn(linuxCmd, prms, options));
    };
    var procs = _2677;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _5003;
      return Seq__Enumerator$Completion_Completion_(f(_5003));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _3891;
      return Seq__Enumerator$Object_Object_(f(_3891));
    }));
});
...
ToolbarHandler__format_data$ = (function(tinfo)
{
    ...
    if (String__StartsWith$(ti_, "type")) 
    {
      ...
      _2457 = ti_.substring(0, 0 + (_idx - 1));
    }
    else
    {
      _2457 = ti_;
    ...
    return Option__Iterate$JQueryMouseEventObject_JQueryMouseEventObject_((function(e)
    {
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((o.Data != "No tooltip information")) 
          {
            _2042 = ((ViewsHelpers__jq$("\u003cdiv/\u003e").text(o.Data)).append(errTip(o.Data)));
          }
          else
          {
            _2042 = (ViewsHelpers__jq$("\u003cdiv/\u003e").text(errTip("")));
          };
          var _ignored0 = (n_.append(String__Replace$(String__Replace$((_2042.html()), "\\n", "\u003c/br\u003e"), "\n", "\u003c/br\u003e")));
