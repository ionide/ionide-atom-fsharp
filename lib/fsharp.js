...
AsyncBuilder__While$ = (function(x,cond,body)
{
    ...
    {
      var _18983;
      return AsyncBuilder__Return$Unit_Unit_(x, _18983);
    };
});
...
AutocompleteProvider__create$ = (function(unitVar0)
{
    ...
    var _17391;
    Event_1_Object__Trigger$Object_(AutocompleteProvider__checkAutoCompleteManager, _17391);
    ...
    loop = (function(i)
    {
      return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
      {
        ...
        if ((Array__BoxedLength$(overloads) > 1)) 
        {
          ...
          _18371 = AsyncBuilder__Zero$(Async__get_async$());
        }
        else
        {
          _18371 = AsyncBuilder__Zero$(Async__get_async$());
        };
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _18371, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
        {
        ...
        return (function(lastResult)
        {
          return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
          {
            ...
            return AsyncBuilder__Bind$AutocompleteEvent__Unit_AutocompleteEvent__Unit_(Async__get_async$(), MailboxProcessor_1_AutocompleteEvent__Receive$AutocompleteEvent_(inbox), (function(_arg5)
            {
              ...
              if ((evt.Tag == 0.000000)) 
              {
                ...
                return AsyncBuilder__Bind$Tuple_2_Int32__Completion____Unit_Tuple_2_Int32__Completion____Unit_(Async__get_async$(), ensureUpToDate(lastRow)(lastResult)(request), (function(_arg6)
                {
                  ...
                  if ((Array__BoxedLength$(r) > 0)) 
                  {
                    ...
                    _15133 = AsyncBuilder__Zero$(Async__get_async$());
                  }
                  else
                  {
                    _15133 = AsyncBuilder__Zero$(Async__get_async$());
                  };
                  return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _15133, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
                  {
              ...
              {
                var _15219;
                return AsyncBuilder__ReturnFrom$Unit_Unit_(Async__get_async$(), updating(_15219));
              };
            }));
          }));
        });
    ...
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$IEmitter__Unit_IEmitter__Unit_(Async__get_async$(), Control__Async_AwaitObservable_Static$IEmitter_IEmitter_(AutocompleteProvider__autoCompleteManagerAvailable), (function(_arg1)
      {
        ...
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _17311 = ((ViewsHelpers__jq$("li.selected").prev()).find("span.word-container .word"));
          }
          else
          {
            _17311 = ((ViewsHelpers__jq$("li.selected").next()).find("span.word-container .word"));
          };
          var selected = _17311;
          var _17321;
          if (((selected.length) > 0.000000)) 
          {
            _17321 = (selected.text());
          }
          else
          {
            if (flag) 
            {
              _17321 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").last()).find(" span.word-container .word")).text());
            }
            else
            {
              _17321 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").first()).find(" span.word-container .word")).text());
            };
          };
          var text = _17321;
...
AutocompleteProvider__registerHelptextHandler$Unit_Unit_ = (function(disposePrevious)
{
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$IEditor__Unit_IEditor__Unit_(Async__get_async$(), Control__Async_AwaitObservable_Static$IEditor_IEditor_(Event_1_Object__get_Publish$Object_(AutocompleteProvider__editorChanged)), (function(_arg1)
      {
        var editor = _arg1;
        var _19237;
        disposePrevious(_19237);
        var _19238;
        if ((!ViewsHelpers__isFSharpEditor$(editor))) 
        {
          _19238 = (function(value)
          {
            var ignored0 = value;
          });
        }
...
CompletionHelpers__distanceCalc$Char_Char = (function(m,u,n,v)
{
    ...
    for (var _15004 = 1; _15004 <= (m - 1); _15004++)
    {
      (function(i)
      {
        d0[0] = i;
        ...
        for (var j = 1; j <= (n - 1); j++)
        {
          ...
          d0[j] = (1 + CompletionHelpers__min3$Int32_Int32(d1[j], d0[(j - 1)], (d1[(j - 1)] + _14963)));
          null;
        };
        ...
        return AsyncBuilder__Bind$FSharpOption_1_Result_1_Lint____Object___FSharpOption_1_Result_1_Lint____Object___(Async__get_async$(), LanguageService__lint$(editor), (function(_arg2)
        {
          ...
          if ((matchValue.Items[0.000000].Tag == 0.000000)) 
          {
            ...
            else
            {
              ...
              if (linter) 
              {
                _16288 = Array__Map$Lint__Object_Lint__Object_((function(item)
                {
          ...
          else
          {
            if ((matchValue.Items[1.000000].Tag == 0.000000)) 
            {
              ...
              _16288 = Array__Map$Error__Object_Error__Object_((function(item)
              {
            ...
            else
            {
              ...
              if (linter) 
              {
                _16487 = Array__Map$Lint__Object_Lint__Object_((function(item)
                {
                  return ErrorLinterProvider__mapLint$(editor, item);
                }), n_.Data);
              }
              ...
              var r_ = _16487;
              _16288 = Array__Concat$Object_Object_(Seq__OfList$Object___Object___(List__CreateCons$Object___Object___(r, List__CreateCons$Object___Object___(r_, List__Empty$Object___Object___()))));
            };
          };
          return AsyncBuilder__Return$Object___Object___(Async__get_async$(), _16288);
        }));
      }));
    })));
});
    ...
    return {Subscribe: (function(observer)
    {
      return (function(x,observer)
      {
        ...
        }), OnCompleted: (function(unitVar1)
        {
          ...
          {
            var _17482;
            return _this.onCompleted(_17482);
          })(_impl, unitVar1);
        })});
      })(impl, observer);
    })};
    ...
    return {Subscribe: (function(observer)
    {
      return (function(x,observer)
      {
        ...
        }), OnCompleted: (function(unitVar1)
        {
          ...
          {
            var _17084;
            return _this.onCompleted(_17084);
          })(_impl, unitVar1);
        })});
      })(impl, observer);
    })};
...
Observable__protect$FSharpOption_1_IEmitter__Unit_FSharpOption_1_IEmitter__Unit_ = (function(f,succeed,fail)
{
    ...
    {
      var _17047;
      _17044 = (new FSharpChoice_2_FSharpOption_1_IEmitter__Exception__Choice1Of2FSharpOption_1_IEmitter__Exception_(f(_17047)));
    }
    catch(e){
      _17044 = (new FSharpChoice_2_FSharpOption_1_IEmitter__Exception__Choice2Of2FSharpOption_1_IEmitter__Exception_(e));
    };
    var matchValue = _17044;
    if ((matchValue.Tag == 1.000000)) 
    {
...
Observable__protect$FSharpOption_1_String__Unit_FSharpOption_1_String__Unit_ = (function(f,succeed,fail)
{
    ...
    {
      var _17445;
      _17442 = (new FSharpChoice_2_FSharpOption_1_String__Exception__Choice1Of2FSharpOption_1_String__Exception_(f(_17445)));
    }
    catch(e){
      _17442 = (new FSharpChoice_2_FSharpOption_1_String__Exception__Choice2Of2FSharpOption_1_String__Exception_(e));
    };
    var matchValue = _17442;
    if ((matchValue.Tag == 1.000000)) 
    {
      var _e = matchValue.Item;
      return fail(_e);
