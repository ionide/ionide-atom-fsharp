    ...
    var _ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg4)
    {
      ...
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _65 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _65 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _65;
          var _75;
          ...
          else
          {
            if (flag) 
            {
              _75 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").last()).find(" span.word-container .word")).text());
            }
            else
            {
              _75 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").first()).find(" span.word-container .word")).text());
            };
          };
          var text = _75;
...
Events__emitEmpty$String_1String = (function(t,s)
{
    var name = Events__getName$(t);
    var _1523;
    return (Events__emitter.emit(name, _1523));
});
            ...
            return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.tabLength")).toString()), Seq__Delay$String_1String((function(___unitVar)
            {
              return Seq__Append$String_1String(Seq__Singleton$String_1String("--pageWidth"), Seq__Delay$String_1String((function(____unitVar)
              {
                return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.preferredLineLength")).toString()), Seq__Delay$String_1String((function(_____unitVar)
                {
                  ...
                  {
                    _3933 = Seq__Singleton$String_1String("--semicolonEOL");
                  }
                  else
                  {
                    _3933 = Seq__Empty$String_1String();
                  };
                  return Seq__Append$String_1String(_3933, Seq__Delay$String_1String((function(______unitVar)
                  {
                    var _4005;
                    if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceBeforeArgument"))) 
                    {
                      _4005 = Seq__Singleton$String_1String("--noSpaceBeforeArgument");
                    }
                    else
                    {
                      _4005 = Seq__Empty$String_1String();
                    };
                    return Seq__Append$String_1String(_4005, Seq__Delay$String_1String((function(_______unitVar)
                    {
                      var _4018;
                      if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceBeforeColon"))) 
                      {
                        _4018 = Seq__Singleton$String_1String("--noSpaceBeforeColon");
                      }
                      else
                      {
                        _4018 = Seq__Empty$String_1String();
                      };
                      return Seq__Append$String_1String(_4018, Seq__Delay$String_1String((function(________unitVar)
                      {
                        var _4031;
                        if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAfterComma"))) 
                        {
                          _4031 = Seq__Singleton$String_1String("--noSpaceAfterComma");
                        }
                        else
                        {
                          _4031 = Seq__Empty$String_1String();
                        };
                        return Seq__Append$String_1String(_4031, Seq__Delay$String_1String((function(_________unitVar)
                        {
                          var _4044;
                          if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAfterSemiColon"))) 
                          {
                            _4044 = Seq__Singleton$String_1String("--noSpaceAfterSemiColon");
                          }
                          else
                          {
                            _4044 = Seq__Empty$String_1String();
                          };
                          return Seq__Append$String_1String(_4044, Seq__Delay$String_1String((function(__________unitVar)
                          {
                            var _4057;
                            if ((((window.atom).config).get("atom-fsharp.FormatDocument.IndentOnTryWith"))) 
                            {
                              _4057 = Seq__Singleton$String_1String("--indentOnTryWith");
                            }
                            else
                            {
                              _4057 = Seq__Empty$String_1String();
                            };
                            return Seq__Append$String_1String(_4057, Seq__Delay$String_1String((function(___________unitVar)
                            {
                              var _4070;
                              if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAroundDelimiter"))) 
                              {
                                _4070 = Seq__Singleton$String_1String("--noSpaceAroundDelimiter");
                              }
                              else
                              {
                                _4070 = Seq__Empty$String_1String();
                              };
                              return Seq__Append$String_1String(_4070, Seq__Delay$String_1String((function(____________unitVar)
                              {
                                var _4083;
                                if ((((window.atom).config).get("atom-fsharp.FormatDocument.ReorderOpenDeclaration"))) 
                                {
                                  _4083 = Seq__Singleton$String_1String("--reorderOpenDeclaration");
                                }
                                else
                                {
                                  _4083 = Seq__Empty$String_1String();
                                };
                                return Seq__Append$String_1String(_4083, Seq__Delay$String_1String((function(_____________unitVar)
                                {
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _3729 = "highlight-symboluse-declaration";
        }
        else
        {
          _3729 = "highlight-symboluse";
        };
        var cls = _3729;
      ...
      findFsProj = (function(dir)
      {
        if (((fs.lstatSync(dir)).isDirectory())) 
        {
          ...
          else
          {
            ...
            {
              _2383 = dir.substring(0, 0 + dir.lastIndexOf((path.sep)));
            }
            else
            {
              _2383 = "";
...
Process__exec$ = (function(location,linuxCmd,cmd)
{
    ...
    if (Process__isWin$()) 
    {
      _4423 = (child_process.execFile(location, cmd, options, (function(_arg3)
      {
    ...
    else
    {
      ...
      _4423 = (child_process.execFile(linuxCmd, prms, options, (function(_arg6)
      {
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _852;
      return Seq__Enumerator$Completion_Completion_(f(_852));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _943;
      return Seq__Enumerator$Object_Object_(f(_943));
    }));
});
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _4105;
      return Seq__Enumerator$String_1String(f(_4105));
    }));
});
    ...
    return Option__Iterate$JQueryMouseEventObject_JQueryMouseEventObject_((function(e)
    {
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((data != "No tooltip information")) 
          {
            _3114 = ((ViewsHelpers__jq$("\u003cdiv/\u003e").text(data)).append(errTip(data)));
          }
          else
          {
            _3114 = (ViewsHelpers__jq$("\u003cdiv/\u003e").text(errTip("")));
          };
          var _ignored0 = (n_.append(String__Replace$(String__Replace$((_3114.html()), "\\n", "\u003c/br\u003e"), "\n", "\u003c/br\u003e")));
