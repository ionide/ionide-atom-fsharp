    ...
    var ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg3)
    {
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        ...
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _6164 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _6164 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _6164;
            ...
            return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.tabLength")).toString()), Seq__Delay$String_1String((function(___unitVar)
            {
              return Seq__Append$String_1String(Seq__Singleton$String_1String("--pageWidth"), Seq__Delay$String_1String((function(____unitVar)
              {
                return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.preferredLineLength")).toString()), Seq__Delay$String_1String((function(_____unitVar)
                {
                  ...
                  {
                    _4899 = Seq__Singleton$String_1String("--semicolonEOL");
                  }
                  else
                  {
                    _4899 = Seq__Empty$String_1String();
                  };
                  return Seq__Append$String_1String(_4899, Seq__Delay$String_1String((function(______unitVar)
                  {
                    var _4971;
                    if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceBeforeArgument"))) 
                    {
                      _4971 = Seq__Singleton$String_1String("--noSpaceBeforeArgument");
                    }
                    else
                    {
                      _4971 = Seq__Empty$String_1String();
                    };
                    return Seq__Append$String_1String(_4971, Seq__Delay$String_1String((function(_______unitVar)
                    {
                      var _4984;
                      if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceBeforeColon"))) 
                      {
                        _4984 = Seq__Singleton$String_1String("--noSpaceBeforeColon");
                      }
                      else
                      {
                        _4984 = Seq__Empty$String_1String();
                      };
                      return Seq__Append$String_1String(_4984, Seq__Delay$String_1String((function(________unitVar)
                      {
                        var _4997;
                        if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAfterComma"))) 
                        {
                          _4997 = Seq__Singleton$String_1String("--noSpaceAfterComma");
                        }
                        else
                        {
                          _4997 = Seq__Empty$String_1String();
                        };
                        return Seq__Append$String_1String(_4997, Seq__Delay$String_1String((function(_________unitVar)
                        {
                          var _5010;
                          if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAfterSemiColon"))) 
                          {
                            _5010 = Seq__Singleton$String_1String("--noSpaceAfterSemiColon");
                          }
                          else
                          {
                            _5010 = Seq__Empty$String_1String();
                          };
                          return Seq__Append$String_1String(_5010, Seq__Delay$String_1String((function(__________unitVar)
                          {
                            var _5023;
                            if ((((window.atom).config).get("atom-fsharp.FormatDocument.IndentOnTryWith"))) 
                            {
                              _5023 = Seq__Singleton$String_1String("--indentOnTryWith");
                            }
                            else
                            {
                              _5023 = Seq__Empty$String_1String();
                            };
                            return Seq__Append$String_1String(_5023, Seq__Delay$String_1String((function(___________unitVar)
                            {
                              var _5036;
                              if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAroundDelimiter"))) 
                              {
                                _5036 = Seq__Singleton$String_1String("--noSpaceAroundDelimiter");
                              }
                              else
                              {
                                _5036 = Seq__Empty$String_1String();
                              };
                              return Seq__Append$String_1String(_5036, Seq__Delay$String_1String((function(____________unitVar)
                              {
                                var _5049;
                                if ((((window.atom).config).get("atom-fsharp.FormatDocument.ReorderOpenDeclaration"))) 
                                {
                                  _5049 = Seq__Singleton$String_1String("--reorderOpenDeclaration");
                                }
                                else
                                {
                                  _5049 = Seq__Empty$String_1String();
                                };
                                return Seq__Append$String_1String(_5049, Seq__Delay$String_1String((function(_____________unitVar)
                                {
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _4687 = "highlight-symboluse-declaration";
        }
        else
        {
          _4687 = "highlight-symboluse";
        };
        var cls = _4687;
...
Interactive__handleLocation$ = (function(n)
{
    ...
    if (Process__isWin$()) 
    {
      _4277 = (path.join(n.Data, "fsi.exe"));
    }
    else
    {
      _4277 = "fsharpi";
    };
    Interactive__fsipath = _4277;
...
Process__exec$ = (function(location,linuxCmd,cmd)
{
    ...
    if (Process__isWin$()) 
    {
      _5389 = (child_process.execFile(location, cmd, options, (function(_arg3)
      {
        return (function(_arg2)
        {
          return (function(_arg1)
    ...
    else
    {
      ...
      _5389 = (child_process.execFile(linuxCmd, prms, options, (function(_arg6)
      {
...
Process__notice$ = (function(currentNotification,isError,text,details)
{
    ...
    if ((matchValue.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _2727 = (((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true))));
      }
      else
      {
        _2727 = (((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true))));
      };
      var n = _2727;
...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _4299 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _4299;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
...
Process__spawnWithNotifications$ = (function(location,linuxCmd,cmd)
{
    ...
    {
      _2524 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _2524;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
    var _2540;
    if (Process__isWin$()) 
    {
      _2540 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _2540 = (child_process.spawn(linuxCmd, prms, options));
    };
    var procs = _2540;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _5718;
      return Seq__Enumerator$Completion_Completion_(f(_5718));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _3816;
      return Seq__Enumerator$Object_Object_(f(_3816));
    }));
});
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _5071;
      return Seq__Enumerator$String_1String(f(_5071));
    }));
});
...
ToolbarHandler__format_data$ = (function(tinfo)
{
    ...
    if (String__StartsWith$(ti_, "type")) 
    {
      ...
      _2278 = ti_.substring(0, 0 + (_idx - 1));
    }
    else
    {
      _2278 = ti_;
