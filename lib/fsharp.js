    ...
    var ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg3)
    {
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        ...
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _58 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _58 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _58;
          var _70;
          ...
          else
          {
            if (flag) 
            {
              _70 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").last()).find(" span.word-container .word")).text());
            }
            else
            {
              _70 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").first()).find(" span.word-container .word")).text());
            };
          };
          var text = _70;
...
Events__emitEmpty$String_1String = (function(t,s)
{
    ...
    var _1038;
    return (Events__emitter.emit(name, _1038));
});
...
FAKE__activate$ = (function(unitVar0)
{
    ...
    var proj = (function(ex)
    {
      return (function(arr)
      {
        ...
        if ((arr != undefined)) 
        {
          _3790 = Array__TryFind$String_1String((function(a)
          {
            return (function(n)
            {
            ...
            return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.tabLength")).toString()), Seq__Delay$String_1String((function(___unitVar)
            {
              return Seq__Append$String_1String(Seq__Singleton$String_1String("--pageWidth"), Seq__Delay$String_1String((function(____unitVar)
              {
                return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.preferredLineLength")).toString()), Seq__Delay$String_1String((function(_____unitVar)
                {
                  ...
                  {
                    _5405 = Seq__Singleton$String_1String("--semicolonEOL");
                  }
                  else
                  {
                    _5405 = Seq__Empty$String_1String();
                  };
                  return Seq__Append$String_1String(_5405, Seq__Delay$String_1String((function(______unitVar)
                  {
                    var _5477;
                    if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceBeforeArgument"))) 
                    {
                      _5477 = Seq__Singleton$String_1String("--noSpaceBeforeArgument");
                    }
                    else
                    {
                      _5477 = Seq__Empty$String_1String();
                    };
                    return Seq__Append$String_1String(_5477, Seq__Delay$String_1String((function(_______unitVar)
                    {
                      var _5490;
                      if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceBeforeColon"))) 
                      {
                        _5490 = Seq__Singleton$String_1String("--noSpaceBeforeColon");
                      }
                      else
                      {
                        _5490 = Seq__Empty$String_1String();
                      };
                      return Seq__Append$String_1String(_5490, Seq__Delay$String_1String((function(________unitVar)
                      {
                        var _5503;
                        if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAfterComma"))) 
                        {
                          _5503 = Seq__Singleton$String_1String("--noSpaceAfterComma");
                        }
                        else
                        {
                          _5503 = Seq__Empty$String_1String();
                        };
                        return Seq__Append$String_1String(_5503, Seq__Delay$String_1String((function(_________unitVar)
                        {
                          var _5516;
                          if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAfterSemiColon"))) 
                          {
                            _5516 = Seq__Singleton$String_1String("--noSpaceAfterSemiColon");
                          }
                          else
                          {
                            _5516 = Seq__Empty$String_1String();
                          };
                          return Seq__Append$String_1String(_5516, Seq__Delay$String_1String((function(__________unitVar)
                          {
                            var _5529;
                            if ((((window.atom).config).get("atom-fsharp.FormatDocument.IndentOnTryWith"))) 
                            {
                              _5529 = Seq__Singleton$String_1String("--indentOnTryWith");
                            }
                            else
                            {
                              _5529 = Seq__Empty$String_1String();
                            };
                            return Seq__Append$String_1String(_5529, Seq__Delay$String_1String((function(___________unitVar)
                            {
                              var _5542;
                              if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAroundDelimiter"))) 
                              {
                                _5542 = Seq__Singleton$String_1String("--noSpaceAroundDelimiter");
                              }
                              else
                              {
                                _5542 = Seq__Empty$String_1String();
                              };
                              return Seq__Append$String_1String(_5542, Seq__Delay$String_1String((function(____________unitVar)
                              {
                                var _5555;
                                if ((((window.atom).config).get("atom-fsharp.FormatDocument.ReorderOpenDeclaration"))) 
                                {
                                  _5555 = Seq__Singleton$String_1String("--reorderOpenDeclaration");
                                }
                                else
                                {
                                  _5555 = Seq__Empty$String_1String();
                                };
                                return Seq__Append$String_1String(_5555, Seq__Delay$String_1String((function(_____________unitVar)
                                {
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _5193 = "highlight-symboluse-declaration";
        }
        else
        {
          _5193 = "highlight-symboluse";
        };
        var cls = _5193;
      ...
      findFsProj = (function(dir)
      {
        if (((fs.lstatSync(dir)).isDirectory())) 
        {
          ...
          else
          {
            ...
            {
              _1934 = dir.substring(0, 0 + dir.lastIndexOf((path.sep)));
            }
            else
            {
              _1934 = "";
...
Process__exec$ = (function(location,linuxCmd,cmd)
{
    ...
    if (Process__isWin$()) 
    {
      _5895 = (child_process.execFile(location, cmd, options, (function(_arg3)
      {
        return (function(_arg2)
        {
          return (function(_arg1)
    ...
    else
    {
      ...
      _5895 = (child_process.execFile(linuxCmd, prms, options, (function(_arg6)
      {
...
Process__notice$ = (function(currentNotification,isError,text,details)
{
    ...
    if ((matchValue.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _3308 = (((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true))));
      }
      else
      {
        _3308 = (((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true))));
      };
      var n = _3308;
...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _4811 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _4811;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
...
Process__spawnWithNotifications$ = (function(location,linuxCmd,cmd)
{
    ...
    {
      _3105 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _3105;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
    var _3121;
    if (Process__isWin$()) 
    {
      _3121 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _3121 = (child_process.spawn(linuxCmd, prms, options));
    };
    var procs = _3121;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _442;
      return Seq__Enumerator$Completion_Completion_(f(_442));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _533;
      return Seq__Enumerator$Object_Object_(f(_533));
    }));
});
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _5577;
      return Seq__Enumerator$String_1String(f(_5577));
    }));
});
    ...
    return Option__Iterate$JQueryMouseEventObject_JQueryMouseEventObject_((function(e)
    {
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((o.Data != "No tooltip information")) 
          {
            _2615 = ((ViewsHelpers__jq$("\u003cdiv/\u003e").text(o.Data)).append(errTip(o.Data)));
          }
          else
          {
            _2615 = (ViewsHelpers__jq$("\u003cdiv/\u003e").text(errTip("")));
          };
          var _ignored0 = (n_.append(String__Replace$(String__Replace$((_2615.html()), "\\n", "\u003c/br\u003e"), "\n", "\u003c/br\u003e")));
