...
AsyncBuilder__Zero$ = (function(x,unitVar1)
{
    ...
    {
      var _1971;
      return Async__invokeCont$Unit_Unit_(k, _1971);
    }));
});
...
Async_1_StartImmediate$ = (function(workflow,cancellationToken)
{
    ...
    {
      _2117 = (new CancellationToken___ctor$({Tag: 0.000000}));
    };
    var token = _2117;
    var f = workflow.Item;
    ...
    var __ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg4)
    {
      ...
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _13271 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _13271 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _13271;
          var _13281;
          if (((selected.length) > 0.000000)) 
          {
            _13281 = (selected.text());
          }
          else
          {
            if (flag) 
            {
              _13281 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").last()).find(" span.word-container .word")).text());
            }
            else
            {
              _13281 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").first()).find(" span.word-container .word")).text());
            };
          };
          var text = _13281;
...
AutocompleteProvider__getSuggestion$ = (function(options)
{
    if ((((options.editor.buffer).file) != null)) 
    {
      ...
      {
        _4698 = ((col - 2) - options.prefix.length);
      }
      else
      {
        _4698 = col;
      ...
      return new Promise(function(resolve,reject){(function(unitVar0)
      {
        ...
        else
        {
          ...
          else
          {
            ...
            if ((((options.editor.buffer).lines)[row_].charAt(col_) == "\\")) 
            {
              _13029 = CompletionHelpers__glyph_completion$(prefix, Option__GetValue$Result_1_Completion___Result_1_Completion___(AutocompleteProvider__lastResult).Data);
            }
            else
            {
              _13029 = CompletionHelpers__fsharp_completion$(prefix, Option__GetValue$Result_1_Completion___Result_1_Completion___(AutocompleteProvider__lastResult).Data);
            };
            var r = _13029;
            if ((Array__BoxedLength$(r) > 0)) 
            {
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              {
                _12699 = dist((___i - 1))((___j - 1));
              }
              else
              {
                _12699 = CompletionHelpers__min3$Int32_Int32((dist((___i - 1))(___j) + 1), (dist(___i)((___j - 1)) + 1), (dist((___i - 1))((___j - 1)) + 1));
              };
              var dval = _12699;
...
{
    var _4654;
    return (((window.atom).workspace).open("atom://config/packages/ionide-fsharp", _4654));
});
            ...
            return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.tabLength")).toString()), Seq__Delay$String_1String((function(___unitVar)
            {
              return Seq__Append$String_1String(Seq__Singleton$String_1String("--pageWidth"), Seq__Delay$String_1String((function(____unitVar)
              {
                return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.preferredLineLength")).toString()), Seq__Delay$String_1String((function(_____unitVar)
                {
                  ...
                  {
                    _4172 = Seq__Singleton$String_1String("--semicolonEOL");
                  }
                  else
                  {
                    _4172 = Seq__Empty$String_1String();
                  };
                  return Seq__Append$String_1String(_4172, Seq__Delay$String_1String((function(______unitVar)
                  {
                    var _4244;
                    if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceBeforeArgument"))) 
                    {
                      _4244 = Seq__Singleton$String_1String("--noSpaceBeforeArgument");
                    }
                    else
                    {
                      _4244 = Seq__Empty$String_1String();
                    };
                    return Seq__Append$String_1String(_4244, Seq__Delay$String_1String((function(_______unitVar)
                    {
                      var _4257;
                      if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceBeforeColon"))) 
                      {
                        _4257 = Seq__Singleton$String_1String("--noSpaceBeforeColon");
                      }
                      else
                      {
                        _4257 = Seq__Empty$String_1String();
                      };
                      return Seq__Append$String_1String(_4257, Seq__Delay$String_1String((function(________unitVar)
                      {
                        var _4270;
                        if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAfterComma"))) 
                        {
                          _4270 = Seq__Singleton$String_1String("--noSpaceAfterComma");
                        }
                        else
                        {
                          _4270 = Seq__Empty$String_1String();
                        };
                        return Seq__Append$String_1String(_4270, Seq__Delay$String_1String((function(_________unitVar)
                        {
                          var _4283;
                          if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAfterSemiColon"))) 
                          {
                            _4283 = Seq__Singleton$String_1String("--noSpaceAfterSemiColon");
                          }
                          else
                          {
                            _4283 = Seq__Empty$String_1String();
                          };
                          return Seq__Append$String_1String(_4283, Seq__Delay$String_1String((function(__________unitVar)
                          {
                            var _4296;
                            if ((((window.atom).config).get("ionide-fsharp.FormatDocument.IndentOnTryWith"))) 
                            {
                              _4296 = Seq__Singleton$String_1String("--indentOnTryWith");
                            }
                            else
                            {
                              _4296 = Seq__Empty$String_1String();
                            };
                            return Seq__Append$String_1String(_4296, Seq__Delay$String_1String((function(___________unitVar)
                            {
                              var _4309;
                              if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAroundDelimiter"))) 
                              {
                                _4309 = Seq__Singleton$String_1String("--noSpaceAroundDelimiter");
                              }
                              else
                              {
                                _4309 = Seq__Empty$String_1String();
                              };
                              return Seq__Append$String_1String(_4309, Seq__Delay$String_1String((function(____________unitVar)
                              {
                                var _4322;
                                if ((((window.atom).config).get("ionide-fsharp.FormatDocument.ReorderOpenDeclaration"))) 
                                {
                                  _4322 = Seq__Singleton$String_1String("--reorderOpenDeclaration");
                                }
                                else
                                {
                                  _4322 = Seq__Empty$String_1String();
                                };
                                return Seq__Append$String_1String(_4322, Seq__Delay$String_1String((function(_____________unitVar)
                                {
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _3968 = "highlight-symboluse-declaration";
        }
        else
        {
          _3968 = "highlight-symboluse";
        };
        var cls = _3968;
...
{
    var _822;
    return LanguageService__send$(LanguageService__request$Unit_Unit_(LanguageService__url$("compilerlocation"), _822));
});
      ...
      findFsProj = (function(dir)
      {
        if (((fs.existsSync(dir)) && ((fs.lstatSync(dir)).isDirectory()))) 
        {
          ...
          else
          {
            ...
            {
              _2360 = dir.substring(0, 0 + dir.lastIndexOf((path.sep)));
            }
            else
            {
              _2360 = "";
...
Process__exec$ = (function(location,linuxCmd,cmd)
{
    ...
    if (Process__isWin$()) 
    {
      _4550 = (child_process.execFile(location, cmd, options, (function(_arg3)
      {
    ...
    else
    {
      ...
      _4550 = (child_process.execFile(linuxCmd, prms, options, (function(_arg6)
      {
...
Process__spawn$ = (function(location,linuxCmd,cmd)
{
    ...
    if (Process__isWin$()) 
    {
      _692 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _692 = (child_process.spawn(linuxCmd, prms, options));
    };
    var procs = _692;
    return procs;
});
...
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _4344;
      return Seq__Enumerator$String_1String(f(_4344));
    }));
});
...
ToolbarHandler__cursorHandler$ = (function(o)
{
    ...
    if ((Array__BoxedLength$(o.Data) > 0)) 
    {
      ...
      var state = List__Empty$OverloadSignature_OverloadSignature_();
      _3596 = List__Head$OverloadSignature_OverloadSignature_((function(array)
      {
        return Array__Fold$OverloadSignature____FSharpList_1_OverloadSignature_OverloadSignature____FSharpList_1_OverloadSignature_(folder, state, array);
      })(o.Data)).Signature;
    }
      ...
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((Array__BoxedLength$(o.Data) > 0)) 
          {
            ...
            var state = List__Empty$OverloadSignature_OverloadSignature_();
            _3217 = List__Head$OverloadSignature_OverloadSignature_((function(array)
            {
              return Array__Fold$OverloadSignature____FSharpList_1_OverloadSignature_OverloadSignature____FSharpList_1_OverloadSignature_(folder, state, array);
            })(o.Data)).Signature;
          }
...
WebRequest__AsyncGetResponse$ = (function(req,unitVar1)
{
    return Async_1_FromContinuations$WebResponse_WebResponse_((function(tupledArg)
    {
      ...
      {
        _942 = UTF8Encoding__GetString$(Replacements__utf8Encoding$(), Stream__get_Contents$(req.requestStream));
      };
      var body = _942;
