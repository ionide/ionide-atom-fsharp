...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      ...
      {
        _4835 = "highlight-symboluse-declaration";
      }
      else
      {
        _4835 = "highlight-symboluse";
      };
      var cls = _4835;
...
HighlighterHandler__handle$ = (function(o)
{
    ...
    var action = (function(item)
    {
      ...
      {
        _1463 = "highlight-warning";
      }
      else
      {
        _1463 = "highlight-error";
      };
      var cls = _1463;
...
Interactive__handleLocation$ = (function(n)
{
    ...
    if (Process__isWin$()) 
    {
      _4478 = (path.join(n.Data, "fsi.exe"));
    }
    else
    {
      _4478 = "fsharpi";
    };
    Interactive__fsipath = _4478;
    ...
    if ((((((editor != undefined) && (editor["buffer"] != undefined)) && ((editor.buffer) != null)) && ((editor.buffer)["file"] != undefined)) && (((editor.buffer).file) != null))) 
    {
      ...
      findFsProj = (function(dir)
      {
        ...
        else
        {
          ...
          {
            _1296 = dir.substring(0, 0 + dir.lastIndexOf((path.sep)));
          }
          else
          {
            _1296 = "";
...
Process__notice$ = (function(currentNotification,isError,text,details)
{
    ...
    if ((matchValue.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _2990 = (((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true))));
      }
      else
      {
        _2990 = (((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true))));
      };
      var n = _2990;
...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _4500 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _4500;
...
Process__spawnWithNotifications$ = (function(location,linuxCmd,cmd)
{
    ...
    {
      _2787 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _2787;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
    var _2803;
    if (Process__isWin$()) 
    {
      _2803 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _2803 = (child_process.spawn(linuxCmd, prms, options));
    };
    var procs = _2803;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _5129;
      return Seq__Enumerator$Completion_Completion_(f(_5129));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _4017;
      return Seq__Enumerator$Object_Object_(f(_4017));
    }));
});
...
ToolbarHandler__format_data$ = (function(tinfo)
{
    ...
    if (String__StartsWith$(ti_, "type")) 
    {
      ...
      _2583 = ti_.substring(0, 0 + (_idx - 1));
    }
    else
    {
      _2583 = ti_;
    ...
    return Option__Iterate$JQueryMouseEventObject_JQueryMouseEventObject_((function(e)
    {
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((o.Data != "No tooltip information")) 
          {
            _2168 = ((ViewsHelpers__jq$("\u003cdiv/\u003e").text(o.Data)).append(errTip(o.Data)));
          }
          else
          {
            _2168 = (ViewsHelpers__jq$("\u003cdiv/\u003e").text(errTip("")));
          };
          var _ignored0 = (n_.append(String__Replace$(String__Replace$((_2168.html()), "\\n", "\u003c/br\u003e"), "\n", "\u003c/br\u003e")));
