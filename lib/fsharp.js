    ...
    var _ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg4)
    {
      ...
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _4477 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _4477 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _4477;
          var _4487;
          ...
          else
          {
            if (flag) 
            {
              _4487 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").last()).find(" span.word-container .word")).text());
            }
            else
            {
              _4487 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").first()).find(" span.word-container .word")).text());
            };
          };
          var text = _4487;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _3948;
      return Seq__Enumerator$Completion_Completion_(f(_3948));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _4039;
      return Seq__Enumerator$Object_Object_(f(_4039));
    }));
});
