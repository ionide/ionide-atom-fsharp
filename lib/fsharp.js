...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      ...
      {
        _4563 = "highlight-symboluse-declaration";
      }
      else
      {
        _4563 = "highlight-symboluse";
      };
      var cls = _4563;
...
Interactive__handleLocation$ = (function(n)
{
    ...
    if (Process__isWin$()) 
    {
      _4179 = (path.join(n.Data, "fsi.exe"));
    }
    else
    {
      _4179 = "fsharpi";
    };
    Interactive__fsipath = _4179;
    ...
    if ((((((editor != undefined) && (editor["buffer"] != undefined)) && ((editor.buffer) != null)) && ((editor.buffer)["file"] != undefined)) && (((editor.buffer).file) != null))) 
    {
      ...
      findFsProj = (function(dir)
      {
        ...
        else
        {
          ...
          {
            _1268 = dir.substring(0, 0 + dir.lastIndexOf((path.sep)));
          }
          else
          {
            _1268 = "";
...
Process__notice$ = (function(currentNotification,isError,text,details)
{
    ...
    if ((matchValue.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _2681 = (((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true))));
      }
      else
      {
        _2681 = (((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true))));
      };
      var n = _2681;
...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _4201 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _4201;
...
Process__spawnWithNotifications$ = (function(location,linuxCmd,cmd)
{
    ...
    {
      _2478 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _2478;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
    var _2494;
    if (Process__isWin$()) 
    {
      _2494 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _2494 = (child_process.spawn(linuxCmd, prms, options));
    };
    var procs = _2494;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _4857;
      return Seq__Enumerator$Completion_Completion_(f(_4857));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _3718;
      return Seq__Enumerator$Object_Object_(f(_3718));
    }));
});
...
ToolbarHandler__format_data$ = (function(tinfo)
{
    ...
    if (String__StartsWith$(ti_, "type")) 
    {
      ...
      _2273 = ti_.substring(0, 0 + (_idx - 1));
    }
    else
    {
      _2273 = ti_;
    ...
    return Option__Iterate$JQueryMouseEventObject_JQueryMouseEventObject_((function(e)
    {
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((o.Data != "No tooltip information")) 
          {
            _2016 = ((ViewsHelpers__jq$("\u003cdiv/\u003e").text(o.Data)).append(errTip(o.Data)));
          }
          else
          {
            _2016 = (ViewsHelpers__jq$("\u003cdiv/\u003e").text(errTip("")));
          };
          var _ignored0 = (n_.append(String__Replace$(String__Replace$((_2016.html()), "\\n", "\u003c/br\u003e"), "\n", "\u003c/br\u003e")));
