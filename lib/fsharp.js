    ...
    var __ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg4)
    {
      ...
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _12321 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _12321 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _12321;
          var _12331;
          if (((selected.length) > 0.000000)) 
          {
            _12331 = (selected.text());
          }
          else
          {
            if (flag) 
            {
              _12331 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").last()).find(" span.word-container .word")).text());
            }
            else
            {
              _12331 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").first()).find(" span.word-container .word")).text());
            };
          };
          var text = _12331;
...
AutocompleteProvider__getSuggestion$ = (function(options)
{
    if ((((options.editor.buffer).file) != null)) 
    {
      ...
      {
        _3767 = ((col - 2) - options.prefix.length);
      }
      else
      {
        _3767 = col;
      ...
      return new Promise(function(resolve){(function(unitVar0)
      {
          ...
          Events__once$Object__Unit_Object__Unit_((new EventType__Errors()), (function(result)
          {
            Events__once$CompletionResult__Unit_CompletionResult__Unit_((new EventType__Completion()), (function(_result)
            {
              ...
              if ((((options.editor.buffer).lines)[row_].charAt(col_) == "\\")) 
              {
                ...
                _3825 = CompletionHelpers__glyph_completion$(prefix, GlyphMaps__unicode_map);
              }
              else
              {
                AutocompleteProvider__lastResult = {Tag: 1.000000, Value: _result};
                _3825 = CompletionHelpers__fsharp_completion$(prefix, _result.Data);
              };
              var r = _3825;
        ...
        else
        {
          ...
          if ((((options.editor.buffer).lines)[row_].charAt(col_) == "\\")) 
          {
            _12083 = CompletionHelpers__glyph_completion$(prefix, Option__GetValue$CompletionResult_CompletionResult_(AutocompleteProvider__lastResult).Data);
          }
          else
          {
            _12083 = CompletionHelpers__fsharp_completion$(prefix, Option__GetValue$CompletionResult_CompletionResult_(AutocompleteProvider__lastResult).Data);
          };
          var r = _12083;
          if ((Array__BoxedLength$(r) > 0)) 
          {
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              {
                _11760 = dist((___i - 1))((___j - 1));
              }
              else
              {
                _11760 = CompletionHelpers__min3$Int32_Int32((dist((___i - 1))(___j) + 1), (dist(___i)((___j - 1)) + 1), (dist((___i - 1))((___j - 1)) + 1));
              };
              var dval = _11760;
            ...
            return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.tabLength")).toString()), Seq__Delay$String_1String((function(___unitVar)
            {
              return Seq__Append$String_1String(Seq__Singleton$String_1String("--pageWidth"), Seq__Delay$String_1String((function(____unitVar)
              {
                return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.preferredLineLength")).toString()), Seq__Delay$String_1String((function(_____unitVar)
                {
                  ...
                  {
                    _3040 = Seq__Singleton$String_1String("--semicolonEOL");
                  }
                  else
                  {
                    _3040 = Seq__Empty$String_1String();
                  };
                  return Seq__Append$String_1String(_3040, Seq__Delay$String_1String((function(______unitVar)
                  {
                    var _3112;
                    if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceBeforeArgument"))) 
                    {
                      _3112 = Seq__Singleton$String_1String("--noSpaceBeforeArgument");
                    }
                    else
                    {
                      _3112 = Seq__Empty$String_1String();
                    };
                    return Seq__Append$String_1String(_3112, Seq__Delay$String_1String((function(_______unitVar)
                    {
                      var _3125;
                      if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceBeforeColon"))) 
                      {
                        _3125 = Seq__Singleton$String_1String("--noSpaceBeforeColon");
                      }
                      else
                      {
                        _3125 = Seq__Empty$String_1String();
                      };
                      return Seq__Append$String_1String(_3125, Seq__Delay$String_1String((function(________unitVar)
                      {
                        var _3138;
                        if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAfterComma"))) 
                        {
                          _3138 = Seq__Singleton$String_1String("--noSpaceAfterComma");
                        }
                        else
                        {
                          _3138 = Seq__Empty$String_1String();
                        };
                        return Seq__Append$String_1String(_3138, Seq__Delay$String_1String((function(_________unitVar)
                        {
                          var _3151;
                          if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAfterSemiColon"))) 
                          {
                            _3151 = Seq__Singleton$String_1String("--noSpaceAfterSemiColon");
                          }
                          else
                          {
                            _3151 = Seq__Empty$String_1String();
                          };
                          return Seq__Append$String_1String(_3151, Seq__Delay$String_1String((function(__________unitVar)
                          {
                            var _3164;
                            if ((((window.atom).config).get("ionide-fsharp.FormatDocument.IndentOnTryWith"))) 
                            {
                              _3164 = Seq__Singleton$String_1String("--indentOnTryWith");
                            }
                            else
                            {
                              _3164 = Seq__Empty$String_1String();
                            };
                            return Seq__Append$String_1String(_3164, Seq__Delay$String_1String((function(___________unitVar)
                            {
                              var _3177;
                              if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAroundDelimiter"))) 
                              {
                                _3177 = Seq__Singleton$String_1String("--noSpaceAroundDelimiter");
                              }
                              else
                              {
                                _3177 = Seq__Empty$String_1String();
                              };
                              return Seq__Append$String_1String(_3177, Seq__Delay$String_1String((function(____________unitVar)
                              {
                                var _3190;
                                if ((((window.atom).config).get("ionide-fsharp.FormatDocument.ReorderOpenDeclaration"))) 
                                {
                                  _3190 = Seq__Singleton$String_1String("--reorderOpenDeclaration");
                                }
                                else
                                {
                                  _3190 = Seq__Empty$String_1String();
                                };
                                return Seq__Append$String_1String(_3190, Seq__Delay$String_1String((function(_____________unitVar)
                                {
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _2836 = "highlight-symboluse-declaration";
        }
        else
        {
          _2836 = "highlight-symboluse";
        };
        var cls = _2836;
...
Process__exec$ = (function(location,linuxCmd,cmd)
{
    ...
    if (Process__isWin$()) 
    {
      _3530 = (child_process.execFile(location, cmd, options, (function(_arg3)
      {
    ...
    else
    {
      ...
      _3530 = (child_process.execFile(linuxCmd, prms, options, (function(_arg6)
      {
...
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _3212;
      return Seq__Enumerator$String_1String(f(_3212));
    }));
});
    ...
    return Option__Iterate$JQueryMouseEventObject_JQueryMouseEventObject_((function(e)
    {
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((data != "No tooltip information")) 
          {
            _2221 = ((ViewsHelpers__jq$("\u003cdiv/\u003e").text(data)).append(errTip(data)));
          }
          else
          {
            _2221 = (ViewsHelpers__jq$("\u003cdiv/\u003e").text(errTip("")));
          };
          var _ignored0 = (n_.append(String__Replace$(String__Replace$((_2221.html()), "\\n", "\u003c/br\u003e"), "\n", "\u003c/br\u003e")));
