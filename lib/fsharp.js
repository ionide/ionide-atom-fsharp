...
FAKE__notice$ = (function(isError,text,details)
{
    if ((FAKE__currentNotification.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _2539 = ((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true)));
      }
      else
      {
        _2539 = ((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true)));
      };
      var n = _2539;
...
FAKE__spawn$ = (function(location,cmd)
{
    ...
    else
    {
      ...
      _2354 = (child_process.spawn("mono", prms, options));
    };
    var procs = _2354;
...
Interactive__handleLocation$ = (function(n)
{
    ...
    if (String__StartsWith$(((window.process).platform), "win")) 
    {
      _2999 = (path.join(n.Data, "fsi.exe"));
    }
    else
    {
      _2999 = "fsharpi";
    };
    Interactive__fsipath = _2999;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _3448;
      return Seq__Enumerator$Completion_Completion_(f(_3448));
    }));
});
Seq__Delay$Suggestion_Suggestion_ = (function(f)
{
    ...
    {
      var _3539;
      return Seq__Enumerator$Suggestion_Suggestion_(f(_3539));
    }));
});
