...
FAKE__notice$ = (function(isError,text,details)
{
    if ((FAKE__currentNotification.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _2112 = ((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true)));
      }
      else
      {
        _2112 = ((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true)));
      };
      var n = _2112;
...
FAKE__spawn$ = (function(location,cmd)
{
    ...
    {
      _1927 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _1927 = (child_process.spawn("mono", prms, options));
    };
    var procs = _1927;
...
HighlighterHandler__handle$ = (function(o)
{
    ...
    var action = (function(item)
    {
      ...
      {
        _1572 = "highlight-warning";
      }
      else
      {
        _1572 = "highlight-error";
      };
      var cls = _1572;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _2784;
      return Seq__Enumerator$Completion_Completion_(f(_2784));
    }));
});
Seq__Delay$Suggestion_Suggestion_ = (function(f)
{
    ...
    {
      var _2875;
      return Seq__Enumerator$Suggestion_Suggestion_(f(_2875));
    }));
});
