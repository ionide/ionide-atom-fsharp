...
FSharpIDE__activate$ = (function(x,state)
{
    ...
    FSharpIDE__register$(x, panel);
    FSharpIDE__initialize$(x, panel);
});
...
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _1490;
      return Seq__Enumerator$Object_Object_(f(_1490));
    }));
});
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _1399;
      return Seq__Enumerator$String_1String(f(_1399));
    }));
});
