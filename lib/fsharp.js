    ...
    var ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg3)
    {
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        ...
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _6132 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _6132 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _6132;
          var _6142;
          ...
          else
          {
            if (flag) 
            {
              _6142 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").last()).find(" span.word-container .word")).text());
            }
            else
            {
              _6142 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").first()).find(" span.word-container .word")).text());
            };
          };
          var text = _6142;
            ...
            return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.tabLength")).toString()), Seq__Delay$String_1String((function(___unitVar)
            {
              return Seq__Append$String_1String(Seq__Singleton$String_1String("--pageWidth"), Seq__Delay$String_1String((function(____unitVar)
              {
                return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.preferredLineLength")).toString()), Seq__Delay$String_1String((function(_____unitVar)
                {
                  ...
                  {
                    _4859 = Seq__Singleton$String_1String("--semicolonEOL");
                  }
                  else
                  {
                    _4859 = Seq__Empty$String_1String();
                  };
                  return Seq__Append$String_1String(_4859, Seq__Delay$String_1String((function(______unitVar)
                  {
                    var _4931;
                    if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceBeforeArgument"))) 
                    {
                      _4931 = Seq__Singleton$String_1String("--noSpaceBeforeArgument");
                    }
                    else
                    {
                      _4931 = Seq__Empty$String_1String();
                    };
                    return Seq__Append$String_1String(_4931, Seq__Delay$String_1String((function(_______unitVar)
                    {
                      var _4944;
                      if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceBeforeColon"))) 
                      {
                        _4944 = Seq__Singleton$String_1String("--noSpaceBeforeColon");
                      }
                      else
                      {
                        _4944 = Seq__Empty$String_1String();
                      };
                      return Seq__Append$String_1String(_4944, Seq__Delay$String_1String((function(________unitVar)
                      {
                        var _4957;
                        if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAfterComma"))) 
                        {
                          _4957 = Seq__Singleton$String_1String("--noSpaceAfterComma");
                        }
                        else
                        {
                          _4957 = Seq__Empty$String_1String();
                        };
                        return Seq__Append$String_1String(_4957, Seq__Delay$String_1String((function(_________unitVar)
                        {
                          var _4970;
                          if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAfterSemiColon"))) 
                          {
                            _4970 = Seq__Singleton$String_1String("--noSpaceAfterSemiColon");
                          }
                          else
                          {
                            _4970 = Seq__Empty$String_1String();
                          };
                          return Seq__Append$String_1String(_4970, Seq__Delay$String_1String((function(__________unitVar)
                          {
                            var _4983;
                            if ((((window.atom).config).get("atom-fsharp.FormatDocument.IndentOnTryWith"))) 
                            {
                              _4983 = Seq__Singleton$String_1String("--indentOnTryWith");
                            }
                            else
                            {
                              _4983 = Seq__Empty$String_1String();
                            };
                            return Seq__Append$String_1String(_4983, Seq__Delay$String_1String((function(___________unitVar)
                            {
                              var _4996;
                              if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAroundDelimiter"))) 
                              {
                                _4996 = Seq__Singleton$String_1String("--noSpaceAroundDelimiter");
                              }
                              else
                              {
                                _4996 = Seq__Empty$String_1String();
                              };
                              return Seq__Append$String_1String(_4996, Seq__Delay$String_1String((function(____________unitVar)
                              {
                                var _5009;
                                if ((((window.atom).config).get("atom-fsharp.FormatDocument.ReorderOpenDeclaration"))) 
                                {
                                  _5009 = Seq__Singleton$String_1String("--reorderOpenDeclaration");
                                }
                                else
                                {
                                  _5009 = Seq__Empty$String_1String();
                                };
                                return Seq__Append$String_1String(_5009, Seq__Delay$String_1String((function(_____________unitVar)
                                {
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _4647 = "highlight-symboluse-declaration";
        }
        else
        {
          _4647 = "highlight-symboluse";
        };
        var cls = _4647;
...
Interactive__handleLocation$ = (function(n)
{
    ...
    if (Process__isWin$()) 
    {
      _4237 = (path.join(n.Data, "fsi.exe"));
    }
    else
    {
      _4237 = "fsharpi";
    };
    Interactive__fsipath = _4237;
...
Process__exec$ = (function(location,linuxCmd,cmd)
{
    ...
    if (Process__isWin$()) 
    {
      _5349 = (child_process.execFile(location, cmd, options, (function(_arg3)
      {
        return (function(_arg2)
        {
          return (function(_arg1)
    ...
    else
    {
      ...
      _5349 = (child_process.execFile(linuxCmd, prms, options, (function(_arg6)
      {
...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _4259 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _4259;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _5682;
      return Seq__Enumerator$Completion_Completion_(f(_5682));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _3776;
      return Seq__Enumerator$Object_Object_(f(_3776));
    }));
});
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _5031;
      return Seq__Enumerator$String_1String(f(_5031));
    }));
});
