...
FAKE__jqC$ = (function(context,selector)
{
...
FAKE__notice$ = (function(isError,text,details)
{
    ...
    else
    {
      ...
      var t = FAKE__jqC$(view, ".content .detail .detail-content");
...
FAKE__spawn$ = (function(location,cmd)
{
    ...
    {
      _2352 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _2352 = (child_process.spawn("mono", prms, options));
    };
    var procs = _2352;
...
Interactive__handleLocation$ = (function(n)
{
    ...
    if (String__StartsWith$(((window.process).platform), "win")) 
    {
      _2997 = (path.join(n.Data, "fsi.exe"));
    }
    else
    {
      _2997 = "fsharpi";
    };
    Interactive__fsipath = _2997;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _3425;
      return Seq__Enumerator$Completion_Completion_(f(_3425));
    }));
});
Seq__Delay$Suggestion_Suggestion_ = (function(f)
{
    ...
    {
      var _3516;
      return Seq__Enumerator$Suggestion_Suggestion_(f(_3516));
    }));
});
