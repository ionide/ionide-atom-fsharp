...
FAKE__notice$ = (function(isError,text,details)
{
    if ((FAKE__currentNotification.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _1690 = ((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true)));
      }
      else
      {
        _1690 = ((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true)));
      };
      var n = _1690;
...
FAKE__spawn$ = (function(location,cmd)
{
    ...
    {
      _1505 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _1505 = (child_process.spawn("mono", prms, options));
    };
    var procs = _1505;
...
FSharpIDE__parseProjectForEditor$ = (function(_this,editor)
{
    ...
    if (((editor != undefined) && (editor["buffer"] != undefined))) 
    {
      var status = "Loading";
...
HighlighterHandler__handle$ = (function(lst)
{
    ...
    var action = (function(item)
    {
      ...
      {
        _1299 = "highlight-warning";
      }
      else
      {
        _1299 = "highlight-error";
      };
      var cls = _1299;
...
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _2537;
      return Seq__Enumerator$Object_Object_(f(_2537));
    }));
});
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _2446;
      return Seq__Enumerator$String_1String(f(_2446));
    }));
});
