...
AutocompleteProvider__create$ = (function(unitVar0)
{
    ...
    var _16563;
    Event_1_Object__Trigger$Object_(AutocompleteProvider__checkAutoCompleteManager, _16563);
    ...
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$IEmitter__Unit_IEmitter__Unit_(Async__get_async$(), Control__Async_AwaitObservable_Static$IEmitter_IEmitter_(AutocompleteProvider__autoCompleteManagerAvailable), (function(_arg1)
      {
        ...
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _16483 = ((ViewsHelpers__jq$("li.selected").prev()).find("span.word-container .word"));
          }
          else
          {
            _16483 = ((ViewsHelpers__jq$("li.selected").next()).find("span.word-container .word"));
          };
          var selected = _16483;
          var _16493;
          if (((selected.length) > 0.000000)) 
          {
            _16493 = (selected.text());
          }
          else
          {
            if (flag) 
            {
              _16493 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").last()).find(" span.word-container .word")).text());
            }
            else
            {
              _16493 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").first()).find(" span.word-container .word")).text());
            };
          };
          var text = _16493;
...
AutocompleteProvider__registerHelptextHandler$Unit_Unit_ = (function(disposePrevious)
{
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$IEditor__Unit_IEditor__Unit_(Async__get_async$(), Control__Async_AwaitObservable_Static$IEditor_IEditor_(Event_1_Object__get_Publish$Object_(AutocompleteProvider__editorChanged)), (function(_arg1)
      {
        var editor = _arg1;
        var _16815;
        disposePrevious(_16815);
        var _16816;
        if ((!ViewsHelpers__isFSharpEditor$(editor))) 
        {
          _16816 = (function(value)
          {
            var ignored0 = value;
          });
        }
...
ErrorLinterProvider__lint$ = (function(editor)
{
    return Control__Async_StartAsPromise_Static$Object_Object_(AsyncBuilder__Delay$Object___Object___(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_Error____Object___FSharpOption_1_Result_1_Error____Object___(Async__get_async$(), LanguageService__parseEditor$(editor), (function(_arg1)
      {
        ...
        {
          var n = Option__GetValue$Result_1_Error___Result_1_Error___(result);
          ...
          _15785 = Array__Map$Error__Object_Error__Object_(map, n.Data);
        }
        else
        {
          _15785 = [];
        };
        return AsyncBuilder__Return$Object___Object___(Async__get_async$(), _15785);
      }));
    })));
});
    ...
    return {Subscribe: (function(observer)
    {
      return (function(x,observer)
      {
        ...
        }), OnCompleted: (function(unitVar1)
        {
          ...
          {
            var _16256;
            return _this.onCompleted(_16256);
          })(_impl, unitVar1);
        })});
      })(impl, observer);
    })};
...
Observable__protect$FSharpOption_1_IEmitter__Unit_FSharpOption_1_IEmitter__Unit_ = (function(f,succeed,fail)
{
    ...
    {
      var _16219;
      _16216 = (new FSharpChoice_2_FSharpOption_1_IEmitter__Exception__Choice1Of2FSharpOption_1_IEmitter__Exception_(f(_16219)));
    }
    catch(e){
      _16216 = (new FSharpChoice_2_FSharpOption_1_IEmitter__Exception__Choice2Of2FSharpOption_1_IEmitter__Exception_(e));
    };
    var matchValue = _16216;
    if ((matchValue.Tag == 1.000000)) 
    {
