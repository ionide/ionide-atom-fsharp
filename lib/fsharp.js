...
FAKE__notice$ = (function(isError,text,details)
{
    if ((FAKE__currentNotification.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _1695 = ((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true)));
      }
      else
      {
        _1695 = ((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true)));
      };
      var n = _1695;
...
FAKE__spawn$ = (function(location,cmd)
{
    ...
    {
      _1510 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _1510 = (child_process.spawn("mono", prms, options));
    };
    var procs = _1510;
...
FSharpIDE__parseProjectForEditor$ = (function(_this,editor)
{
    ...
    if ((((editor != undefined) && (editor["buffer"] != undefined)) && ((editor.buffer) != null))) 
    {
...
HighlighterHandler__handle$ = (function(lst)
{
    ...
    var action = (function(item)
    {
      ...
      {
        _1304 = "highlight-warning";
      }
      else
      {
        _1304 = "highlight-error";
      };
      var cls = _1304;
...
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _2542;
      return Seq__Enumerator$Object_Object_(f(_2542));
    }));
});
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _2451;
      return Seq__Enumerator$String_1String(f(_2451));
    }));
});
