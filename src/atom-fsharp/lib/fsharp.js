...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _2790;
      return Seq__Enumerator$Completion_Completion_(f(_2790));
    }));
});
Seq__Delay$Suggestion_Suggestion_ = (function(f)
{
    ...
    {
      var _2881;
      return Seq__Enumerator$Suggestion_Suggestion_(f(_2881));
    }));
});
