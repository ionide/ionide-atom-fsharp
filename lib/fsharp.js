...
var position___ctor$, position__GeneratedCompareTo, list_1_String____NilString___, list_1_String____ConsString___, list_1_String__NilString, list_1_String__ConsString, cords___ctor$, ViewsHelpers__pixelPositionFromMouseEvent$, ViewsHelpers__jq_$, ViewsHelpers__jqC$, ViewsHelpers__jq$, ViewsHelpers__getElementsByClass$Element_Element_, ViewsHelpers__bufferPositionFromMouseEvent$, UnfoldEnumerator_2_Int32__String___ctor$Int32_String, UnfoldEnumerator_2_Int32__String_____ctor$Int32_String___, UnfoldEnumerator_2_Int32__Match___ctor$Int32_Match_1, UnfoldEnumerator_2_Int32__IDisposable___ctor$Int32_IDisposable_, UnfoldEnumerator_2_Int32__Completion___ctor$Int32_Completion_, UnfoldEnumerator_2_Int32__BuildData___ctor$Int32_BuildData_, UnfoldEnumerator_2_IEnumerator_1_Completion__Suggestion___ctor$IEnumerator_1_Completion__Suggestion_, UnfoldEnumerator_2_IEnumerator_1_Completion__Completion___ctor$IEnumerator_1_Completion__Completion_, UnfoldEnumerator_2_IEnumerator_1_BuildData__Object___ctor$IEnumerator_1_BuildData__Object_, UnfoldEnumerator_2_FSharpList_1_String____String_____ctor$FSharpList_1_String____String___, UnfoldEnumerator_2_FSharpList_1_String__String___ctor$FSharpList_1_String__String, TupleSuggestion__IEnumerator_1_Completion_, TupleString____Int32, TupleString____FSharpList_1_String___, TupleString_String, TupleString_Int32, TupleString_FSharpList_1_String_, TupleSelectListView__IPanel_, TupleObject__IEnumerator_1_BuildData_, TupleMatch_1_Int32, TupleIDisposable__Int32, TupleError__String, TupleCompletion__Int32, TupleCompletion__IEnumerator_1_Completion_, TupleBuildData__Int32, TooltipHandler__tooltip, TooltipHandler__timer, TooltipHandler__subscriptions, TooltipHandler__remove$, TooltipHandler__reg$, TooltipHandler__mouseHandler$, TooltipHandler__matchError$, TooltipHandler__lastMousePosition, TooltipHandler__initialize$, TooltipHandler__get_tooltip$, TooltipHandler__get_timer$, TooltipHandler__get_subscriptions$, TooltipHandler__get_lastMousePosition$, TooltipHandler__get_event$, TooltipHandler__get_errorArr$, TooltipHandler__get_ed$, TooltipHandler__getPosition$, TooltipHandler__event, TooltipHandler__errorHandler$, TooltipHandler__errorArr, TooltipHandler__ed, TooltipHandler__deactivate$, TooltipHandler__dashes$, TooltipHandler__createTooltip$, TooltipHandler__clearTimer$, TooltipHandler__activate$, ToolbarHandler__subscriptions, ToolbarHandler__remove$, ToolbarHandler__initialize$, ToolbarHandler__handleEditorChange$, ToolbarHandler__get_subscriptions$, ToolbarHandler__get_ed$, ToolbarHandler__get_cursorSubscription$, ToolbarHandler__get_bar$, ToolbarHandler__getCursor$, ToolbarHandler__format_data$, ToolbarHandler__ed, ToolbarHandler__deactivate$, ToolbarHandler__cursorSubscription, ToolbarHandler__cursorHandler$, ToolbarHandler__createToolbar$, ToolbarHandler__bar, ToolbarHandler__askForToolbar$, ToolbarHandler__activate$, T___ctor$, Suggestion___ctor$, String__StartsWith$, String__SplitWithoutOptions$, String__Replace$, String__PrintFormatToString$, StatusBar__subscriptions, StatusBar__statusbar, StatusBar__notification, StatusBar__get_subscriptions$, StatusBar__get_statusbar$, StatusBar__get_notification$, StatusBar__addStatusNotification$, StatusBar__activate$, StatusBarOptions___ctor$, State__On, State__Off, Seq__Where$Completion_Completion_, Seq__Unfold$Int32__String___Int32_String___, Seq__Unfold$Int32__String_1Int32_String, Seq__Unfold$Int32__Match_1Int32_Match_1, Seq__Unfold$Int32__IDisposable_Int32_IDisposable_, Seq__Unfold$Int32__Completion_Int32_Completion_, Seq__Unfold$Int32__BuildData_Int32_BuildData_, Seq__Unfold$IEnumerator_1_Completion__Suggestion_IEnumerator_1_Completion__Suggestion_, Seq__Unfold$IEnumerator_1_Completion__Completion_IEnumerator_1_Completion__Completion_, Seq__Unfold$IEnumerator_1_BuildData__Object_IEnumerator_1_BuildData__Object_, Seq__Unfold$FSharpList_1_String____String___FSharpList_1_String____String___, Seq__Unfold$FSharpList_1_String__String_1FSharpList_1_String__String, Seq__TryPickIndexedAux$BuildData__BuildData_BuildData__BuildData_, Seq__TryPickIndexed$BuildData__BuildData_BuildData__BuildData_, Seq__TryFindIndexed$BuildData_BuildData_, Seq__ToArray$Suggestion_Suggestion_, Seq__ToArray$String___String___, Seq__ToArray$String_1String, Seq__ToArray$Object_Object_, Seq__ToArray$Match_1Match_1, Seq__ToArray$BuildData_BuildData_, Seq__SortBy$BuildData__DateTime_1BuildData__DateTime_1, Seq__OfList$String___String___, Seq__OfList$String_1String, Seq__OfArray$String___String___, Seq__OfArray$String_1String, Seq__OfArray$Completion_Completion_, Seq__OfArray$BuildData_BuildData_, Seq__Map$Completion__Suggestion_Completion__Suggestion_, Seq__Map$BuildData__Object_BuildData__Object_, Seq__IterateIndexed$Suggestion_Suggestion_, Seq__IterateIndexed$String___String___, Seq__IterateIndexed$String_1String, Seq__IterateIndexed$Object_Object_, Seq__IterateIndexed$Match_1Match_1, Seq__IterateIndexed$BuildData_BuildData_, Seq__Iterate$String_1String, Seq__Iterate$IDisposable_IDisposable_, Seq__FromFactory$Suggestion_Suggestion_, Seq__FromFactory$String___String___, Seq__FromFactory$String_1String, Seq__FromFactory$Object_Object_, Seq__FromFactory$Match_1Match_1, Seq__FromFactory$IDisposable_IDisposable_, Seq__FromFactory$Completion_Completion_, Seq__FromFactory$BuildData_BuildData_, Seq__FoldIndexedAux$Unit__Suggestion_Unit__Suggestion_, Seq__FoldIndexedAux$Unit__String___Unit__String___, Seq__FoldIndexedAux$Unit__String_1Unit__String, Seq__FoldIndexedAux$Unit__Object_Unit__Object_, Seq__FoldIndexedAux$Unit__Match_1Unit__Match_1, Seq__FoldIndexedAux$Unit__IDisposable_Unit__IDisposable_, Seq__FoldIndexedAux$Unit__BuildData_Unit__BuildData_, Seq__FoldIndexed$Suggestion__Unit_Suggestion__Unit_, Seq__FoldIndexed$String____Unit_String____Unit_, Seq__FoldIndexed$String_1_Unit_String_Unit_, Seq__FoldIndexed$Object__Unit_Object__Unit_, Seq__FoldIndexed$Match_1_Unit_Match_1_Unit_, Seq__FoldIndexed$IDisposable__Unit_IDisposable__Unit_, Seq__FoldIndexed$BuildData__Unit_BuildData__Unit_, Seq__Fold$String_1_Unit_String_Unit_, Seq__Fold$IDisposable__Unit_IDisposable__Unit_, Seq__FindIndexed$BuildData_BuildData_, Seq__Find$BuildData_BuildData_, Seq__Filter$Completion_Completion_, Seq__Enumerator$Suggestion_Suggestion_, Seq__Enumerator$String___String___, Seq__Enumerator$String_1String, Seq__Enumerator$Object_Object_, Seq__Enumerator$Match_1Match_1, Seq__Enumerator$IDisposable_IDisposable_, Seq__Enumerator$Completion_Completion_, Seq__Enumerator$BuildData_BuildData_, Seq__Delay$Suggestion_Suggestion_, Seq__Delay$Object_Object_, Seq__Delay$Completion_Completion_, Seq__Cast$Match_1Match_1, ResizeArray__ToSeq$IDisposable_IDisposable_, ResizeArray__ToSeq$BuildData_BuildData_, ResizeArray_1_Object__get_Item$Object_, ResizeArray_1_Object__get_Count$Object_, Regex__MatchesWithOffset$, Regex__MatchesStatic$, Regex__Matches$, Regex__MatchFirstWithOffset$, Regex__MatchFirstStatic$, Regex__MatchFirst$, Regex__MatchCollectionToSeq$, Regex__Create$, Provider___ctor$, Process__spawnWithNotifications$, Process__spawnSimple$, Process__spawnSame$, Process__notice$, Process__isWin$, Process__handleExit$Notification_Notification_, Process__handle$Object_Object_, Parser__subscriptions, Parser__projects, Parser__parseProjectForEditor$, Parser__h, Parser__get_subscriptions$, Parser__get_projects$, Parser__get_h$, Parser__deactivate$, Parser__activate$, PanelOptions___ctor$, Options___ctor$, Option__Map$NodeList__JQuery_NodeList__JQuery_, Option__Map$NodeList__Element_NodeList__Element_, Option__Map$NodeList__Coordinates_NodeList__Coordinates_, Option__Map$HTMLElement__NodeList_HTMLElement__NodeList_, Option__Map$Element__HTMLElement_Element__HTMLElement_, Option__Iterate$Tuple_2_String__String_Tuple_2_String__String_, Option__Iterate$Tuple_2_SelectListView__IPanel_Tuple_2_SelectListView__IPanel_, Option__Iterate$Timer_Timer_, Option__Iterate$Notification_Notification_, Option__Iterate$JQuery_JQuery_, Option__Iterate$JQueryMouseEventObject_JQueryMouseEventObject_, Option__Iterate$ITile_ITile_, Option__Iterate$IStatusBar_IStatusBar_, Option__Iterate$IPanel_IPanel_, Option__Iterate$IEditor_IEditor_, Option__Iterate$IDisposable_IDisposable_, Option__Iterate$Element_Element_, Option__Iterate$ChildProcess_ChildProcess_, Option__IsSome$Int32_Int32, Option__IsSome$IEnumerator_1_Completion_IEnumerator_1_Completion_, Option__IsSome$IEnumerator_1_BuildData_IEnumerator_1_BuildData_, Option__IsSome$IEditor_IEditor_, Option__IsSome$FSharpList_1_String___FSharpList_1_String___, Option__IsSome$FSharpList_1_String_FSharpList_1_String_, Option__IsSome$Error_Error_, Option__IsSome$CompletionResult_CompletionResult_, Option__IsSome$ChildProcess_ChildProcess_, Option__IsNone$Error_Error_, Option__IsNone$CompletionResult_CompletionResult_, Option__IsNone$ChildProcess_ChildProcess_, Option__GetValue$Tuple_2_Suggestion__IEnumerator_1_Completion_Tuple_2_Suggestion__IEnumerator_1_Completion_, Option__GetValue$Tuple_2_String____Int32_Tuple_2_String____Int32_, Option__GetValue$Tuple_2_String____FSharpList_1_String___Tuple_2_String____FSharpList_1_String___, Option__GetValue$Tuple_2_String__String_Tuple_2_String__String_, Option__GetValue$Tuple_2_String__Int32_Tuple_2_String__Int32_, Option__GetValue$Tuple_2_String__FSharpList_1_String_Tuple_2_String__FSharpList_1_String_, Option__GetValue$Tuple_2_SelectListView__IPanel_Tuple_2_SelectListView__IPanel_, Option__GetValue$Tuple_2_Object__IEnumerator_1_BuildData_Tuple_2_Object__IEnumerator_1_BuildData_, Option__GetValue$Tuple_2_Match__Int32_Tuple_2_Match__Int32_, Option__GetValue$Tuple_2_IDisposable__Int32_Tuple_2_IDisposable__Int32_, Option__GetValue$Tuple_2_Completion__Int32_Tuple_2_Completion__Int32_, Option__GetValue$Tuple_2_Completion__IEnumerator_1_Completion_Tuple_2_Completion__IEnumerator_1_Completion_, Option__GetValue$Tuple_2_BuildData__Int32_Tuple_2_BuildData__Int32_, Option__GetValue$Timer_Timer_, Option__GetValue$String_1String, Option__GetValue$Notification_Notification_, Option__GetValue$NodeList_NodeList_, Option__GetValue$JQuery_JQuery_, Option__GetValue$JQueryMouseEventObject_JQueryMouseEventObject_, Option__GetValue$Int32_Int32, Option__GetValue$ITile_ITile_, Option__GetValue$IStatusBar_IStatusBar_, Option__GetValue$IPanel_IPanel_, Option__GetValue$IEnumerator_1_Completion_IEnumerator_1_Completion_, Option__GetValue$IEnumerator_1_BuildData_IEnumerator_1_BuildData_, Option__GetValue$IEditor_IEditor_, Option__GetValue$IDisposable_IDisposable_, Option__GetValue$HTMLElement_HTMLElement_, Option__GetValue$FSharpList_1_String___FSharpList_1_String___, Option__GetValue$FSharpList_1_String_FSharpList_1_String_, Option__GetValue$Error_Error_, Option__GetValue$Element_Element_, Option__GetValue$Coordinates_Coordinates_, Option__GetValue$CompletionResult_CompletionResult_, Option__GetValue$ChildProcess_ChildProcess_, Option__GetValue$BuildData_BuildData_, OpenOptions___ctor$, OpenEditorOptions___ctor$, NotificationsOptions___ctor$, Match__get_Groups$, MatchCollection__get_Item$, MatchCollection__get_Count$, List__Tail$String___String___, List__Tail$String_1String, List__Head$String___String___, List__Head$String_1String, List__Empty$String___String___, List__Empty$String_1String, List__CreateCons$String___String___, List__CreateCons$String_1String, ListView__regiterListView$FSharpFunc_2_ItemDescription__JQuery_FSharpFunc_2_ItemDescription__JQuery_, LanguageService__tooltip$, LanguageService__toolbarFlag, LanguageService__toolbar$, LanguageService__stop$, LanguageService__start$, LanguageService__service, LanguageService__send$, LanguageService__project$, LanguageService__parseResponse$, LanguageService__parseEditor$, LanguageService__parse$, LanguageService__last, LanguageService__get_toolbarFlag$, LanguageService__get_service$, LanguageService__get_last$, LanguageService__get_encoding$, LanguageService__findDeclaration$, LanguageService__encoding, LanguageService__completion$, LanguageService__ask$, ItemDescription___ctor$, Interactive__subscriptions, Interactive__startFsi$, Interactive__sendToFsi$, Interactive__sendSelection$, Interactive__sendLine$, Interactive__sendFile$, Interactive__resetFsi$, Interactive__openFsi$, Interactive__handleLocation$, Interactive__handle$, Interactive__get_subscriptions$, Interactive__get_fsipath$, Interactive__get_fsiProc$, Interactive__get_fsiEditor$, Interactive__fsipath, Interactive__fsiProc, Interactive__fsiEditor, Interactive__deactivate$, Interactive__activate$, HighlighterHandler__subscriptions, HighlighterHandler__marked, HighlighterHandler__handle$, HighlighterHandler__get_subscriptions$, HighlighterHandler__get_marked$, HighlighterHandler__deactivate$, HighlighterHandler__activate$, Group__get_Success$, GroupCollection__get_Item$, FindDeclaration__openDec$, FindDeclaration__handle$Unit_Unit_, FindDeclaration__deactivate$, FindDeclaration__activate$, FSharpString__emptyIfNull$, FSharpString__Replicate$, FSharpString__Initialize$, FSharpString__Concat$, FSharpIDE__provide$, FSharpIDE__getSuggestion$, FSharpIDE__deactivate$, FSharpIDE__consumeStatusBar$, FSharpIDE__activate$, FSharpIDE___ctor$, FAKE__viewForItem$, FAKE__taskListView, FAKE__registerTaskList$, FAKE__registerBuildList$, FAKE__get_taskListView$, FAKE__get_buildListView$, FAKE__get_File$, FAKE__get_BuildList$, FAKE__deactivate$, FAKE__buildListView, FAKE__activate$, FAKE__ShowBuildList$, FAKE__File, FAKE__FAKENotFound$, FAKE__BuildTask$, FAKE__BuildList, Events__parseAndEmit$TooltipResult_TooltipResult_, Events__parseAndEmit$ParseResult_ParseResult_, Events__parseAndEmit$CompletionResult_CompletionResult_, Events__parseAndEmit$CompilerLocationResult_CompilerLocationResult_, Events__once$Object__Unit_Object__Unit_, Events__once$FindDeclarationResult__Unit_FindDeclarationResult__Unit_, Events__once$CompletionResult__Unit_CompletionResult__Unit_, Events__on$, Events__log$String_1_TooltipResult_String_TooltipResult_, Events__log$String_1_String_1String_String, Events__log$String_1_ParseResult_String_ParseResult_, Events__log$String_1_CompletionResult_String_CompletionResult_, Events__log$String_1_CompilerLocationResult_String_CompilerLocationResult_, Events__last, Events__get_last$, Events__get_emitter$, Events__getName$, Events__emitter, Events__emitEmpty$String_1String, Events__emit$String_1String, EventType__Tooltips, EventType__Toolbars, EventType__Status, EventType__ServerStop, EventType__ServerStart, EventType__ServerError, EventType__Project, EventType__FindDecl, EventType__Errors, EventType__Completion, EventType__CompilerLocation, ErrorPanel__subscriptions, ErrorPanel__panel, ErrorPanel__handleEditorChange$, ErrorPanel__handle$, ErrorPanel__get_subscriptions$, ErrorPanel__get_panel$, ErrorPanel__deactivate$, ErrorPanel__createRow$, ErrorPanel__create$, ErrorPanel__addMinimize$, ErrorPanel__activate$, DateTime__get_Now$, DateTime__createUnsafe$, DateTime__ToShortTimeString$, DateTime__ToShortDateString$, DateTime__Compare$, CreateEnumerable_1_Suggestion___ctor$Suggestion_, CreateEnumerable_1_String___ctor$String, CreateEnumerable_1_String_____ctor$String___, CreateEnumerable_1_Object___ctor$Object_, CreateEnumerable_1_Match___ctor$Match_1, CreateEnumerable_1_IDisposable___ctor$IDisposable_, CreateEnumerable_1_Completion___ctor$Completion_, CreateEnumerable_1_BuildData___ctor$BuildData_, CompareTo, Capture__get_Value$, Capture__getValue$, BuildData___ctor$, AutocompleteProvider__lastResult, AutocompleteProvider__isForced, AutocompleteProvider__get_lastResult$, AutocompleteProvider__get_isForced$, AutocompleteProvider__getSuggestion$, AutocompleteProvider__create$, Atom__addCommand$, Array__ZeroCreate$Suggestion_Suggestion_, Array__ZeroCreate$String___String___, Array__ZeroCreate$String_1String, Array__ZeroCreate$Object_Object_, Array__ZeroCreate$Match_1Match_1, Array__ZeroCreate$BuildData_BuildData_, Array__TryPickIndexedAux$String_1_String_1String_String, Array__TryPickIndexedAux$Error__Error_Error__Error_, Array__TryPickIndexed$String_1_String_1String_String, Array__TryPickIndexed$Error__Error_Error__Error_, Array__TryFind$String_1String, Array__TryFind$Error_Error_, Array__SortInPlaceWith$BuildData_BuildData_, Array__SortInPlaceBy$BuildData__DateTime_1BuildData__DateTime_1, Array__Reverse$Object_Object_, Array__MapIndexed$String_1_String___String_String___, Array__MapIndexed$Match_1_Object_Match_1_Object_, Array__Map$String_1_String___String_String___, Array__Map$Match_1_Object_Match_1_Object_, Array__Length$String_1String, Array__Length$Object_Object_, Array__Length$Match_1Match_1, Array__Length$IEditor_IEditor_, Array__Length$IDisplayBufferMarker_IDisplayBufferMarker_, Array__Length$Error_Error_, Array__Iterate$IEditor_IEditor_, Array__Iterate$IDisplayBufferMarker_IDisplayBufferMarker_, Array__Iterate$Error_Error_, Array__Initialize$String_1String, Array__FoldIndexed$Unit__IEditor_Unit__IEditor_, Array__FoldIndexed$Unit__IDisplayBufferMarker_Unit__IDisplayBufferMarker_, Array__FoldIndexed$Unit__Error_Unit__Error_, Array__FoldIndexed$String____String_1String____String, Array__Fold$String_1_String___String_String___, Array__Fold$IEditor__Unit_IEditor__Unit_, Array__Fold$IDisplayBufferMarker__Unit_IDisplayBufferMarker__Unit_, Array__Fold$Error__Unit_Error__Unit_, Array__Empty$IDisplayBufferMarker_IDisplayBufferMarker_, Array__ConcatImpl$String_1String, Array__Concat$String_1String, Array__BoxedLength$, Array__Append$IDisplayBufferMarker_IDisplayBufferMarker_;
...
{
    Atom__addCommand$("atom-text-editor", "fsharp:autocomplete", (function(_arg1)
    {
...
AutocompleteProvider__getSuggestion$ = (function(options)
{
    if ((((options.editor.buffer).file) != null)) 
    {
      ...
      {
        _4091 = options.prefix;
      };
      var prefix = _4091;
      return new Promise(function(resolve){(function(unitVar0)
      {
        if (((AutocompleteProvider__isForced || Option__IsNone$CompletionResult_CompletionResult_(AutocompleteProvider__lastResult)) || (options.prefix == "."))) 
        {
          Events__once$Object__Unit_Object__Unit_((new EventType__Errors()), (function(_arg1)
          {
...
Events__emitEmpty$String_1String = (function(t,s)
{
    ...
    var _290;
    return Events__emitter.emit(name, _290);
});
    ...
    var proj = (function(ex)
    {
      return (function(arr)
      {
        ...
        else
        {
          ...
          var regex = Regex__MatchFirstStatic$(file, "FAKE.exe.* ([\\w]+\\.fsx)");
          if (Group__get_Success$(regex)) 
          {
            ...
            Atom__addCommand$("atom-workspace", "FAKE: Show Builds", (function(arg00_)
            {
...
FAKE__registerBuildList$ = (function(unitVar0)
{
    ...
    var confirmedCallback = (function(buildDescription)
    {
      ...
      ((window.atom).workspace).open(buildDescription.data, (new OpenEditorOptions___ctor$("right"))).done((function(ed)
      {
        ...
        var ignored0 = (ed.onDidDestroy((function(_arg2)
        {
...
FAKE__registerTaskList$ = (function(unitVar0)
{
    ...
    var confirmedCallback = (function(packageDescription)
    {
      ...
      return Option__Iterate$Tuple_2_String__String_Tuple_2_String__String_((function(tupledArg)
      {
        ...
        var ignored0 = (fakeProcess.on("exit", (function(_arg2)
        {
...
HighlighterHandler__handle$ = (function(o)
{
    ...
    var action = (function(item)
    {
      ...
      {
        _1252 = "highlight-warning";
      }
      else
      {
        _1252 = "highlight-error";
      };
      var cls = _1252;
...
Interactive__activate$ = (function(unitVar0)
{
    ...
    Atom__addCommand$("atom-workspace", "FSI:Open", (function(arg00_)
    {
      return Interactive__openFsi$();
    }));
    Atom__addCommand$("atom-text-editor", "FSI:Send-Line", (function(arg00_)
    {
      return Interactive__sendLine$();
    }));
    Atom__addCommand$("atom-text-editor", "FSI:Send-Selection", (function(arg00_)
    {
      return Interactive__sendSelection$();
    }));
    Atom__addCommand$("atom-text-editor", "FSI:Send-File", (function(arg00_)
    {
      return Interactive__sendFile$();
    }));
    Atom__addCommand$("atom-text-editor", "FSI:Reset-REPL", (function(arg00_)
    {
...
Interactive__deactivate$ = (function(unitVar0)
{
    ...
    {
      return (n.dispose());
    }), ResizeArray__ToSeq$IDisposable_IDisposable_(Interactive__subscriptions));
...
Interactive__handleLocation$ = (function(n)
{
    ...
    if (Process__isWin$()) 
    {
      _3850 = (path.join(n.Data, "fsi.exe"));
    }
    else
    {
      _3850 = "fsharpi";
    };
    Interactive__fsipath = _3850;
...
Process__handleExit$Notification_Notification_ = (function(currentNotification,code)
{
...
Process__notice$ = (function(currentNotification,isError,text,details)
{
    ...
    if ((matchValue.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _2744 = ((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true)));
      }
      else
      {
        _2744 = ((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true)));
      };
      var n = _2744;
    ...
    {
      var _n = Option__GetValue$Notification_Notification_(matchValue);
...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _3872 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _3872;
...
Process__spawnWithNotifications$ = (function(location,linuxCmd,cmd)
{
    ...
    {
      _2541 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _2541;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
    var _2557;
    if (Process__isWin$()) 
    {
      _2557 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _2557 = (child_process.spawn(linuxCmd, prms, options));
    };
    var procs = _2557;
    var currentNotification = {contents: {Tag: 0.000000}};
    var ignored0 = (procs.on("exit", (function(code)
    {
      return Process__handleExit$Notification_Notification_(currentNotification, code);
    })));
    var error = false;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _4298;
      return Seq__Enumerator$Completion_Completion_(f(_4298));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _3745;
      return Seq__Enumerator$Object_Object_(f(_3745));
    }));
});
Seq__Delay$Suggestion_Suggestion_ = (function(f)
{
    ...
    {
      var _4389;
      return Seq__Enumerator$Suggestion_Suggestion_(f(_4389));
    }));
});
...
ToolbarHandler__deactivate$ = (function(unitVar0)
{
    ...
    {
      return (n.dispose());
    }), ResizeArray__ToSeq$IDisposable_IDisposable_(ToolbarHandler__subscriptions));
    (ToolbarHandler__subscriptions = []);
    Option__Iterate$IDisposable_IDisposable_((function(cs)
    {
      return (cs.dispose());
...
ToolbarHandler__format_data$ = (function(tinfo)
{
    var ti = tinfo.trim();
    var _2339;
    if (String__StartsWith$(ti, "type")) 
    {
      var idx = ti.indexOf("=");
      _2339 = ti.substring(0, 0 + (idx - 1));
    }
    else
    {
      _2339 = ti;
...
ToolbarHandler__initialize$ = (function(editor)
{
    ...
    if ((((editor != undefined) && (editor["getGrammar"] != undefined)) && (((editor.getGrammar()).name) == "F#"))) 
    {
      ...
      {
        return {Tag: 1.000000, Value: arg0};
      })((editor.onDidChangeCursorPosition((function(n)
      {
...
{
    return Option__Iterate$IDisposable_IDisposable_((function(cs)
    {
      (cs.dispose());
    ...
    return Option__Iterate$JQueryMouseEventObject_JQueryMouseEventObject_((function(e)
    {
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((o.Data != "No tooltip information")) 
          {
            _1956 = ((ViewsHelpers__jq$("\u003cdiv/\u003e").text(o.Data)).append(errTip(o.Data)));
          }
          else
          {
            _1956 = (ViewsHelpers__jq$("\u003cdiv/\u003e").text(errTip("")));
          };
          var _ignored0 = (n_.append(String__Replace$(String__Replace$((_1956.html()), "\\n", "\u003c/br\u003e"), "\n", "\u003c/br\u003e")));
          ...
          var ___ignored0 = (TooltipHandler__tooltip.css("top", y));
