    ...
    var __ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg4)
    {
      ...
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _13187 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _13187 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _13187;
          var _13197;
          if (((selected.length) > 0.000000)) 
          {
            _13197 = (selected.text());
          }
          else
          {
            if (flag) 
            {
              _13197 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").last()).find(" span.word-container .word")).text());
            }
            else
            {
              _13197 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").first()).find(" span.word-container .word")).text());
            };
          };
          var text = _13197;
...
AutocompleteProvider__getSuggestion$ = (function(options)
{
    if ((((options.editor.buffer).file) != null)) 
    {
      ...
      {
        _4621 = ((col - 2) - options.prefix.length);
      }
      else
      {
        _4621 = col;
      ...
      return new Promise(function(resolve,reject){(function(unitVar0)
      {
        ...
        else
        {
            ...
            Events__once$Object__Unit_Object__Unit_((new EventType__Errors()), (function(result)
            {
              Events__once$Result_1_Completion____Unit_Result_1_Completion____Unit_((new EventType__Completion()), (function(_result)
              {
                ...
                if ((((options.editor.buffer).lines)[row_].charAt(col_) == "\\")) 
                {
                  ...
                  _4683 = CompletionHelpers__glyph_completion$(prefix, GlyphMaps__unicode_map);
                }
                else
                {
                  AutocompleteProvider__lastResult = {Tag: 1.000000, Value: _result};
                  _4683 = CompletionHelpers__fsharp_completion$(prefix, _result.Data);
                };
                var r = _4683;
          ...
          else
          {
            ...
            if ((((options.editor.buffer).lines)[row_].charAt(col_) == "\\")) 
            {
              _12947 = CompletionHelpers__glyph_completion$(prefix, Option__GetValue$Result_1_Completion___Result_1_Completion___(AutocompleteProvider__lastResult).Data);
            }
            else
            {
              _12947 = CompletionHelpers__fsharp_completion$(prefix, Option__GetValue$Result_1_Completion___Result_1_Completion___(AutocompleteProvider__lastResult).Data);
            };
            var r = _12947;
            if ((Array__BoxedLength$(r) > 0)) 
            {
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              {
                _12619 = dist((___i - 1))((___j - 1));
              }
              else
              {
                _12619 = CompletionHelpers__min3$Int32_Int32((dist((___i - 1))(___j) + 1), (dist(___i)((___j - 1)) + 1), (dist((___i - 1))((___j - 1)) + 1));
              };
              var dval = _12619;
...
{
    var _4577;
    return (((window.atom).workspace).open("atom://config/packages/ionide-fsharp", _4577));
});
            ...
            return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.tabLength")).toString()), Seq__Delay$String_1String((function(___unitVar)
            {
              return Seq__Append$String_1String(Seq__Singleton$String_1String("--pageWidth"), Seq__Delay$String_1String((function(____unitVar)
              {
                return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.preferredLineLength")).toString()), Seq__Delay$String_1String((function(_____unitVar)
                {
                  ...
                  {
                    _4005 = Seq__Singleton$String_1String("--semicolonEOL");
                  }
                  else
                  {
                    _4005 = Seq__Empty$String_1String();
                  };
                  return Seq__Append$String_1String(_4005, Seq__Delay$String_1String((function(______unitVar)
                  {
                    var _4077;
                    if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceBeforeArgument"))) 
                    {
                      _4077 = Seq__Singleton$String_1String("--noSpaceBeforeArgument");
                    }
                    else
                    {
                      _4077 = Seq__Empty$String_1String();
                    };
                    return Seq__Append$String_1String(_4077, Seq__Delay$String_1String((function(_______unitVar)
                    {
                      var _4090;
                      if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceBeforeColon"))) 
                      {
                        _4090 = Seq__Singleton$String_1String("--noSpaceBeforeColon");
                      }
                      else
                      {
                        _4090 = Seq__Empty$String_1String();
                      };
                      return Seq__Append$String_1String(_4090, Seq__Delay$String_1String((function(________unitVar)
                      {
                        var _4103;
                        if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAfterComma"))) 
                        {
                          _4103 = Seq__Singleton$String_1String("--noSpaceAfterComma");
                        }
                        else
                        {
                          _4103 = Seq__Empty$String_1String();
                        };
                        return Seq__Append$String_1String(_4103, Seq__Delay$String_1String((function(_________unitVar)
                        {
                          var _4116;
                          if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAfterSemiColon"))) 
                          {
                            _4116 = Seq__Singleton$String_1String("--noSpaceAfterSemiColon");
                          }
                          else
                          {
                            _4116 = Seq__Empty$String_1String();
                          };
                          return Seq__Append$String_1String(_4116, Seq__Delay$String_1String((function(__________unitVar)
                          {
                            var _4129;
                            if ((((window.atom).config).get("ionide-fsharp.FormatDocument.IndentOnTryWith"))) 
                            {
                              _4129 = Seq__Singleton$String_1String("--indentOnTryWith");
                            }
                            else
                            {
                              _4129 = Seq__Empty$String_1String();
                            };
                            return Seq__Append$String_1String(_4129, Seq__Delay$String_1String((function(___________unitVar)
                            {
                              var _4142;
                              if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAroundDelimiter"))) 
                              {
                                _4142 = Seq__Singleton$String_1String("--noSpaceAroundDelimiter");
                              }
                              else
                              {
                                _4142 = Seq__Empty$String_1String();
                              };
                              return Seq__Append$String_1String(_4142, Seq__Delay$String_1String((function(____________unitVar)
                              {
                                var _4155;
                                if ((((window.atom).config).get("ionide-fsharp.FormatDocument.ReorderOpenDeclaration"))) 
                                {
                                  _4155 = Seq__Singleton$String_1String("--reorderOpenDeclaration");
                                }
                                else
                                {
                                  _4155 = Seq__Empty$String_1String();
                                };
                                return Seq__Append$String_1String(_4155, Seq__Delay$String_1String((function(_____________unitVar)
                                {
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _3801 = "highlight-symboluse-declaration";
        }
        else
        {
          _3801 = "highlight-symboluse";
        };
        var cls = _3801;
      ...
      findFsProj = (function(dir)
      {
        if (((fs.lstatSync(dir)).isDirectory())) 
        {
          ...
          else
          {
            ...
            {
              _1983 = dir.substring(0, 0 + dir.lastIndexOf((path.sep)));
            }
            else
            {
              _1983 = "";
...
Process__exec$ = (function(location,linuxCmd,cmd)
{
    ...
    if (Process__isWin$()) 
    {
      _4383 = (child_process.execFile(location, cmd, options, (function(_arg3)
      {
    ...
    else
    {
      ...
      _4383 = (child_process.execFile(linuxCmd, prms, options, (function(_arg6)
      {
...
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _4177;
      return Seq__Enumerator$String_1String(f(_4177));
    }));
});
...
ToolbarHandler__cursorHandler$ = (function(o)
{
    ...
    if ((Array__BoxedLength$(o.Data) > 0)) 
    {
      ...
      var state = List__Empty$OverloadSignature_OverloadSignature_();
      _3429 = List__Head$OverloadSignature_OverloadSignature_((function(array)
      {
        return Array__Fold$OverloadSignature____FSharpList_1_OverloadSignature_OverloadSignature____FSharpList_1_OverloadSignature_(folder, state, array);
      })(o.Data)).Signature;
    }
      ...
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((Array__BoxedLength$(o.Data) > 0)) 
          {
            ...
            var state = List__Empty$OverloadSignature_OverloadSignature_();
            _3050 = List__Head$OverloadSignature_OverloadSignature_((function(array)
            {
              return Array__Fold$OverloadSignature____FSharpList_1_OverloadSignature_OverloadSignature____FSharpList_1_OverloadSignature_(folder, state, array);
            })(o.Data)).Signature;
          }
