    ...
    var ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg3)
    {
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        ...
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _6128 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _6128 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _6128;
          var _6138;
          ...
          else
          {
            if (flag) 
            {
              _6138 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").last()).find(" span.word-container .word")).text());
            }
            else
            {
              _6138 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").first()).find(" span.word-container .word")).text());
            };
          };
          var text = _6138;
            ...
            return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.tabLength")).toString()), Seq__Delay$String_1String((function(___unitVar)
            {
              return Seq__Append$String_1String(Seq__Singleton$String_1String("--pageWidth"), Seq__Delay$String_1String((function(____unitVar)
              {
                return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.preferredLineLength")).toString()), Seq__Delay$String_1String((function(_____unitVar)
                {
                  ...
                  {
                    _4855 = Seq__Singleton$String_1String("--semicolonEOL");
                  }
                  else
                  {
                    _4855 = Seq__Empty$String_1String();
                  };
                  return Seq__Append$String_1String(_4855, Seq__Delay$String_1String((function(______unitVar)
                  {
                    var _4927;
                    if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceBeforeArgument"))) 
                    {
                      _4927 = Seq__Singleton$String_1String("--noSpaceBeforeArgument");
                    }
                    else
                    {
                      _4927 = Seq__Empty$String_1String();
                    };
                    return Seq__Append$String_1String(_4927, Seq__Delay$String_1String((function(_______unitVar)
                    {
                      var _4940;
                      if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceBeforeColon"))) 
                      {
                        _4940 = Seq__Singleton$String_1String("--noSpaceBeforeColon");
                      }
                      else
                      {
                        _4940 = Seq__Empty$String_1String();
                      };
                      return Seq__Append$String_1String(_4940, Seq__Delay$String_1String((function(________unitVar)
                      {
                        var _4953;
                        if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAfterComma"))) 
                        {
                          _4953 = Seq__Singleton$String_1String("--noSpaceAfterComma");
                        }
                        else
                        {
                          _4953 = Seq__Empty$String_1String();
                        };
                        return Seq__Append$String_1String(_4953, Seq__Delay$String_1String((function(_________unitVar)
                        {
                          var _4966;
                          if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAfterSemiColon"))) 
                          {
                            _4966 = Seq__Singleton$String_1String("--noSpaceAfterSemiColon");
                          }
                          else
                          {
                            _4966 = Seq__Empty$String_1String();
                          };
                          return Seq__Append$String_1String(_4966, Seq__Delay$String_1String((function(__________unitVar)
                          {
                            var _4979;
                            if ((((window.atom).config).get("atom-fsharp.FormatDocument.IndentOnTryWith"))) 
                            {
                              _4979 = Seq__Singleton$String_1String("--indentOnTryWith");
                            }
                            else
                            {
                              _4979 = Seq__Empty$String_1String();
                            };
                            return Seq__Append$String_1String(_4979, Seq__Delay$String_1String((function(___________unitVar)
                            {
                              var _4992;
                              if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAroundDelimiter"))) 
                              {
                                _4992 = Seq__Singleton$String_1String("--noSpaceAroundDelimiter");
                              }
                              else
                              {
                                _4992 = Seq__Empty$String_1String();
                              };
                              return Seq__Append$String_1String(_4992, Seq__Delay$String_1String((function(____________unitVar)
                              {
                                var _5005;
                                if ((((window.atom).config).get("atom-fsharp.FormatDocument.ReorderOpenDeclaration"))) 
                                {
                                  _5005 = Seq__Singleton$String_1String("--reorderOpenDeclaration");
                                }
                                else
                                {
                                  _5005 = Seq__Empty$String_1String();
                                };
                                return Seq__Append$String_1String(_5005, Seq__Delay$String_1String((function(_____________unitVar)
                                {
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _4643 = "highlight-symboluse-declaration";
        }
        else
        {
          _4643 = "highlight-symboluse";
        };
        var cls = _4643;
...
Process__exec$ = (function(location,linuxCmd,cmd)
{
    ...
    if (Process__isWin$()) 
    {
      _5345 = (child_process.execFile(location, cmd, options, (function(_arg3)
      {
        return (function(_arg2)
        {
          return (function(_arg1)
    ...
    else
    {
      ...
      _5345 = (child_process.execFile(linuxCmd, prms, options, (function(_arg6)
      {
...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _4261 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _4261;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _5678;
      return Seq__Enumerator$Completion_Completion_(f(_5678));
    }));
});
...
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _5027;
      return Seq__Enumerator$String_1String(f(_5027));
    }));
});
