...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _4587 = "highlight-symboluse-declaration";
        }
        else
        {
          _4587 = "highlight-symboluse";
        };
        var cls = _4587;
...
Interactive__handleLocation$ = (function(n)
{
    ...
    if (Process__isWin$()) 
    {
      _4194 = (path.join(n.Data, "fsi.exe"));
    }
    else
    {
      _4194 = "fsharpi";
    };
    Interactive__fsipath = _4194;
      ...
      findFsProj = (function(dir)
      {
        if (((fs.lstatSync(dir)).isDirectory())) 
        {
          ...
          else
          {
            ...
            {
              _1271 = dir.substring(0, 0 + dir.lastIndexOf((path.sep)));
            }
            else
            {
              _1271 = "";
...
Process__notice$ = (function(currentNotification,isError,text,details)
{
    ...
    if ((matchValue.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _2684 = (((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true))));
      }
      else
      {
        _2684 = (((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true))));
      };
      var n = _2684;
...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _4216 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _4216;
...
Process__spawnWithNotifications$ = (function(location,linuxCmd,cmd)
{
    ...
    {
      _2481 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _2481;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
    var _2497;
    if (Process__isWin$()) 
    {
      _2497 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _2497 = (child_process.spawn(linuxCmd, prms, options));
    };
    var procs = _2497;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _4896;
      return Seq__Enumerator$Completion_Completion_(f(_4896));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _3733;
      return Seq__Enumerator$Object_Object_(f(_3733));
    }));
});
...
ToolbarHandler__format_data$ = (function(tinfo)
{
    ...
    if (String__StartsWith$(ti_, "type")) 
    {
      ...
      _2276 = ti_.substring(0, 0 + (_idx - 1));
    }
    else
    {
      _2276 = ti_;
    ...
    return Option__Iterate$JQueryMouseEventObject_JQueryMouseEventObject_((function(e)
    {
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((o.Data != "No tooltip information")) 
          {
            _2019 = ((ViewsHelpers__jq$("\u003cdiv/\u003e").text(o.Data)).append(errTip(o.Data)));
          }
          else
          {
            _2019 = (ViewsHelpers__jq$("\u003cdiv/\u003e").text(errTip("")));
          };
          var _ignored0 = (n_.append(String__Replace$(String__Replace$((_2019.html()), "\\n", "\u003c/br\u003e"), "\n", "\u003c/br\u003e")));
