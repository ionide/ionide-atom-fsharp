...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _4522 = "highlight-symboluse-declaration";
        }
        else
        {
          _4522 = "highlight-symboluse";
        };
        var cls = _4522;
...
Interactive__handleLocation$ = (function(n)
{
    ...
    if (Process__isWin$()) 
    {
      _4137 = (path.join(n.Data, "fsi.exe"));
    }
    else
    {
      _4137 = "fsharpi";
    };
    Interactive__fsipath = _4137;
      ...
      findFsProj = (function(dir)
      {
        if (((fs.lstatSync(dir)).isDirectory())) 
        {
          ...
          else
          {
            ...
            {
              _1220 = dir.substring(0, 0 + dir.lastIndexOf((path.sep)));
            }
            else
            {
              _1220 = "";
...
Process__notice$ = (function(currentNotification,isError,text,details)
{
    ...
    if ((matchValue.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _2627 = (((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true))));
      }
      else
      {
        _2627 = (((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true))));
      };
      var n = _2627;
...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _4159 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _4159;
...
Process__spawnWithNotifications$ = (function(location,linuxCmd,cmd)
{
    ...
    {
      _2424 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _2424;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
    var _2440;
    if (Process__isWin$()) 
    {
      _2440 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _2440 = (child_process.spawn(linuxCmd, prms, options));
    };
    var procs = _2440;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _4829;
      return Seq__Enumerator$Completion_Completion_(f(_4829));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _3676;
      return Seq__Enumerator$Object_Object_(f(_3676));
    }));
});
...
ToolbarHandler__format_data$ = (function(tinfo)
{
    ...
    if (String__StartsWith$(ti_, "type")) 
    {
      ...
      _2219 = ti_.substring(0, 0 + (_idx - 1));
    }
    else
    {
      _2219 = ti_;
    ...
    return Option__Iterate$JQueryMouseEventObject_JQueryMouseEventObject_((function(e)
    {
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((o.Data != "No tooltip information")) 
          {
            _1938 = ((ViewsHelpers__jq$("\u003cdiv/\u003e").text(o.Data)).append(errTip(o.Data)));
          }
          else
          {
            _1938 = (ViewsHelpers__jq$("\u003cdiv/\u003e").text(errTip("")));
          };
          var _ignored0 = (n_.append(String__Replace$(String__Replace$((_1938.html()), "\\n", "\u003c/br\u003e"), "\n", "\u003c/br\u003e")));
