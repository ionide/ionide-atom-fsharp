...
FAKE__notice$ = (function(isError,text,details)
{
    if ((FAKE__currentNotification.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _2530 = ((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true)));
      }
      else
      {
        _2530 = ((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true)));
      };
      var n = _2530;
...
FAKE__spawn$ = (function(location,cmd)
{
    ...
    {
      _2345 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _2345 = (child_process.spawn("mono", prms, options));
    };
    var procs = _2345;
...
HighlighterHandler__handle$ = (function(o)
{
    ...
    var action = (function(item)
    {
      ...
      {
        _1964 = "highlight-warning";
      }
      else
      {
        _1964 = "highlight-error";
      };
      var cls = _1964;
...
Interactive__handleLocation$ = (function(n)
{
    ...
    if (String__StartsWith$(((window.process).platform), "win")) 
    {
      _2990 = (path.join(n.Data, "fsi.exe"));
    }
    else
    {
      _2990 = "fsharpi";
    };
    Interactive__fsipath = _2990;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _3418;
      return Seq__Enumerator$Completion_Completion_(f(_3418));
    }));
});
Seq__Delay$Suggestion_Suggestion_ = (function(f)
{
    ...
    {
      var _3509;
      return Seq__Enumerator$Suggestion_Suggestion_(f(_3509));
    }));
});
