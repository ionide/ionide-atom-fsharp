...
FAKE__notice$ = (function(isError,text,details)
{
    if ((FAKE__currentNotification.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _2116 = ((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true)));
      }
      else
      {
        _2116 = ((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true)));
      };
      var n = _2116;
...
FAKE__spawn$ = (function(location,cmd)
{
    ...
    {
      _1931 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _1931 = (child_process.spawn("mono", prms, options));
    };
    var procs = _1931;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _2788;
      return Seq__Enumerator$Completion_Completion_(f(_2788));
    }));
});
Seq__Delay$Suggestion_Suggestion_ = (function(f)
{
    ...
    {
      var _2879;
      return Seq__Enumerator$Suggestion_Suggestion_(f(_2879));
    }));
});
      ...
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          if ((o.Data != "No tooltip information")) 
          {
            ...
            var _ignored0 = (n_.append(String__Replace$(String__Replace$(((ViewsHelpers__jq$("\u003cdiv/\u003e").text(o.Data)).html()), "\\n", "\u003c/br\u003e"), "\n", "\u003c/br\u003e")));
