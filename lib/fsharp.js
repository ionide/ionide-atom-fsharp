...
AsyncBuilder__Zero$ = (function(x,unitVar1)
{
    ...
    {
      var _1614;
      return Async__invokeCont$Unit_Unit_(k, _1614);
    }));
});
...
Async_1_StartImmediate$ = (function(workflow,cancellationToken)
{
    ...
    {
      _1760 = (new CancellationToken___ctor$({Tag: 0.000000}));
    };
    var token = _1760;
    var f = workflow.Item;
    ...
    var __ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg4)
    {
      ...
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _13186 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _13186 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _13186;
          var _13196;
          if (((selected.length) > 0.000000)) 
          {
            _13196 = (selected.text());
          }
          else
          {
            if (flag) 
            {
              _13196 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").last()).find(" span.word-container .word")).text());
            }
            else
            {
              _13196 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").first()).find(" span.word-container .word")).text());
            };
          };
          var text = _13196;
...
AutocompleteProvider__getSuggestion$ = (function(options)
{
    if ((((options.editor.buffer).file) != null)) 
    {
      ...
      {
        _4620 = ((col - 2) - options.prefix.length);
      }
      else
      {
        _4620 = col;
      ...
      return new Promise(function(resolve,reject){(function(unitVar0)
      {
        ...
        else
        {
            ...
            Events__once$Object__Unit_Object__Unit_((new EventType__Errors()), (function(result)
            {
              Events__once$Result_1_Completion____Unit_Result_1_Completion____Unit_((new EventType__Completion()), (function(_result)
              {
                ...
                if ((((options.editor.buffer).lines)[row_].charAt(col_) == "\\")) 
                {
                  ...
                  _4682 = CompletionHelpers__glyph_completion$(prefix, GlyphMaps__unicode_map);
                }
                else
                {
                  AutocompleteProvider__lastResult = {Tag: 1.000000, Value: _result};
                  _4682 = CompletionHelpers__fsharp_completion$(prefix, _result.Data);
                };
                var r = _4682;
          ...
          else
          {
            ...
            if ((((options.editor.buffer).lines)[row_].charAt(col_) == "\\")) 
            {
              _12946 = CompletionHelpers__glyph_completion$(prefix, Option__GetValue$Result_1_Completion___Result_1_Completion___(AutocompleteProvider__lastResult).Data);
            }
            else
            {
              _12946 = CompletionHelpers__fsharp_completion$(prefix, Option__GetValue$Result_1_Completion___Result_1_Completion___(AutocompleteProvider__lastResult).Data);
            };
            var r = _12946;
            if ((Array__BoxedLength$(r) > 0)) 
            {
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              {
                _12618 = dist((___i - 1))((___j - 1));
              }
              else
              {
                _12618 = CompletionHelpers__min3$Int32_Int32((dist((___i - 1))(___j) + 1), (dist(___i)((___j - 1)) + 1), (dist((___i - 1))((___j - 1)) + 1));
              };
              var dval = _12618;
...
{
    var _4576;
    return (((window.atom).workspace).open("atom://config/packages/ionide-fsharp", _4576));
});
            ...
            return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.tabLength")).toString()), Seq__Delay$String_1String((function(___unitVar)
            {
              return Seq__Append$String_1String(Seq__Singleton$String_1String("--pageWidth"), Seq__Delay$String_1String((function(____unitVar)
              {
                return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.preferredLineLength")).toString()), Seq__Delay$String_1String((function(_____unitVar)
                {
                  ...
                  {
                    _4004 = Seq__Singleton$String_1String("--semicolonEOL");
                  }
                  else
                  {
                    _4004 = Seq__Empty$String_1String();
                  };
                  return Seq__Append$String_1String(_4004, Seq__Delay$String_1String((function(______unitVar)
                  {
                    var _4076;
                    if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceBeforeArgument"))) 
                    {
                      _4076 = Seq__Singleton$String_1String("--noSpaceBeforeArgument");
                    }
                    else
                    {
                      _4076 = Seq__Empty$String_1String();
                    };
                    return Seq__Append$String_1String(_4076, Seq__Delay$String_1String((function(_______unitVar)
                    {
                      var _4089;
                      if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceBeforeColon"))) 
                      {
                        _4089 = Seq__Singleton$String_1String("--noSpaceBeforeColon");
                      }
                      else
                      {
                        _4089 = Seq__Empty$String_1String();
                      };
                      return Seq__Append$String_1String(_4089, Seq__Delay$String_1String((function(________unitVar)
                      {
                        var _4102;
                        if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAfterComma"))) 
                        {
                          _4102 = Seq__Singleton$String_1String("--noSpaceAfterComma");
                        }
                        else
                        {
                          _4102 = Seq__Empty$String_1String();
                        };
                        return Seq__Append$String_1String(_4102, Seq__Delay$String_1String((function(_________unitVar)
                        {
                          var _4115;
                          if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAfterSemiColon"))) 
                          {
                            _4115 = Seq__Singleton$String_1String("--noSpaceAfterSemiColon");
                          }
                          else
                          {
                            _4115 = Seq__Empty$String_1String();
                          };
                          return Seq__Append$String_1String(_4115, Seq__Delay$String_1String((function(__________unitVar)
                          {
                            var _4128;
                            if ((((window.atom).config).get("ionide-fsharp.FormatDocument.IndentOnTryWith"))) 
                            {
                              _4128 = Seq__Singleton$String_1String("--indentOnTryWith");
                            }
                            else
                            {
                              _4128 = Seq__Empty$String_1String();
                            };
                            return Seq__Append$String_1String(_4128, Seq__Delay$String_1String((function(___________unitVar)
                            {
                              var _4141;
                              if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAroundDelimiter"))) 
                              {
                                _4141 = Seq__Singleton$String_1String("--noSpaceAroundDelimiter");
                              }
                              else
                              {
                                _4141 = Seq__Empty$String_1String();
                              };
                              return Seq__Append$String_1String(_4141, Seq__Delay$String_1String((function(____________unitVar)
                              {
                                var _4154;
                                if ((((window.atom).config).get("ionide-fsharp.FormatDocument.ReorderOpenDeclaration"))) 
                                {
                                  _4154 = Seq__Singleton$String_1String("--reorderOpenDeclaration");
                                }
                                else
                                {
                                  _4154 = Seq__Empty$String_1String();
                                };
                                return Seq__Append$String_1String(_4154, Seq__Delay$String_1String((function(_____________unitVar)
                                {
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _3800 = "highlight-symboluse-declaration";
        }
        else
        {
          _3800 = "highlight-symboluse";
        };
        var cls = _3800;
...
{
    var _465;
    return LanguageService__send$(LanguageService__request$Unit_Unit_(LanguageService__url$("compilerlocation"), _465));
});
...
{
    var clo1 = String__PrintFormatToString$("http://localhost:8088/%s");
    return (function(arg10)
    {
      return clo1(arg10);
    })(s);
      ...
      findFsProj = (function(dir)
      {
        if (((fs.lstatSync(dir)).isDirectory())) 
        {
          ...
          else
          {
            ...
            {
              _1986 = dir.substring(0, 0 + dir.lastIndexOf((path.sep)));
            }
            else
            {
              _1986 = "";
...
Process__exec$ = (function(location,linuxCmd,cmd)
{
    ...
    if (Process__isWin$()) 
    {
      _4382 = (child_process.execFile(location, cmd, options, (function(_arg3)
      {
    ...
    else
    {
      ...
      _4382 = (child_process.execFile(linuxCmd, prms, options, (function(_arg6)
      {
...
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _4176;
      return Seq__Enumerator$String_1String(f(_4176));
    }));
});
...
ToolbarHandler__cursorHandler$ = (function(o)
{
    ...
    if ((Array__BoxedLength$(o.Data) > 0)) 
    {
      ...
      var state = List__Empty$OverloadSignature_OverloadSignature_();
      _3428 = List__Head$OverloadSignature_OverloadSignature_((function(array)
      {
        return Array__Fold$OverloadSignature____FSharpList_1_OverloadSignature_OverloadSignature____FSharpList_1_OverloadSignature_(folder, state, array);
      })(o.Data)).Signature;
    }
      ...
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((Array__BoxedLength$(o.Data) > 0)) 
          {
            ...
            var state = List__Empty$OverloadSignature_OverloadSignature_();
            _3049 = List__Head$OverloadSignature_OverloadSignature_((function(array)
            {
              return Array__Fold$OverloadSignature____FSharpList_1_OverloadSignature_OverloadSignature____FSharpList_1_OverloadSignature_(folder, state, array);
            })(o.Data)).Signature;
          }
...
WebRequest__AsyncGetResponse$ = (function(req,unitVar1)
{
    return Async_1_FromContinuations$WebResponse_WebResponse_((function(tupledArg)
    {
      ...
      {
        _585 = UTF8Encoding__GetString$(Replacements__utf8Encoding$(), Stream__get_Contents$(req.requestStream));
      };
      var body = _585;
