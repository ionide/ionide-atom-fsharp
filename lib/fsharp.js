...
{
    var ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg1)
    {
...
ErrorPanel__deactivate$ = (function(unitVar0)
{
    ...
    {
      return (n.dispose());
    }), ResizeArray__ToSeq$Disposable_Disposable_(ErrorPanel__subscriptions));
    ...
    var proj = (function(ex)
    {
      return (function(arr)
      {
        ...
        else
        {
          ...
          {
            var ___ignored0 = (((window.atom).commands).add("atom-workspace", "FAKE: Build", (function(arg00_)
            {
              return FAKE__FAKENotFound$();
            })));
          };
...
HighlighterHandler__deactivate$ = (function(unitVar0)
{
    ...
    {
      return (n.dispose());
    }), ResizeArray__ToSeq$Disposable_Disposable_(HighlighterHandler__subscriptions));
...
Interactive__handleLocation$ = (function(n)
{
    ...
    if (Process__isWin$()) 
    {
      _3902 = (path.join(n.Data, "fsi.exe"));
    }
    else
    {
      _3902 = "fsharpi";
    };
    Interactive__fsipath = _3902;
...
Parser__activate$ = (function(unitVar0)
{
    ...
    return Parser__subscriptions.push((((window.atom).workspace).onDidChangeActivePaneItem((function(ed)
    {
      ...
      Option__Iterate$Disposable_Disposable_((function(h_)
      {
        return (h_.dispose());
      }), Parser__h);
...
Process__notice$ = (function(currentNotification,isError,text,details)
{
    ...
    if ((matchValue.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _2775 = (((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true))));
      }
      else
      {
        _2775 = (((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true))));
      };
      var n = _2775;
...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _3924 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _3924;
...
Process__spawnWithNotifications$ = (function(location,linuxCmd,cmd)
{
    ...
    {
      _2572 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _2572;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
    var _2588;
    if (Process__isWin$()) 
    {
      _2588 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _2588 = (child_process.spawn(linuxCmd, prms, options));
    };
    var procs = _2588;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _4369;
      return Seq__Enumerator$Completion_Completion_(f(_4369));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _3793;
      return Seq__Enumerator$Object_Object_(f(_3793));
    }));
});
Seq__Delay$Suggestion_Suggestion_ = (function(f)
{
    ...
    {
      var _4460;
      return Seq__Enumerator$Suggestion_Suggestion_(f(_4460));
    }));
});
...
ToolbarHandler__format_data$ = (function(tinfo)
{
    ...
    if (String__StartsWith$(ti_, "type")) 
    {
      ...
      _2368 = ti_.substring(0, 0 + (_idx - 1));
    }
    else
    {
      _2368 = ti_;
    ...
    return Option__Iterate$JQueryMouseEventObject_JQueryMouseEventObject_((function(e)
    {
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((o.Data != "No tooltip information")) 
          {
            _1957 = ((ViewsHelpers__jq$("\u003cdiv/\u003e").text(o.Data)).append(errTip(o.Data)));
          }
          else
          {
            _1957 = (ViewsHelpers__jq$("\u003cdiv/\u003e").text(errTip("")));
          };
          var _ignored0 = (n_.append(String__Replace$(String__Replace$((_1957.html()), "\\n", "\u003c/br\u003e"), "\n", "\u003c/br\u003e")));
