    ...
    var ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg3)
    {
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        ...
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _5412 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _5412 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _5412;
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _4668 = "highlight-symboluse-declaration";
        }
        else
        {
          _4668 = "highlight-symboluse";
        };
        var cls = _4668;
...
Interactive__handleLocation$ = (function(n)
{
    ...
    if (Process__isWin$()) 
    {
      _4260 = (path.join(n.Data, "fsi.exe"));
    }
    else
    {
      _4260 = "fsharpi";
    };
    Interactive__fsipath = _4260;
      ...
      findFsProj = (function(dir)
      {
        if (((fs.lstatSync(dir)).isDirectory())) 
        {
          ...
          else
          {
            ...
            {
              _1259 = dir.substring(0, 0 + dir.lastIndexOf((path.sep)));
            }
            else
            {
              _1259 = "";
...
Process__notice$ = (function(currentNotification,isError,text,details)
{
    ...
    if ((matchValue.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _2710 = (((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true))));
      }
      else
      {
        _2710 = (((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true))));
      };
      var n = _2710;
...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _4282 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _4282;
...
Process__spawnWithNotifications$ = (function(location,linuxCmd,cmd)
{
    ...
    {
      _2507 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _2507;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
    var _2523;
    if (Process__isWin$()) 
    {
      _2523 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _2523 = (child_process.spawn(linuxCmd, prms, options));
    };
    var procs = _2523;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _5015;
      return Seq__Enumerator$Completion_Completion_(f(_5015));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _3799;
      return Seq__Enumerator$Object_Object_(f(_3799));
    }));
});
...
ToolbarHandler__format_data$ = (function(tinfo)
{
    ...
    if (String__StartsWith$(ti_, "type")) 
    {
      ...
      _2261 = ti_.substring(0, 0 + (_idx - 1));
    }
    else
    {
      _2261 = ti_;
    ...
    return Option__Iterate$JQueryMouseEventObject_JQueryMouseEventObject_((function(e)
    {
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((o.Data != "No tooltip information")) 
          {
            _1977 = ((ViewsHelpers__jq$("\u003cdiv/\u003e").text(o.Data)).append(errTip(o.Data)));
          }
          else
          {
            _1977 = (ViewsHelpers__jq$("\u003cdiv/\u003e").text(errTip("")));
          };
          var _ignored0 = (n_.append(String__Replace$(String__Replace$((_1977.html()), "\\n", "\u003c/br\u003e"), "\n", "\u003c/br\u003e")));
