    ...
    var _ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg4)
    {
      ...
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _6504 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _6504 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _6504;
          var _6514;
          ...
          else
          {
            if (flag) 
            {
              _6514 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").last()).find(" span.word-container .word")).text());
            }
            else
            {
              _6514 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").first()).find(" span.word-container .word")).text());
            };
          };
          var text = _6514;
...
{
    var name = Events__getName$(t);
    Events__log$String_1_String_1String_String(name, "");
    var _309;
    return (Events__emitter.emit(name, _309));
});
...
{
    var debug = (((window.atom).config).get("atom-fsharp.DeveloperMode"));
    var d = ((window.JSON).stringify(o));
    if (debug) 
    {
      return (Events__emitter.emit("Fsharp_log", (new TupleString_String(name, d))));
    }
    else
    {
      ;
...
FAKE__activate$ = (function(unitVar0)
{
    ...
    var proj = (function(ex)
    {
      return (function(arr)
      {
        ...
        if ((arr != undefined)) 
        {
          _3517 = Array__TryFind$String_1String((function(a)
          {
            return (function(n)
            {
...
{
    var show = (((window.atom).config).get("atom-fsharp.ShowQuickInfoPanel"));
    var highlight = (((window.atom).config).get("atom-fsharp.ShowUseHighlights"));
    var debug = (((window.atom).config).get("atom-fsharp.DeveloperMode"));
    ...
    var s = (((window.atom).config).onDidChange("atom-fsharp.ShowQuickInfoPanel", (function(n)
    {
      if (n.newValue) 
      {
    ...
    var s2 = (((window.atom).config).onDidChange("atom-fsharp.ShowUseHighlights", (function(n)
    {
      if (n.newValue) 
      {
    ...
    var s3 = (((window.atom).config).onDidChange("atom-fsharp.DeveloperMode", (function(n)
    {
      if (n.newValue) 
      {
...
{
    var location = ((((window.atom).packages).packageDirPaths)[0] + "/atom-fsharp/bin-fantomas/fantomas.exe");
    var editor = (((window.atom).workspace).getActiveTextEditor());
    if (ViewsHelpers__isFSharpEditor$(editor)) 
    {
          ...
          return Seq__Append$String_1String(Seq__Singleton$String_1String("--indent"), Seq__Delay$String_1String((function(__unitVar)
          {
            return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.tabLength")).toString()), Seq__Delay$String_1String((function(___unitVar)
            {
              return Seq__Append$String_1String(Seq__Singleton$String_1String("--pageWidth"), Seq__Delay$String_1String((function(____unitVar)
              {
                ...
                {
                  var _5205;
                  if ((((window.atom).config).get("atom-fsharp.FormatDocument.SemicolonAtEndOfLine"))) 
                  {
                    _5205 = Seq__Singleton$String_1String("--semicolonEOL");
                  }
                  else
                  {
                    _5205 = Seq__Empty$String_1String();
                  };
                  return Seq__Append$String_1String(_5205, Seq__Delay$String_1String((function(______unitVar)
                  {
                    var _5277;
                    if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceBeforeArgument"))) 
                    {
                      _5277 = Seq__Singleton$String_1String("--noSpaceBeforeArgument");
                    }
                    else
                    {
                      _5277 = Seq__Empty$String_1String();
                    };
                    return Seq__Append$String_1String(_5277, Seq__Delay$String_1String((function(_______unitVar)
                    {
                      var _5290;
                      if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceBeforeColon"))) 
                      {
                        _5290 = Seq__Singleton$String_1String("--noSpaceBeforeColon");
                      }
                      else
                      {
                        _5290 = Seq__Empty$String_1String();
                      };
                      return Seq__Append$String_1String(_5290, Seq__Delay$String_1String((function(________unitVar)
                      {
                        var _5303;
                        if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAfterComma"))) 
                        {
                          _5303 = Seq__Singleton$String_1String("--noSpaceAfterComma");
                        }
                        else
                        {
                          _5303 = Seq__Empty$String_1String();
                        };
                        return Seq__Append$String_1String(_5303, Seq__Delay$String_1String((function(_________unitVar)
                        {
                          var _5316;
                          if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAfterSemiColon"))) 
                          {
                            _5316 = Seq__Singleton$String_1String("--noSpaceAfterSemiColon");
                          }
                          else
                          {
                            _5316 = Seq__Empty$String_1String();
                          };
                          return Seq__Append$String_1String(_5316, Seq__Delay$String_1String((function(__________unitVar)
                          {
                            var _5329;
                            if ((((window.atom).config).get("atom-fsharp.FormatDocument.IndentOnTryWith"))) 
                            {
                              _5329 = Seq__Singleton$String_1String("--indentOnTryWith");
                            }
                            else
                            {
                              _5329 = Seq__Empty$String_1String();
                            };
                            return Seq__Append$String_1String(_5329, Seq__Delay$String_1String((function(___________unitVar)
                            {
                              var _5342;
                              if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAroundDelimiter"))) 
                              {
                                _5342 = Seq__Singleton$String_1String("--noSpaceAroundDelimiter");
                              }
                              else
                              {
                                _5342 = Seq__Empty$String_1String();
                              };
                              return Seq__Append$String_1String(_5342, Seq__Delay$String_1String((function(____________unitVar)
                              {
                                var _5355;
                                if ((((window.atom).config).get("atom-fsharp.FormatDocument.ReorderOpenDeclaration"))) 
                                {
                                  _5355 = Seq__Singleton$String_1String("--reorderOpenDeclaration");
                                }
                                else
                                {
                                  _5355 = Seq__Empty$String_1String();
                                };
                                return Seq__Append$String_1String(_5355, Seq__Delay$String_1String((function(_____________unitVar)
                                {
                                  if ((((window.atom).config).get("atom-fsharp.FormatDocument.StrictMode"))) 
                                  {
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _4993 = "highlight-symboluse-declaration";
        }
        else
        {
          _4993 = "highlight-symboluse";
        };
        var cls = _4993;
...
{
    Events__log$String_1_String_1String_String("REQEUST", msg_);
    var msg = String__Replace$(msg_, "﻿", "");
      ...
      findFsProj = (function(dir)
      {
        if (((fs.lstatSync(dir)).isDirectory())) 
        {
          ...
          else
          {
            ...
            {
              _1464 = dir.substring(0, 0 + dir.lastIndexOf((path.sep)));
            }
            else
            {
              _1464 = "";
...
Process__exec$ = (function(location,linuxCmd,cmd)
{
    ...
    if (Process__isWin$()) 
    {
      _5695 = (child_process.execFile(location, cmd, options, (function(_arg3)
      {
        return (function(_arg2)
        {
          return (function(_arg1)
    ...
    else
    {
      ...
      _5695 = (child_process.execFile(linuxCmd, prms, options, (function(_arg6)
      {
...
Process__fromPath$ = (function(name)
{
    ...
    {
      var path = (((window.atom).config).get("atom-fsharp.MonoPath"));
      return ((path + "/") + name);
    };
});
...
Process__notice$ = (function(currentNotification,isError,text,details)
{
    ...
    if ((matchValue.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _3045 = (((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true))));
      }
      else
      {
        _3045 = (((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true))));
      };
      var n = _3045;
...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _4611 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _4611;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
...
Process__spawnWithNotifications$ = (function(location,linuxCmd,cmd)
{
    ...
    {
      _2842 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _2842;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
    var _2858;
    if (Process__isWin$()) 
    {
      _2858 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _2858 = (child_process.spawn(linuxCmd, prms, options));
    };
    var procs = _2858;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _6050;
      return Seq__Enumerator$Completion_Completion_(f(_6050));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _4128;
      return Seq__Enumerator$Object_Object_(f(_4128));
    }));
});
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _5377;
      return Seq__Enumerator$String_1String(f(_5377));
    }));
});
    ...
    return Option__Iterate$JQueryMouseEventObject_JQueryMouseEventObject_((function(e)
    {
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((data != "No tooltip information")) 
          {
            _2319 = ((ViewsHelpers__jq$("\u003cdiv/\u003e").text(data)).append(errTip(data)));
          }
          else
          {
            _2319 = (ViewsHelpers__jq$("\u003cdiv/\u003e").text(errTip("")));
          };
          var _ignored0 = (n_.append(String__Replace$(String__Replace$((_2319.html()), "\\n", "\u003c/br\u003e"), "\n", "\u003c/br\u003e")));
