...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      ...
      {
        _4846 = "highlight-symboluse-declaration";
      }
      else
      {
        _4846 = "highlight-symboluse";
      };
      var cls = _4846;
...
Interactive__handleLocation$ = (function(n)
{
    ...
    if (Process__isWin$()) 
    {
      _4489 = (path.join(n.Data, "fsi.exe"));
    }
    else
    {
      _4489 = "fsharpi";
    };
    Interactive__fsipath = _4489;
...
Process__notice$ = (function(currentNotification,isError,text,details)
{
    ...
    if ((matchValue.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _2991 = (((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true))));
      }
      else
      {
        _2991 = (((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true))));
      };
      var n = _2991;
...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _4511 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _4511;
...
Process__spawnWithNotifications$ = (function(location,linuxCmd,cmd)
{
    ...
    {
      _2788 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _2788;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
    var _2804;
    if (Process__isWin$()) 
    {
      _2804 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _2804 = (child_process.spawn(linuxCmd, prms, options));
    };
    var procs = _2804;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _5140;
      return Seq__Enumerator$Completion_Completion_(f(_5140));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _4028;
      return Seq__Enumerator$Object_Object_(f(_4028));
    }));
});
