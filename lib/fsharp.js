...
AsyncBuilder__Zero$ = (function(x,unitVar1)
{
    ...
    {
      var _1566;
      return Async__invokeCont$Unit_Unit_(k, _1566);
    }));
});
...
Async_1_StartImmediate$ = (function(workflow,cancellationToken)
{
    ...
    {
      _1712 = (new CancellationToken___ctor$({Tag: 0.000000}));
    };
    var token = _1712;
    var f = workflow.Item;
    ...
    var __ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg4)
    {
      ...
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _13125 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _13125 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _13125;
          var _13135;
          if (((selected.length) > 0.000000)) 
          {
            _13135 = (selected.text());
          }
          else
          {
            if (flag) 
            {
              _13135 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").last()).find(" span.word-container .word")).text());
            }
            else
            {
              _13135 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").first()).find(" span.word-container .word")).text());
            };
          };
          var text = _13135;
...
AutocompleteProvider__getSuggestion$ = (function(options)
{
    if ((((options.editor.buffer).file) != null)) 
    {
      ...
      {
        _4525 = ((col - 2) - options.prefix.length);
      }
      else
      {
        _4525 = col;
      ...
      return new Promise(function(resolve){(function(unitVar0)
      {
          ...
          Events__once$Object__Unit_Object__Unit_((new EventType__Errors()), (function(result)
          {
            Events__once$Result_1_Completion____Unit_Result_1_Completion____Unit_((new EventType__Completion()), (function(_result)
            {
              ...
              if ((((options.editor.buffer).lines)[row_].charAt(col_) == "\\")) 
              {
                ...
                _4583 = CompletionHelpers__glyph_completion$(prefix, GlyphMaps__unicode_map);
              }
              else
              {
                AutocompleteProvider__lastResult = {Tag: 1.000000, Value: _result};
                _4583 = CompletionHelpers__fsharp_completion$(prefix, _result.Data);
              };
              var r = _4583;
        ...
        else
        {
          ...
          if ((((options.editor.buffer).lines)[row_].charAt(col_) == "\\")) 
          {
            _12887 = CompletionHelpers__glyph_completion$(prefix, Option__GetValue$Result_1_Completion___Result_1_Completion___(AutocompleteProvider__lastResult).Data);
          }
          else
          {
            _12887 = CompletionHelpers__fsharp_completion$(prefix, Option__GetValue$Result_1_Completion___Result_1_Completion___(AutocompleteProvider__lastResult).Data);
          };
          var r = _12887;
          if ((Array__BoxedLength$(r) > 0)) 
          {
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              {
                _12519 = dist((___i - 1))((___j - 1));
              }
              else
              {
                _12519 = CompletionHelpers__min3$Int32_Int32((dist((___i - 1))(___j) + 1), (dist(___i)((___j - 1)) + 1), (dist((___i - 1))((___j - 1)) + 1));
              };
              var dval = _12519;
...
Events__emitEmpty$String_1String = (function(t,s)
{
    var name = Events__getName$(t);
    var _273;
    return (Events__emitter.emit(name, _273));
});
            ...
            return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.tabLength")).toString()), Seq__Delay$String_1String((function(___unitVar)
            {
              return Seq__Append$String_1String(Seq__Singleton$String_1String("--pageWidth"), Seq__Delay$String_1String((function(____unitVar)
              {
                return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.preferredLineLength")).toString()), Seq__Delay$String_1String((function(_____unitVar)
                {
                  ...
                  {
                    _3910 = Seq__Singleton$String_1String("--semicolonEOL");
                  }
                  else
                  {
                    _3910 = Seq__Empty$String_1String();
                  };
                  return Seq__Append$String_1String(_3910, Seq__Delay$String_1String((function(______unitVar)
                  {
                    var _3982;
                    if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceBeforeArgument"))) 
                    {
                      _3982 = Seq__Singleton$String_1String("--noSpaceBeforeArgument");
                    }
                    else
                    {
                      _3982 = Seq__Empty$String_1String();
                    };
                    return Seq__Append$String_1String(_3982, Seq__Delay$String_1String((function(_______unitVar)
                    {
                      var _3995;
                      if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceBeforeColon"))) 
                      {
                        _3995 = Seq__Singleton$String_1String("--noSpaceBeforeColon");
                      }
                      else
                      {
                        _3995 = Seq__Empty$String_1String();
                      };
                      return Seq__Append$String_1String(_3995, Seq__Delay$String_1String((function(________unitVar)
                      {
                        var _4008;
                        if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAfterComma"))) 
                        {
                          _4008 = Seq__Singleton$String_1String("--noSpaceAfterComma");
                        }
                        else
                        {
                          _4008 = Seq__Empty$String_1String();
                        };
                        return Seq__Append$String_1String(_4008, Seq__Delay$String_1String((function(_________unitVar)
                        {
                          var _4021;
                          if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAfterSemiColon"))) 
                          {
                            _4021 = Seq__Singleton$String_1String("--noSpaceAfterSemiColon");
                          }
                          else
                          {
                            _4021 = Seq__Empty$String_1String();
                          };
                          return Seq__Append$String_1String(_4021, Seq__Delay$String_1String((function(__________unitVar)
                          {
                            var _4034;
                            if ((((window.atom).config).get("ionide-fsharp.FormatDocument.IndentOnTryWith"))) 
                            {
                              _4034 = Seq__Singleton$String_1String("--indentOnTryWith");
                            }
                            else
                            {
                              _4034 = Seq__Empty$String_1String();
                            };
                            return Seq__Append$String_1String(_4034, Seq__Delay$String_1String((function(___________unitVar)
                            {
                              var _4047;
                              if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAroundDelimiter"))) 
                              {
                                _4047 = Seq__Singleton$String_1String("--noSpaceAroundDelimiter");
                              }
                              else
                              {
                                _4047 = Seq__Empty$String_1String();
                              };
                              return Seq__Append$String_1String(_4047, Seq__Delay$String_1String((function(____________unitVar)
                              {
                                var _4060;
                                if ((((window.atom).config).get("ionide-fsharp.FormatDocument.ReorderOpenDeclaration"))) 
                                {
                                  _4060 = Seq__Singleton$String_1String("--reorderOpenDeclaration");
                                }
                                else
                                {
                                  _4060 = Seq__Empty$String_1String();
                                };
                                return Seq__Append$String_1String(_4060, Seq__Delay$String_1String((function(_____________unitVar)
                                {
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _3706 = "highlight-symboluse-declaration";
        }
        else
        {
          _3706 = "highlight-symboluse";
        };
        var cls = _3706;
...
{
    var _463;
    return LanguageService__send$(LanguageService__request$Unit_Unit_(LanguageService__url$("compilerlocation"), _463));
});
      ...
      findFsProj = (function(dir)
      {
        if (((fs.lstatSync(dir)).isDirectory())) 
        {
          ...
          else
          {
            ...
            {
              _1939 = dir.substring(0, 0 + dir.lastIndexOf((path.sep)));
            }
            else
            {
              _1939 = "";
...
Process__exec$ = (function(location,linuxCmd,cmd)
{
    ...
    if (Process__isWin$()) 
    {
      _4288 = (child_process.execFile(location, cmd, options, (function(_arg3)
      {
    ...
    else
    {
      ...
      _4288 = (child_process.execFile(linuxCmd, prms, options, (function(_arg6)
      {
...
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _4082;
      return Seq__Enumerator$String_1String(f(_4082));
    }));
});
...
ToolbarHandler__cursorHandler$ = (function(o)
{
    ...
    if ((Array__BoxedLength$(o.Data) > 0)) 
    {
      ...
      var state = List__Empty$OverloadSignature_OverloadSignature_();
      _3341 = List__Head$OverloadSignature_OverloadSignature_((function(array)
      {
        return Array__Fold$OverloadSignature____FSharpList_1_OverloadSignature_OverloadSignature____FSharpList_1_OverloadSignature_(folder, state, array);
      })(o.Data)).Signature;
    }
      ...
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((Array__BoxedLength$(o.Data) > 0)) 
          {
            ...
            var state = List__Empty$OverloadSignature_OverloadSignature_();
            _2962 = List__Head$OverloadSignature_OverloadSignature_((function(array)
            {
              return Array__Fold$OverloadSignature____FSharpList_1_OverloadSignature_OverloadSignature____FSharpList_1_OverloadSignature_(folder, state, array);
            })(o.Data)).Signature;
          }
...
WebRequest__AsyncGetResponse$ = (function(req,unitVar1)
{
    return Async_1_FromContinuations$WebResponse_WebResponse_((function(tupledArg)
    {
      ...
      {
        _583 = UTF8Encoding__GetString$(Replacements__utf8Encoding$(), Stream__get_Contents$(req.requestStream));
      };
      var body = _583;
