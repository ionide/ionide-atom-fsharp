...
ErrorPanelView__handleEditorChange$ = (function(panel,service,editor)
{
    if ((((editor != undefined) && (editor["getGrammar"] != undefined)) && (((editor.getGrammar()).name) == "F#"))) 
    {
      ...
      {
        var _ignored0 = LanguageService__parseCurrent$((function(_arg1)
        {
          ;
        }), service);
      })));
...
FAKE__notice$ = (function(isError,text,details)
{
    if ((FAKE__currentNotification.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _1709 = ((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true)));
      }
      else
      {
        _1709 = ((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true)));
      };
      var n = _1709;
...
FAKE__spawn$ = (function(location,cmd)
{
    ...
    {
      _1524 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _1524 = (child_process.spawn("mono", prms, options));
    };
    var procs = _1524;
...
FSharpIDE__projInit$ = (function(_this,unitVar0)
{
    ...
    var proj = (function(ex)
    {
      return (function(arr)
      {
        ...
        {
          var a = Option__GetValue$String_1String(projExist);
          var path = ((((window.atom).project).getDirectories())[0].resolve());
...
FSharpIDE__register$ = (function(_this,panel)
{
    ...
    _this.subscriptions.push(((window.atom).workspace).onDidChangeActivePaneItem((function(ed)
    {
      var ignored0 = ErrorPanelView__handleEditorChange$(panel, _this.service, ed);
    })));
    _this.subscriptions.push(((window.atom).workspace).onDidChangeActivePaneItem((function(ed)
    {
      var ignored0 = (window.setTimeout((function(_arg5)
      {
    ...
    return _this.subscriptions.push((((window.atom).project).onDidChangePaths((function(_arg6)
    {
      var _1281;
      var arg10_ = _1281;
...
HighlighterHandler__handle$ = (function(lst)
{
    ...
    var action = (function(item)
    {
      ...
      {
        _1140 = "highlight-warning";
      }
      else
      {
        _1140 = "highlight-error";
      };
      var cls = _1140;
...
LanguageService__start$ = (function(t)
{
    ...
    if (String__StartsWith$(((window.process).platform), "win")) 
    {
      _222 = (child_process.spawn(location));
    }
    else
    {
      _222 = (child_process.spawn("mono", [location]));
    };
    var child = _222;
...
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _2569;
      return Seq__Enumerator$Object_Object_(f(_2569));
    }));
});
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _2478;
      return Seq__Enumerator$String_1String(f(_2478));
    }));
});
