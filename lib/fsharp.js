...
AsyncBuilder__Zero$ = (function(x,unitVar1)
{
    ...
    {
      var _1964;
      return Async__invokeCont$Unit_Unit_(k, _1964);
    }));
});
...
Async_1_StartImmediate$ = (function(workflow,cancellationToken)
{
    ...
    {
      _2110 = (new CancellationToken___ctor$({Tag: 0.000000}));
    };
    var token = _2110;
    var f = workflow.Item;
    ...
    var __ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg4)
    {
      ...
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _13240 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _13240 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _13240;
          var _13250;
          if (((selected.length) > 0.000000)) 
          {
            _13250 = (selected.text());
          }
          else
          {
            if (flag) 
            {
              _13250 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").last()).find(" span.word-container .word")).text());
            }
            else
            {
              _13250 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").first()).find(" span.word-container .word")).text());
            };
          };
          var text = _13250;
...
AutocompleteProvider__getSuggestion$ = (function(options)
{
    if ((((options.editor.buffer).file) != null)) 
    {
      ...
      {
        _4674 = ((col - 2) - options.prefix.length);
      }
      else
      {
        _4674 = col;
      ...
      return new Promise(function(resolve,reject){(function(unitVar0)
      {
        ...
        else
        {
            ...
            Events__once$Object__Unit_Object__Unit_((new EventType__Errors()), (function(result)
            {
              Events__once$Result_1_Completion____Unit_Result_1_Completion____Unit_((new EventType__Completion()), (function(_result)
              {
                ...
                if ((((options.editor.buffer).lines)[row_].charAt(col_) == "\\")) 
                {
                  ...
                  _4736 = CompletionHelpers__glyph_completion$(prefix, GlyphMaps__unicode_map);
                }
                else
                {
                  AutocompleteProvider__lastResult = {Tag: 1.000000, Value: _result};
                  _4736 = CompletionHelpers__fsharp_completion$(prefix, _result.Data);
                };
                var r = _4736;
          ...
          else
          {
            ...
            if ((((options.editor.buffer).lines)[row_].charAt(col_) == "\\")) 
            {
              _13000 = CompletionHelpers__glyph_completion$(prefix, Option__GetValue$Result_1_Completion___Result_1_Completion___(AutocompleteProvider__lastResult).Data);
            }
            else
            {
              _13000 = CompletionHelpers__fsharp_completion$(prefix, Option__GetValue$Result_1_Completion___Result_1_Completion___(AutocompleteProvider__lastResult).Data);
            };
            var r = _13000;
            if ((Array__BoxedLength$(r) > 0)) 
            {
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              {
                _12672 = dist((___i - 1))((___j - 1));
              }
              else
              {
                _12672 = CompletionHelpers__min3$Int32_Int32((dist((___i - 1))(___j) + 1), (dist(___i)((___j - 1)) + 1), (dist((___i - 1))((___j - 1)) + 1));
              };
              var dval = _12672;
...
CompletionHelpers__fsharp_completion$ = (function(prefix,data)
{
    return Array__Map$Completion__Object_Completion__Object_((function(t)
    {
      ...
      return (new Suggestion___ctor$(t.ReplacementText, t.Name, prefix, t.GlyphChar, inputRecord.leftLabel, rightLabel));
...
ErrorLinterProvider__create$ = (function(unitVar0)
{
    ...
    return [(new Provider_1__ctor$(["source.fsharp", "source.fsharp.fsi", "source.fsharp.fsx", "source.fsharp.fsl"], "file", true, lint))];
});
...
{
    var _4630;
    return (((window.atom).workspace).open("atom://config/packages/ionide-fsharp", _4630));
});
            ...
            return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.tabLength")).toString()), Seq__Delay$String_1String((function(___unitVar)
            {
              return Seq__Append$String_1String(Seq__Singleton$String_1String("--pageWidth"), Seq__Delay$String_1String((function(____unitVar)
              {
                return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.preferredLineLength")).toString()), Seq__Delay$String_1String((function(_____unitVar)
                {
                  ...
                  {
                    _4148 = Seq__Singleton$String_1String("--semicolonEOL");
                  }
                  else
                  {
                    _4148 = Seq__Empty$String_1String();
                  };
                  return Seq__Append$String_1String(_4148, Seq__Delay$String_1String((function(______unitVar)
                  {
                    var _4220;
                    if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceBeforeArgument"))) 
                    {
                      _4220 = Seq__Singleton$String_1String("--noSpaceBeforeArgument");
                    }
                    else
                    {
                      _4220 = Seq__Empty$String_1String();
                    };
                    return Seq__Append$String_1String(_4220, Seq__Delay$String_1String((function(_______unitVar)
                    {
                      var _4233;
                      if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceBeforeColon"))) 
                      {
                        _4233 = Seq__Singleton$String_1String("--noSpaceBeforeColon");
                      }
                      else
                      {
                        _4233 = Seq__Empty$String_1String();
                      };
                      return Seq__Append$String_1String(_4233, Seq__Delay$String_1String((function(________unitVar)
                      {
                        var _4246;
                        if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAfterComma"))) 
                        {
                          _4246 = Seq__Singleton$String_1String("--noSpaceAfterComma");
                        }
                        else
                        {
                          _4246 = Seq__Empty$String_1String();
                        };
                        return Seq__Append$String_1String(_4246, Seq__Delay$String_1String((function(_________unitVar)
                        {
                          var _4259;
                          if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAfterSemiColon"))) 
                          {
                            _4259 = Seq__Singleton$String_1String("--noSpaceAfterSemiColon");
                          }
                          else
                          {
                            _4259 = Seq__Empty$String_1String();
                          };
                          return Seq__Append$String_1String(_4259, Seq__Delay$String_1String((function(__________unitVar)
                          {
                            var _4272;
                            if ((((window.atom).config).get("ionide-fsharp.FormatDocument.IndentOnTryWith"))) 
                            {
                              _4272 = Seq__Singleton$String_1String("--indentOnTryWith");
                            }
                            else
                            {
                              _4272 = Seq__Empty$String_1String();
                            };
                            return Seq__Append$String_1String(_4272, Seq__Delay$String_1String((function(___________unitVar)
                            {
                              var _4285;
                              if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAroundDelimiter"))) 
                              {
                                _4285 = Seq__Singleton$String_1String("--noSpaceAroundDelimiter");
                              }
                              else
                              {
                                _4285 = Seq__Empty$String_1String();
                              };
                              return Seq__Append$String_1String(_4285, Seq__Delay$String_1String((function(____________unitVar)
                              {
                                var _4298;
                                if ((((window.atom).config).get("ionide-fsharp.FormatDocument.ReorderOpenDeclaration"))) 
                                {
                                  _4298 = Seq__Singleton$String_1String("--reorderOpenDeclaration");
                                }
                                else
                                {
                                  _4298 = Seq__Empty$String_1String();
                                };
                                return Seq__Append$String_1String(_4298, Seq__Delay$String_1String((function(_____________unitVar)
                                {
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _3944 = "highlight-symboluse-declaration";
        }
        else
        {
          _3944 = "highlight-symboluse";
        };
        var cls = _3944;
...
{
    var _815;
    return LanguageService__send$(LanguageService__request$Unit_Unit_(LanguageService__url$("compilerlocation"), _815));
});
...
{
    var location = ((((window.atom).packages).packageDirPaths)[0] + "/ionide-fsharp/bin/FsAutoComplete.Suave.exe");
      ...
      findFsProj = (function(dir)
      {
        if (((fs.lstatSync(dir)).isDirectory())) 
        {
          ...
          else
          {
            ...
            {
              _2336 = dir.substring(0, 0 + dir.lastIndexOf((path.sep)));
            }
            else
            {
              _2336 = "";
...
Process__exec$ = (function(location,linuxCmd,cmd)
{
    ...
    if (Process__isWin$()) 
    {
      _4526 = (child_process.execFile(location, cmd, options, (function(_arg3)
      {
    ...
    else
    {
      ...
      _4526 = (child_process.execFile(linuxCmd, prms, options, (function(_arg6)
      {
...
Process__spawn$ = (function(location,linuxCmd,cmd)
{
    ...
    {
      _463 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _463;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
    var _685;
    if (Process__isWin$()) 
    {
      _685 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _685 = (child_process.spawn(linuxCmd, prms, options));
    };
    var procs = _685;
    return procs;
});
...
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _4320;
      return Seq__Enumerator$String_1String(f(_4320));
    }));
});
...
ToolbarHandler__cursorHandler$ = (function(o)
{
    ...
    if ((Array__BoxedLength$(o.Data) > 0)) 
    {
      ...
      var state = List__Empty$OverloadSignature_OverloadSignature_();
      _3572 = List__Head$OverloadSignature_OverloadSignature_((function(array)
      {
        return Array__Fold$OverloadSignature____FSharpList_1_OverloadSignature_OverloadSignature____FSharpList_1_OverloadSignature_(folder, state, array);
      })(o.Data)).Signature;
    }
      ...
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((Array__BoxedLength$(o.Data) > 0)) 
          {
            ...
            var state = List__Empty$OverloadSignature_OverloadSignature_();
            _3193 = List__Head$OverloadSignature_OverloadSignature_((function(array)
            {
              return Array__Fold$OverloadSignature____FSharpList_1_OverloadSignature_OverloadSignature____FSharpList_1_OverloadSignature_(folder, state, array);
            })(o.Data)).Signature;
          }
...
WebRequest__AsyncGetResponse$ = (function(req,unitVar1)
{
    return Async_1_FromContinuations$WebResponse_WebResponse_((function(tupledArg)
    {
      ...
      {
        _935 = UTF8Encoding__GetString$(Replacements__utf8Encoding$(), Stream__get_Contents$(req.requestStream));
      };
      var body = _935;
