...
Events__emitEmpty$String_1String = (function(t,s)
{
    ...
    var _1030;
    return (Events__emitter.emit(name, _1030));
});
            ...
            return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.tabLength")).toString()), Seq__Delay$String_1String((function(___unitVar)
            {
              return Seq__Append$String_1String(Seq__Singleton$String_1String("--pageWidth"), Seq__Delay$String_1String((function(____unitVar)
              {
                return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.preferredLineLength")).toString()), Seq__Delay$String_1String((function(_____unitVar)
                {
                  ...
                  {
                    _5400 = Seq__Singleton$String_1String("--semicolonEOL");
                  }
                  else
                  {
                    _5400 = Seq__Empty$String_1String();
                  };
                  return Seq__Append$String_1String(_5400, Seq__Delay$String_1String((function(______unitVar)
                  {
                    var _5472;
                    if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceBeforeArgument"))) 
                    {
                      _5472 = Seq__Singleton$String_1String("--noSpaceBeforeArgument");
                    }
                    else
                    {
                      _5472 = Seq__Empty$String_1String();
                    };
                    return Seq__Append$String_1String(_5472, Seq__Delay$String_1String((function(_______unitVar)
                    {
                      var _5485;
                      if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceBeforeColon"))) 
                      {
                        _5485 = Seq__Singleton$String_1String("--noSpaceBeforeColon");
                      }
                      else
                      {
                        _5485 = Seq__Empty$String_1String();
                      };
                      return Seq__Append$String_1String(_5485, Seq__Delay$String_1String((function(________unitVar)
                      {
                        var _5498;
                        if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAfterComma"))) 
                        {
                          _5498 = Seq__Singleton$String_1String("--noSpaceAfterComma");
                        }
                        else
                        {
                          _5498 = Seq__Empty$String_1String();
                        };
                        return Seq__Append$String_1String(_5498, Seq__Delay$String_1String((function(_________unitVar)
                        {
                          var _5511;
                          if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAfterSemiColon"))) 
                          {
                            _5511 = Seq__Singleton$String_1String("--noSpaceAfterSemiColon");
                          }
                          else
                          {
                            _5511 = Seq__Empty$String_1String();
                          };
                          return Seq__Append$String_1String(_5511, Seq__Delay$String_1String((function(__________unitVar)
                          {
                            var _5524;
                            if ((((window.atom).config).get("atom-fsharp.FormatDocument.IndentOnTryWith"))) 
                            {
                              _5524 = Seq__Singleton$String_1String("--indentOnTryWith");
                            }
                            else
                            {
                              _5524 = Seq__Empty$String_1String();
                            };
                            return Seq__Append$String_1String(_5524, Seq__Delay$String_1String((function(___________unitVar)
                            {
                              var _5537;
                              if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAroundDelimiter"))) 
                              {
                                _5537 = Seq__Singleton$String_1String("--noSpaceAroundDelimiter");
                              }
                              else
                              {
                                _5537 = Seq__Empty$String_1String();
                              };
                              return Seq__Append$String_1String(_5537, Seq__Delay$String_1String((function(____________unitVar)
                              {
                                var _5550;
                                if ((((window.atom).config).get("atom-fsharp.FormatDocument.ReorderOpenDeclaration"))) 
                                {
                                  _5550 = Seq__Singleton$String_1String("--reorderOpenDeclaration");
                                }
                                else
                                {
                                  _5550 = Seq__Empty$String_1String();
                                };
                                return Seq__Append$String_1String(_5550, Seq__Delay$String_1String((function(_____________unitVar)
                                {
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _5188 = "highlight-symboluse-declaration";
        }
        else
        {
          _5188 = "highlight-symboluse";
        };
        var cls = _5188;
...
Interactive__handleLocation$ = (function(n)
{
    ...
    if (Process__isWin$()) 
    {
      _4778 = (path.join(n.Data, "fsi.exe"));
    }
    else
    {
      _4778 = "fsharpi";
    };
    Interactive__fsipath = _4778;
      ...
      findFsProj = (function(dir)
      {
        if (((fs.lstatSync(dir)).isDirectory())) 
        {
          ...
          else
          {
            ...
            {
              _1926 = dir.substring(0, 0 + dir.lastIndexOf((path.sep)));
            }
            else
            {
              _1926 = "";
...
Process__exec$ = (function(location,linuxCmd,cmd)
{
    ...
    if (Process__isWin$()) 
    {
      _5890 = (child_process.execFile(location, cmd, options, (function(_arg3)
      {
        return (function(_arg2)
        {
          return (function(_arg1)
    ...
    else
    {
      ...
      _5890 = (child_process.execFile(linuxCmd, prms, options, (function(_arg6)
      {
...
Process__notice$ = (function(currentNotification,isError,text,details)
{
    ...
    if ((matchValue.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _3300 = (((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true))));
      }
      else
      {
        _3300 = (((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true))));
      };
      var n = _3300;
...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _4800 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _4800;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
...
Process__spawnWithNotifications$ = (function(location,linuxCmd,cmd)
{
    ...
    {
      _3097 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _3097;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
    var _3113;
    if (Process__isWin$()) 
    {
      _3113 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _3113 = (child_process.spawn(linuxCmd, prms, options));
    };
    var procs = _3113;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _438;
      return Seq__Enumerator$Completion_Completion_(f(_438));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _529;
      return Seq__Enumerator$Object_Object_(f(_529));
    }));
});
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _5572;
      return Seq__Enumerator$String_1String(f(_5572));
    }));
});
    ...
    return Option__Iterate$JQueryMouseEventObject_JQueryMouseEventObject_((function(e)
    {
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((o.Data != "No tooltip information")) 
          {
            _2607 = ((ViewsHelpers__jq$("\u003cdiv/\u003e").text(o.Data)).append(errTip(o.Data)));
          }
          else
          {
            _2607 = (ViewsHelpers__jq$("\u003cdiv/\u003e").text(errTip("")));
          };
          var _ignored0 = (n_.append(String__Replace$(String__Replace$((_2607.html()), "\\n", "\u003c/br\u003e"), "\n", "\u003c/br\u003e")));
