...
{
    Interactive__fsipath = (path.join(n.Data, "fsi.exe"));
});
Interactive__openFsi$ = (function(unitVar0)
{
    ...
    return ((window.atom).workspace).open("F# Interactive", (new OpenEditorOptions___ctor$("right"))).done((function(ed)
    {
      ...
      if ((Option__IsNone$ChildProcess_ChildProcess_(Interactive__fsiProc) && (Interactive__fsipath != ""))) 
      {
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _3358;
      return Seq__Enumerator$Completion_Completion_(f(_3358));
    }));
});
Seq__Delay$Suggestion_Suggestion_ = (function(f)
{
    ...
    {
      var _3449;
      return Seq__Enumerator$Suggestion_Suggestion_(f(_3449));
    }));
});
