...
AsyncBuilder__Zero$ = (function(x,unitVar1)
{
    ...
    {
      var _1966;
      return Async__invokeCont$Unit_Unit_(k, _1966);
    }));
});
...
Async_1_StartImmediate$ = (function(workflow,cancellationToken)
{
    ...
    {
      _2112 = (new CancellationToken___ctor$({Tag: 0.000000}));
    };
    var token = _2112;
    var f = workflow.Item;
    ...
    var __ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg4)
    {
      ...
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _13264 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _13264 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _13264;
          var _13274;
          if (((selected.length) > 0.000000)) 
          {
            _13274 = (selected.text());
          }
          else
          {
            if (flag) 
            {
              _13274 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").last()).find(" span.word-container .word")).text());
            }
            else
            {
              _13274 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").first()).find(" span.word-container .word")).text());
            };
          };
          var text = _13274;
...
AutocompleteProvider__getSuggestion$ = (function(options)
{
    if ((((options.editor.buffer).file) != null)) 
    {
      ...
      {
        _4691 = ((col - 2) - options.prefix.length);
      }
      else
      {
        _4691 = col;
      ...
      return new Promise(function(resolve,reject){(function(unitVar0)
      {
        ...
        else
        {
            ...
            Events__once$Object__Unit_Object__Unit_((new EventType__Errors()), (function(result)
            {
              Events__once$Result_1_Completion____Unit_Result_1_Completion____Unit_((new EventType__Completion()), (function(_result)
              {
                ...
                if ((((options.editor.buffer).lines)[row_].charAt(col_) == "\\")) 
                {
                  ...
                  _4753 = CompletionHelpers__glyph_completion$(prefix, GlyphMaps__unicode_map);
                }
                else
                {
                  AutocompleteProvider__lastResult = {Tag: 1.000000, Value: _result};
                  _4753 = CompletionHelpers__fsharp_completion$(prefix, _result.Data);
                };
                var r = _4753;
          ...
          else
          {
            ...
            if ((((options.editor.buffer).lines)[row_].charAt(col_) == "\\")) 
            {
              _13022 = CompletionHelpers__glyph_completion$(prefix, Option__GetValue$Result_1_Completion___Result_1_Completion___(AutocompleteProvider__lastResult).Data);
            }
            else
            {
              _13022 = CompletionHelpers__fsharp_completion$(prefix, Option__GetValue$Result_1_Completion___Result_1_Completion___(AutocompleteProvider__lastResult).Data);
            };
            var r = _13022;
            if ((Array__BoxedLength$(r) > 0)) 
            {
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              {
                _12692 = dist((___i - 1))((___j - 1));
              }
              else
              {
                _12692 = CompletionHelpers__min3$Int32_Int32((dist((___i - 1))(___j) + 1), (dist(___i)((___j - 1)) + 1), (dist((___i - 1))((___j - 1)) + 1));
              };
              var dval = _12692;
...
{
    var _4647;
    return (((window.atom).workspace).open("atom://config/packages/ionide-fsharp", _4647));
});
            ...
            return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.tabLength")).toString()), Seq__Delay$String_1String((function(___unitVar)
            {
              return Seq__Append$String_1String(Seq__Singleton$String_1String("--pageWidth"), Seq__Delay$String_1String((function(____unitVar)
              {
                return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.preferredLineLength")).toString()), Seq__Delay$String_1String((function(_____unitVar)
                {
                  ...
                  {
                    _4165 = Seq__Singleton$String_1String("--semicolonEOL");
                  }
                  else
                  {
                    _4165 = Seq__Empty$String_1String();
                  };
                  return Seq__Append$String_1String(_4165, Seq__Delay$String_1String((function(______unitVar)
                  {
                    var _4237;
                    if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceBeforeArgument"))) 
                    {
                      _4237 = Seq__Singleton$String_1String("--noSpaceBeforeArgument");
                    }
                    else
                    {
                      _4237 = Seq__Empty$String_1String();
                    };
                    return Seq__Append$String_1String(_4237, Seq__Delay$String_1String((function(_______unitVar)
                    {
                      var _4250;
                      if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceBeforeColon"))) 
                      {
                        _4250 = Seq__Singleton$String_1String("--noSpaceBeforeColon");
                      }
                      else
                      {
                        _4250 = Seq__Empty$String_1String();
                      };
                      return Seq__Append$String_1String(_4250, Seq__Delay$String_1String((function(________unitVar)
                      {
                        var _4263;
                        if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAfterComma"))) 
                        {
                          _4263 = Seq__Singleton$String_1String("--noSpaceAfterComma");
                        }
                        else
                        {
                          _4263 = Seq__Empty$String_1String();
                        };
                        return Seq__Append$String_1String(_4263, Seq__Delay$String_1String((function(_________unitVar)
                        {
                          var _4276;
                          if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAfterSemiColon"))) 
                          {
                            _4276 = Seq__Singleton$String_1String("--noSpaceAfterSemiColon");
                          }
                          else
                          {
                            _4276 = Seq__Empty$String_1String();
                          };
                          return Seq__Append$String_1String(_4276, Seq__Delay$String_1String((function(__________unitVar)
                          {
                            var _4289;
                            if ((((window.atom).config).get("ionide-fsharp.FormatDocument.IndentOnTryWith"))) 
                            {
                              _4289 = Seq__Singleton$String_1String("--indentOnTryWith");
                            }
                            else
                            {
                              _4289 = Seq__Empty$String_1String();
                            };
                            return Seq__Append$String_1String(_4289, Seq__Delay$String_1String((function(___________unitVar)
                            {
                              var _4302;
                              if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAroundDelimiter"))) 
                              {
                                _4302 = Seq__Singleton$String_1String("--noSpaceAroundDelimiter");
                              }
                              else
                              {
                                _4302 = Seq__Empty$String_1String();
                              };
                              return Seq__Append$String_1String(_4302, Seq__Delay$String_1String((function(____________unitVar)
                              {
                                var _4315;
                                if ((((window.atom).config).get("ionide-fsharp.FormatDocument.ReorderOpenDeclaration"))) 
                                {
                                  _4315 = Seq__Singleton$String_1String("--reorderOpenDeclaration");
                                }
                                else
                                {
                                  _4315 = Seq__Empty$String_1String();
                                };
                                return Seq__Append$String_1String(_4315, Seq__Delay$String_1String((function(_____________unitVar)
                                {
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _3961 = "highlight-symboluse-declaration";
        }
        else
        {
          _3961 = "highlight-symboluse";
        };
        var cls = _3961;
...
{
    var _817;
    return LanguageService__send$(LanguageService__request$Unit_Unit_(LanguageService__url$("compilerlocation"), _817));
});
      ...
      findFsProj = (function(dir)
      {
        if (((fs.lstatSync(dir)).isDirectory())) 
        {
          ...
          else
          {
            ...
            {
              _2353 = dir.substring(0, 0 + dir.lastIndexOf((path.sep)));
            }
            else
            {
              _2353 = "";
...
Process__exec$ = (function(location,linuxCmd,cmd)
{
    ...
    if (Process__isWin$()) 
    {
      _4543 = (child_process.execFile(location, cmd, options, (function(_arg3)
      {
    ...
    else
    {
      ...
      _4543 = (child_process.execFile(linuxCmd, prms, options, (function(_arg6)
      {
...
Process__spawn$ = (function(location,linuxCmd,cmd)
{
    ...
    if (Process__isWin$()) 
    {
      _687 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _687 = (child_process.spawn(linuxCmd, prms, options));
    };
    var procs = _687;
    return procs;
});
...
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _4337;
      return Seq__Enumerator$String_1String(f(_4337));
    }));
});
...
ToolbarHandler__cursorHandler$ = (function(o)
{
    ...
    if ((Array__BoxedLength$(o.Data) > 0)) 
    {
      ...
      var state = List__Empty$OverloadSignature_OverloadSignature_();
      _3589 = List__Head$OverloadSignature_OverloadSignature_((function(array)
      {
        return Array__Fold$OverloadSignature____FSharpList_1_OverloadSignature_OverloadSignature____FSharpList_1_OverloadSignature_(folder, state, array);
      })(o.Data)).Signature;
    }
      ...
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((Array__BoxedLength$(o.Data) > 0)) 
          {
            ...
            var state = List__Empty$OverloadSignature_OverloadSignature_();
            _3210 = List__Head$OverloadSignature_OverloadSignature_((function(array)
            {
              return Array__Fold$OverloadSignature____FSharpList_1_OverloadSignature_OverloadSignature____FSharpList_1_OverloadSignature_(folder, state, array);
            })(o.Data)).Signature;
          }
...
WebRequest__AsyncGetResponse$ = (function(req,unitVar1)
{
    return Async_1_FromContinuations$WebResponse_WebResponse_((function(tupledArg)
    {
      ...
      {
        _937 = UTF8Encoding__GetString$(Replacements__utf8Encoding$(), Stream__get_Contents$(req.requestStream));
      };
      var body = _937;
