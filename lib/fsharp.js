    ...
    var ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg3)
    {
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        ...
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _6109 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _6109 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _6109;
            ...
            return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.tabLength")).toString()), Seq__Delay$String_1String((function(___unitVar)
            {
              return Seq__Append$String_1String(Seq__Singleton$String_1String("--pageWidth"), Seq__Delay$String_1String((function(____unitVar)
              {
                return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.preferredLineLength")).toString()), Seq__Delay$String_1String((function(_____unitVar)
                {
                  ...
                  {
                    _4893 = Seq__Singleton$String_1String("--semicolonEOL");
                  }
                  else
                  {
                    _4893 = Seq__Empty$String_1String();
                  };
                  return Seq__Append$String_1String(_4893, Seq__Delay$String_1String((function(______unitVar)
                  {
                    var _4965;
                    if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceBeforeArgument"))) 
                    {
                      _4965 = Seq__Singleton$String_1String("--noSpaceBeforeArgument");
                    }
                    else
                    {
                      _4965 = Seq__Empty$String_1String();
                    };
                    return Seq__Append$String_1String(_4965, Seq__Delay$String_1String((function(_______unitVar)
                    {
                      var _4978;
                      if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceBeforeColon"))) 
                      {
                        _4978 = Seq__Singleton$String_1String("--noSpaceBeforeColon");
                      }
                      else
                      {
                        _4978 = Seq__Empty$String_1String();
                      };
                      return Seq__Append$String_1String(_4978, Seq__Delay$String_1String((function(________unitVar)
                      {
                        var _4991;
                        if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAfterComma"))) 
                        {
                          _4991 = Seq__Singleton$String_1String("--noSpaceAfterComma");
                        }
                        else
                        {
                          _4991 = Seq__Empty$String_1String();
                        };
                        return Seq__Append$String_1String(_4991, Seq__Delay$String_1String((function(_________unitVar)
                        {
                          var _5004;
                          if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAfterSemiColon"))) 
                          {
                            _5004 = Seq__Singleton$String_1String("--noSpaceAfterSemiColon");
                          }
                          else
                          {
                            _5004 = Seq__Empty$String_1String();
                          };
                          return Seq__Append$String_1String(_5004, Seq__Delay$String_1String((function(__________unitVar)
                          {
                            var _5017;
                            if ((((window.atom).config).get("atom-fsharp.FormatDocument.IndentOnTryWith"))) 
                            {
                              _5017 = Seq__Singleton$String_1String("--indentOnTryWith");
                            }
                            else
                            {
                              _5017 = Seq__Empty$String_1String();
                            };
                            return Seq__Append$String_1String(_5017, Seq__Delay$String_1String((function(___________unitVar)
                            {
                              var _5030;
                              if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAroundDelimiter"))) 
                              {
                                _5030 = Seq__Singleton$String_1String("--noSpaceAroundDelimiter");
                              }
                              else
                              {
                                _5030 = Seq__Empty$String_1String();
                              };
                              return Seq__Append$String_1String(_5030, Seq__Delay$String_1String((function(____________unitVar)
                              {
                                var _5043;
                                if ((((window.atom).config).get("atom-fsharp.FormatDocument.ReorderOpenDeclaration"))) 
                                {
                                  _5043 = Seq__Singleton$String_1String("--reorderOpenDeclaration");
                                }
                                else
                                {
                                  _5043 = Seq__Empty$String_1String();
                                };
                                return Seq__Append$String_1String(_5043, Seq__Delay$String_1String((function(_____________unitVar)
                                {
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _4681 = "highlight-symboluse-declaration";
        }
        else
        {
          _4681 = "highlight-symboluse";
        };
        var cls = _4681;
...
Interactive__handleLocation$ = (function(n)
{
    ...
    if (Process__isWin$()) 
    {
      _4271 = (path.join(n.Data, "fsi.exe"));
    }
    else
    {
      _4271 = "fsharpi";
    };
    Interactive__fsipath = _4271;
      ...
      findFsProj = (function(dir)
      {
        if (((fs.lstatSync(dir)).isDirectory())) 
        {
          ...
          else
          {
            ...
            {
              _1270 = dir.substring(0, 0 + dir.lastIndexOf((path.sep)));
            }
            else
            {
              _1270 = "";
...
Process__exec$ = (function(location,linuxCmd,cmd)
{
    ...
    if (Process__isWin$()) 
    {
      _5383 = (child_process.execFile(location, cmd, options, (function(_arg3)
      {
        return (function(_arg2)
        {
          return (function(_arg1)
    ...
    else
    {
      ...
      _5383 = (child_process.execFile(linuxCmd, prms, options, (function(_arg6)
      {
...
Process__notice$ = (function(currentNotification,isError,text,details)
{
    ...
    if ((matchValue.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _2721 = (((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true))));
      }
      else
      {
        _2721 = (((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true))));
      };
      var n = _2721;
...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _4293 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _4293;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
...
Process__spawnWithNotifications$ = (function(location,linuxCmd,cmd)
{
    ...
    {
      _2518 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _2518;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
    var _2534;
    if (Process__isWin$()) 
    {
      _2534 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _2534 = (child_process.spawn(linuxCmd, prms, options));
    };
    var procs = _2534;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _5712;
      return Seq__Enumerator$Completion_Completion_(f(_5712));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _3810;
      return Seq__Enumerator$Object_Object_(f(_3810));
    }));
});
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _5065;
      return Seq__Enumerator$String_1String(f(_5065));
    }));
});
...
ToolbarHandler__format_data$ = (function(tinfo)
{
    ...
    if (String__StartsWith$(ti_, "type")) 
    {
      ...
      _2272 = ti_.substring(0, 0 + (_idx - 1));
    }
    else
    {
      _2272 = ti_;
    ...
    return Option__Iterate$JQueryMouseEventObject_JQueryMouseEventObject_((function(e)
    {
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((o.Data != "No tooltip information")) 
          {
            _1988 = ((ViewsHelpers__jq$("\u003cdiv/\u003e").text(o.Data)).append(errTip(o.Data)));
          }
          else
          {
            _1988 = (ViewsHelpers__jq$("\u003cdiv/\u003e").text(errTip("")));
          };
          var _ignored0 = (n_.append(String__Replace$(String__Replace$((_1988.html()), "\\n", "\u003c/br\u003e"), "\n", "\u003c/br\u003e")));
