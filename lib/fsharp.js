...
AutocompleteService__ask$ = (function(msg_,no,cb,state)
{
    ...
    Option__Iterate$ChildProcess_ChildProcess_((function(c)
    {
      ...
      ((c.stdin).write(msg, AutocompleteService__encoding));
...
AutocompleteService__get_encoding$ = (function()
{
    return "utf-8";
});
AutocompleteService__send$ = (function(msg_,t)
{
    ...
    Option__Iterate$ChildProcess_ChildProcess_((function(c)
    {
      var ignored0 = ((c.stdin).write(msg, AutocompleteService__encoding));
    }), t.Child);
    return t;
});
AutocompleteService__start$ = (function(t)
{
    ...
    var child = _18;
    ((child.stdin).setEncoding(AutocompleteService__encoding));
...
{
    var ignored0 = AutocompleteService__stop$(x.service);
});
...
FSharpIDE__projInit$ = (function(_this,unitVar0)
{
    ...
    var proj = (function(ex)
    {
      return (function(arr)
      {
        ...
        {
          var ignored0 = AutocompleteHandler__parseCurrent$((function(_arg3)
          {
            ;
          }), _this.service);
        }
        else
        {
          ...
          var _ignored0 = AutocompleteHandler__project$(path, (function(_arg2)
          {
            var __ignored0 = AutocompleteHandler__parseCurrent$((function(_arg1)
            {
              ;
            }), _this.service);
          }), _this.service);
...
FSharpIDE__register$ = (function(_this,panel)
{
    ...
    {
      var ignored0 = AutocompleteHandler__parseEditor$(ed, (function(_arg4)
      {
        ;
      }), _this.service);
    })));
    (((window.atom).workspace).onDidChangeActivePaneItem((function(ed)
    {
      return ErrorPanelView__handleEditorChange$(panel, ed);
    })));
    (((window.atom).workspace).onDidChangeActivePaneItem((function(ed)
    {
...
HighlighterHandler__handle$ = (function(lst)
{
    ...
    var action = (function(item)
    {
      ...
      {
        _884 = "highlight-warning";
      }
      else
      {
        _884 = "highlight-error";
      };
      var cls = _884;
...
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _1516;
      return Seq__Enumerator$Object_Object_(f(_1516));
    }));
});
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _1425;
      return Seq__Enumerator$String_1String(f(_1425));
    }));
});
...
AutocompleteService__encoding = AutocompleteService__get_encoding$();
