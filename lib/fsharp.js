    ...
    var __ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg4)
    {
      ...
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _13180 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _13180 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _13180;
          var _13190;
          if (((selected.length) > 0.000000)) 
          {
            _13190 = (selected.text());
          }
          else
          {
            if (flag) 
            {
              _13190 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").last()).find(" span.word-container .word")).text());
            }
            else
            {
              _13190 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").first()).find(" span.word-container .word")).text());
            };
          };
          var text = _13190;
...
AutocompleteProvider__getSuggestion$ = (function(options)
{
    if ((((options.editor.buffer).file) != null)) 
    {
      ...
      {
        _4574 = ((col - 2) - options.prefix.length);
      }
      else
      {
        _4574 = col;
      ...
      return new Promise(function(resolve,reject){(function(unitVar0)
      {
        ...
        else
        {
            ...
            Events__once$Object__Unit_Object__Unit_((new EventType__Errors()), (function(result)
            {
              Events__once$Result_1_Completion____Unit_Result_1_Completion____Unit_((new EventType__Completion()), (function(_result)
              {
                ...
                if ((((options.editor.buffer).lines)[row_].charAt(col_) == "\\")) 
                {
                  ...
                  _4636 = CompletionHelpers__glyph_completion$(prefix, GlyphMaps__unicode_map);
                }
                else
                {
                  AutocompleteProvider__lastResult = {Tag: 1.000000, Value: _result};
                  _4636 = CompletionHelpers__fsharp_completion$(prefix, _result.Data);
                };
                var r = _4636;
          ...
          else
          {
            ...
            if ((((options.editor.buffer).lines)[row_].charAt(col_) == "\\")) 
            {
              _12940 = CompletionHelpers__glyph_completion$(prefix, Option__GetValue$Result_1_Completion___Result_1_Completion___(AutocompleteProvider__lastResult).Data);
            }
            else
            {
              _12940 = CompletionHelpers__fsharp_completion$(prefix, Option__GetValue$Result_1_Completion___Result_1_Completion___(AutocompleteProvider__lastResult).Data);
            };
            var r = _12940;
            if ((Array__BoxedLength$(r) > 0)) 
            {
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              {
                _12572 = dist((___i - 1))((___j - 1));
              }
              else
              {
                _12572 = CompletionHelpers__min3$Int32_Int32((dist((___i - 1))(___j) + 1), (dist(___i)((___j - 1)) + 1), (dist((___i - 1))((___j - 1)) + 1));
              };
              var dval = _12572;
...
{
    var _4530;
    return (((window.atom).workspace).open("atom://config/packages/ionide-fsharp", _4530));
});
            ...
            return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.tabLength")).toString()), Seq__Delay$String_1String((function(___unitVar)
            {
              return Seq__Append$String_1String(Seq__Singleton$String_1String("--pageWidth"), Seq__Delay$String_1String((function(____unitVar)
              {
                return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.preferredLineLength")).toString()), Seq__Delay$String_1String((function(_____unitVar)
                {
                  ...
                  {
                    _3958 = Seq__Singleton$String_1String("--semicolonEOL");
                  }
                  else
                  {
                    _3958 = Seq__Empty$String_1String();
                  };
                  return Seq__Append$String_1String(_3958, Seq__Delay$String_1String((function(______unitVar)
                  {
                    var _4030;
                    if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceBeforeArgument"))) 
                    {
                      _4030 = Seq__Singleton$String_1String("--noSpaceBeforeArgument");
                    }
                    else
                    {
                      _4030 = Seq__Empty$String_1String();
                    };
                    return Seq__Append$String_1String(_4030, Seq__Delay$String_1String((function(_______unitVar)
                    {
                      var _4043;
                      if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceBeforeColon"))) 
                      {
                        _4043 = Seq__Singleton$String_1String("--noSpaceBeforeColon");
                      }
                      else
                      {
                        _4043 = Seq__Empty$String_1String();
                      };
                      return Seq__Append$String_1String(_4043, Seq__Delay$String_1String((function(________unitVar)
                      {
                        var _4056;
                        if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAfterComma"))) 
                        {
                          _4056 = Seq__Singleton$String_1String("--noSpaceAfterComma");
                        }
                        else
                        {
                          _4056 = Seq__Empty$String_1String();
                        };
                        return Seq__Append$String_1String(_4056, Seq__Delay$String_1String((function(_________unitVar)
                        {
                          var _4069;
                          if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAfterSemiColon"))) 
                          {
                            _4069 = Seq__Singleton$String_1String("--noSpaceAfterSemiColon");
                          }
                          else
                          {
                            _4069 = Seq__Empty$String_1String();
                          };
                          return Seq__Append$String_1String(_4069, Seq__Delay$String_1String((function(__________unitVar)
                          {
                            var _4082;
                            if ((((window.atom).config).get("ionide-fsharp.FormatDocument.IndentOnTryWith"))) 
                            {
                              _4082 = Seq__Singleton$String_1String("--indentOnTryWith");
                            }
                            else
                            {
                              _4082 = Seq__Empty$String_1String();
                            };
                            return Seq__Append$String_1String(_4082, Seq__Delay$String_1String((function(___________unitVar)
                            {
                              var _4095;
                              if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAroundDelimiter"))) 
                              {
                                _4095 = Seq__Singleton$String_1String("--noSpaceAroundDelimiter");
                              }
                              else
                              {
                                _4095 = Seq__Empty$String_1String();
                              };
                              return Seq__Append$String_1String(_4095, Seq__Delay$String_1String((function(____________unitVar)
                              {
                                var _4108;
                                if ((((window.atom).config).get("ionide-fsharp.FormatDocument.ReorderOpenDeclaration"))) 
                                {
                                  _4108 = Seq__Singleton$String_1String("--reorderOpenDeclaration");
                                }
                                else
                                {
                                  _4108 = Seq__Empty$String_1String();
                                };
                                return Seq__Append$String_1String(_4108, Seq__Delay$String_1String((function(_____________unitVar)
                                {
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _3754 = "highlight-symboluse-declaration";
        }
        else
        {
          _3754 = "highlight-symboluse";
        };
        var cls = _3754;
      ...
      findFsProj = (function(dir)
      {
        if (((fs.lstatSync(dir)).isDirectory())) 
        {
          ...
          else
          {
            ...
            {
              _1987 = dir.substring(0, 0 + dir.lastIndexOf((path.sep)));
            }
            else
            {
              _1987 = "";
...
Process__exec$ = (function(location,linuxCmd,cmd)
{
    ...
    if (Process__isWin$()) 
    {
      _4336 = (child_process.execFile(location, cmd, options, (function(_arg3)
      {
    ...
    else
    {
      ...
      _4336 = (child_process.execFile(linuxCmd, prms, options, (function(_arg6)
      {
...
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _4130;
      return Seq__Enumerator$String_1String(f(_4130));
    }));
});
...
ToolbarHandler__cursorHandler$ = (function(o)
{
    ...
    if ((Array__BoxedLength$(o.Data) > 0)) 
    {
      ...
      var state = List__Empty$OverloadSignature_OverloadSignature_();
      _3389 = List__Head$OverloadSignature_OverloadSignature_((function(array)
      {
        return Array__Fold$OverloadSignature____FSharpList_1_OverloadSignature_OverloadSignature____FSharpList_1_OverloadSignature_(folder, state, array);
      })(o.Data)).Signature;
    }
      ...
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((Array__BoxedLength$(o.Data) > 0)) 
          {
            ...
            var state = List__Empty$OverloadSignature_OverloadSignature_();
            _3010 = List__Head$OverloadSignature_OverloadSignature_((function(array)
            {
              return Array__Fold$OverloadSignature____FSharpList_1_OverloadSignature_OverloadSignature____FSharpList_1_OverloadSignature_(folder, state, array);
            })(o.Data)).Signature;
          }
