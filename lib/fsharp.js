    ...
    if ((((options.editor.buffer).file) != null)) 
    {
      ...
      return new Promise(function(resolve){(function(unitVar0)
      {
        Events__once$CompletionResult__Unit_CompletionResult__Unit_((new EventType__Completion()), (function(result)
        {
          ...
          {
            return (new Suggestion___ctor$(t.Name, prefix, AutocompleteProvider__getNameFromGlyph$(t.Glyph)));
...
Events__emitEmpty$ = (function(t)
{
    var name = Events__getName$(t);
    var _254;
    Events__log$String_1_Unit_String_Unit_(name, _254);
    var _261;
    return ((window.atom).emit(name, _261));
});
...
Events__log$String_1_Unit_String_Unit_ = (function(name,o)
{
    return ((window.console).log(name, DateTime__get_Now$(), o));
});
...
LanguageService__parseResponse$ = (function(data)
{
    if ((data != null)) 
    {
      ...
      return Seq__Iterate$String_1String((function(s)
      {
        ...
        {
          return Events__emitEmpty$((new EventType__ServerError()));
        }
        else
        {
          if ((s.indexOf("\"Kind\":\"project\"") >= 0)) 
          {
            return Events__emitEmpty$((new EventType__Project()));
          }
          else
          {
...
LanguageService__start$ = (function(unitVar0)
{
    ...
    if (String__StartsWith$(((window.process).platform), "win")) 
    {
      _272 = (child_process.spawn(location));
    }
    else
    {
      _272 = (child_process.spawn("mono", [location]));
    };
    var child = _272;
    ...
    Events__emitEmpty$((new EventType__ServerStart()));
...
LanguageService__stop$ = (function(unitVar0)
{
    ...
    Events__emitEmpty$((new EventType__ServerStop()));
});
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _2833;
      return Seq__Enumerator$Completion_Completion_(f(_2833));
    }));
});
Seq__Delay$Suggestion_Suggestion_ = (function(f)
{
    ...
    {
      var _2924;
      return Seq__Enumerator$Suggestion_Suggestion_(f(_2924));
    }));
});
