...
AutocompleteProvider__getNameFromGlyph$ = (function(i)
{
    if ((i == 0)) 
    {
      return "Class";
          ...
          if ((Array__BoxedLength$(msplit) > 1)) 
          {
            ...
            try
            {
              ...
              if ((result.Kind == "completion")) 
              {
                ...
                {
                  return (new Suggestion___ctor$(t.Name, pref, AutocompleteProvider__getNameFromGlyph$(t.Glyph)));
                }), Seq__Where$Completion_Completion_((function(t)
                {
                  return (t.Name.indexOf(pref) >= 0);
...
FAKE__notice$ = (function(isError,text,details)
{
    if ((FAKE__currentNotification.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _1745 = ((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true)));
      }
      else
      {
        _1745 = ((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true)));
      };
      var n = _1745;
...
FAKE__spawn$ = (function(location,cmd)
{
    ...
    {
      _1560 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _1560 = (child_process.spawn("mono", prms, options));
    };
    var procs = _1560;
...
{
    LanguageService__start$((function(_arg6)
    {
      ;
    }));
...
FSharpIDE__deactivate$ = (function(x,unitVar1)
{
    ...
    (x.subscriptions = []);
    LanguageService__stop$((function(_arg10)
    {
      var status = "Off";
...
FSharpIDE__initialize$ = (function(_this,panel)
{
    ...
    LanguageService__parseEditor$(editor, (function(_arg5)
    {
      ;
    }));
...
FSharpIDE__parseProjectForEditor$ = (function(_this,editor)
{
    ...
    if ((((((editor != undefined) && (editor["buffer"] != undefined)) && ((editor.buffer) != null)) && ((editor.buffer)["file"] != undefined)) && (((editor.buffer).file) != null))) 
    {
      ...
      if (((String__SplitWithoutOptions$(p, ["."])[(Array__BoxedLength$(String__SplitWithoutOptions$(p, ["."])) - 1)] == "fsproj") || ((editor["getGrammar"] != undefined) && (((editor.getGrammar()).name) == "F#")))) 
      {
        ...
        {
          var status = "Waiting for F# file";
          return FSharpIDE__addStatusNotification$(_this, status);
        };
      }
      else
      {
        var _status = "Waiting for F# file";
        return FSharpIDE__addStatusNotification$(_this, _status);
      };
    }
    else
...
FSharpIDE__register$ = (function(_this,panel)
{
    ...
    _this.subscriptions.push(((window.atom).workspace).onDidChangeActivePaneItem((function(ed)
    {
      if (((ed != undefined) && (ed["onDidSave"] != undefined))) 
      {
        return _this.subscriptions.push((ed.onDidSave((function(o)
        {
          return LanguageService__parseEditor$(ed, (function(_arg4)
          {
            ;
          }));
        }))));
...
HighlighterHandler__handle$ = (function(lst)
{
    ...
    var action = (function(item)
    {
      ...
      {
        _1354 = "highlight-warning";
      }
      else
      {
        _1354 = "highlight-error";
      };
      var cls = _1354;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _2613;
      return Seq__Enumerator$Completion_Completion_(f(_2613));
    }));
});
Seq__Delay$Suggestion_Suggestion_ = (function(f)
{
    ...
    {
      var _2704;
      return Seq__Enumerator$Suggestion_Suggestion_(f(_2704));
    }));
});
...
Suggestion___ctor$ = (function(text,replacementPrefix,rightLabel)
{
    var __this = this;
    __this.text = text;
      ...
      var _ignored0 = (n.mousemove((function(e)
      {
        ...
        else
        {
          ...
          TooltipHandler__timer = {Tag: 1.000000, Value: (window.setTimeout((function(_arg1)
          {
            ...
            {
              var path = (((editor.buffer).file).path);
              _945 = LanguageService__tooltip$(path, (pos.row + 1), pos.column, (function(s)
              {
                return (function(_n)
                {
                  try
