...
FAKE__notice$ = (function(isError,text,details)
{
    if ((FAKE__currentNotification.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _2662 = ((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true)));
      }
      else
      {
        _2662 = ((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true)));
      };
      var n = _2662;
...
FAKE__spawn$ = (function(location,cmd)
{
    ...
    {
      _2477 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _2477 = (child_process.spawn("mono", prms, options));
    };
    var procs = _2477;
...
HighlighterHandler__handle$ = (function(o)
{
    ...
    var action = (function(item)
    {
      ...
      {
        _2096 = "highlight-warning";
      }
      else
      {
        _2096 = "highlight-error";
      };
      var cls = _2096;
...
Interactive__get_editor$ = (function()
{
    return {Tag: 0.000000};
});
Interactive__get_fsi$ = (function()
{
    return {Tag: 0.000000};
});
...
Interactive__sendToFsi$ = (function(msg_)
{
    ...
    {
      return ((c.stdin).write(msg, "utf-8"));
    }), Interactive__fsi);
});
Interactive__startFsi$ = (function(unitVar0)
{
    ...
    Interactive__fsi = (function(arg0)
    {
      return {Tag: 1.000000, Value: arg0};
    })(fs);
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _3473;
      return Seq__Enumerator$Completion_Completion_(f(_3473));
    }));
});
Seq__Delay$Suggestion_Suggestion_ = (function(f)
{
    ...
    {
      var _3564;
      return Seq__Enumerator$Suggestion_Suggestion_(f(_3564));
    }));
});
        ...
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          if ((o.Data != "No tooltip information")) 
          {
            ...
            else
            {
              ...
              _1610 = (tip.append(FSharpString__Concat$("", Seq__OfList$String_1String(List__CreateCons$String_1String(TooltipHandler__dashes$(o.Data, emsg), List__CreateCons$String_1String(":: Error - ", List__CreateCons$String_1String(_err.Subcategory, List__CreateCons$String_1String(" ::\n", List__CreateCons$String_1String(emsg, List__Empty$String_1String())))))))));
            };
            var _ignored0 = (n_.append(String__Replace$(String__Replace$((_1610.html()), "\\n", "\u003c/br\u003e"), "\n", "\u003c/br\u003e")));
...
Interactive__editor = Interactive__get_editor$();
Interactive__fsi = Interactive__get_fsi$();
