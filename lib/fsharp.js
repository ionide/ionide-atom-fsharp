...
FAKE__notice$ = (function(isError,text,details)
{
    if ((FAKE__currentNotification.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _2110 = ((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true)));
      }
      else
      {
        _2110 = ((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true)));
      };
      var n = _2110;
...
FAKE__spawn$ = (function(location,cmd)
{
    ...
    {
      _1925 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _1925 = (child_process.spawn("mono", prms, options));
    };
    var procs = _1925;
...
HighlighterHandler__handle$ = (function(o)
{
    ...
    var action = (function(item)
    {
      ...
      {
        _1570 = "highlight-warning";
      }
      else
      {
        _1570 = "highlight-error";
      };
      var cls = _1570;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _2782;
      return Seq__Enumerator$Completion_Completion_(f(_2782));
    }));
});
Seq__Delay$Suggestion_Suggestion_ = (function(f)
{
    ...
    {
      var _2873;
      return Seq__Enumerator$Suggestion_Suggestion_(f(_2873));
    }));
});
