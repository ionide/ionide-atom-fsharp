...
AutocompleteProvider__getSuggestion$ = (function(service,options)
{
    ...
    return new Promise(function(resolve){(function(unitVar0)
    {
      ...
      var ignored0 = LanguageService__parseCurrent$((function(_arg1)
      {
        var _ignored0 = LanguageService__completion$(path, row, col, action, service);
      }), service);
    })()});
});
...
ErrorPanelView__addOutputHandle$ = (function(unitVar0)
{
    return ((window.atom).on("FSharp:Output", (function(msg)
    {
      ...
      var ignored0 = (ViewsHelpers__jq$("#panelOutput").append((function(arg10)
      {
        return clo1(arg10);
      })(msg_)));
      if ((ViewsHelpers__jq$("#panelOutput").isVisible())) 
      {
        var n = ViewsHelpers__jq$("#pane");
        var _ignored0 = (n.scrollTop((n.height())));
      }
      else
      {
        ;
...
ErrorPanelView__handleEditorChange$ = (function(panel,service,editor)
{
    if ((((editor != undefined) && (editor["getGrammar"] != undefined)) && (((editor.getGrammar()).name) == "F#"))) 
    {
      (panel.show());
      return ((editor.buffer).onDidStopChanging((function(_arg2)
      {
        var ignored0 = LanguageService__parseCurrent$((function(_arg1)
        {
          ;
...
FAKE__notice$ = (function(isError,text,details)
{
    if ((FAKE__currentNotification.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _1455 = ((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true)));
      }
      else
      {
        _1455 = ((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true)));
      };
      var n = _1455;
...
FAKE__register$ = (function(unitVar0)
{
    ...
    var proj = (function(ex)
    {
      return (function(arr)
      {
        ...
        {
          return Atom__addCommand$Unit_Unit_("atom-workspace", "FAKE: Build", (function(arg00_)
          {
        ...
        else
        {
          ...
          if (Group__get_Success$(regex)) 
          {
            ...
            Atom__addCommand$Unit_Unit_("atom-workspace", "FAKE: Build", (function(arg00_)
            {
...
FAKE__spawn$ = (function(location,cmd)
{
    ...
    {
      _1270 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _1270 = (child_process.spawn("mono", prms, options));
    };
    var procs = _1270;
...
FSharpIDE___ctor$ = (function(unitVar0)
{
    var __this = this;
    {};
    __this.service = LanguageService__send$("outputmode json\n", LanguageService__start$(LanguageService__create));
});
FSharpIDE__activate$ = (function(x,state)
{
    ...
    var ignored0 = (window.setTimeout((function(_arg7)
    {
      return FSharpIDE__register$(x, panel);
    }), 500.000000));
    var _ignored0 = (window.setTimeout((function(_arg8)
    {
      return FSharpIDE__initialize$(x, panel);
    }), 500.000000));
    var __ignored0 = (window.setTimeout((function(_arg9)
    {
      var service = x.service;
      return atom.commands.add("atom-text-editor", "symbols-view:go-to-declaration", (function(e)
      {
        return FindDeclaration__handle$Unit_Unit_(service, e);
      }));;
    }), 500.000000));
});
FSharpIDE__deactivate$ = (function(x,unitVar1)
{
    var ignored0 = LanguageService__stop$(x.service);
});
...
FSharpIDE__initialize$ = (function(_this,panel)
{
    ...
    ErrorPanelView__handleEditorChange$(panel, _this.service, (((window.atom).workspace).getActiveTextEditor()));
...
FSharpIDE__projInit$ = (function(_this,unitVar0)
{
    var p = (((window.atom).project).getPaths())[0];
    ...
    var proj = (function(ex)
    {
      return (function(arr)
      {
        ...
        if ((projExist.Tag == 0.000000)) 
        {
          var ignored0 = LanguageService__parseCurrent$((function(_arg3)
          {
            ;
          }), _this.service);
        }
        else
        {
          var a = Option__GetValue$String_1String(projExist);
          var path = (((window.atom).project).resolve(a));
          var _ignored0 = LanguageService__project$(path, (function(_arg2)
          {
            var __ignored0 = LanguageService__parseCurrent$((function(_arg1)
            {
              ;
            }), _this.service);
          }), _this.service);
...
FSharpIDE__register$ = (function(_this,panel)
{
    ...
    {
      var ignored0 = LanguageService__parseEditor$(ed, (function(_arg4)
      {
        ;
      }), _this.service);
    })));
    (((window.atom).workspace).onDidChangeActivePaneItem((function(ed)
    {
      return ErrorPanelView__handleEditorChange$(panel, _this.service, ed);
    })));
    (((window.atom).workspace).onDidChangeActivePaneItem((function(ed)
    {
      return (window.setTimeout((function(_arg5)
      {
...
FindDeclaration__handle$Unit_Unit_ = (function(service,e)
{
    var editor = (((window.atom).workspace).getActiveTextEditor());
    ...
    var ignored0 = (function(_service)
    {
      return LanguageService__findDeclaration$(name, line, col, cb, _service);
    })(service);
});
...
HighlighterHandler__handle$ = (function(lst)
{
    ...
    var action = (function(item)
    {
      ...
      {
        _898 = "highlight-warning";
      }
      else
      {
        _898 = "highlight-error";
      };
      var cls = _898;
...
LanguageService__ask$ = (function(msg_,no,cb,state)
{
...
LanguageService__completion$ = (function(fn,line,col,cb,service)
{
    ...
    return LanguageService__ask$(str, 2, cb, service);
});
LanguageService__findDeclaration$ = (function(fn,line,col,cb,service)
{
    ...
    return LanguageService__ask$(str, 1, cb, service);
});
LanguageService__get_create$ = (function()
{
...
LanguageService__parse$ = (function(path,text,cb,service)
{
    var str = (((("parse \"" + path) + "\"\n") + text) + "\n\u003c\u003cEOF\u003e\u003e\n");
    return LanguageService__ask$(str, 2, cb, service);
});
LanguageService__parseCurrent$ = (function(cb,service)
{
    var editor = (((window.atom).workspace).getActiveTextEditor());
    return LanguageService__parseEditor$(editor, cb, service);
});
LanguageService__parseEditor$ = (function(editor,cb,service)
{
    if ((((editor != undefined) && (editor["getGrammar"] != undefined)) && (((editor.getGrammar()).name) == "F#"))) 
    {
      ...
      return LanguageService__parse$(path, text, action, service);
    }
    else
    {
      cb("Error");
...
LanguageService__project$ = (function(s,cb,service)
{
...
LanguageService__send$ = (function(msg_,t)
{
    var msg = String__Replace$(msg_, "﻿", "");
...
LanguageService__start$ = (function(t)
{
...
LanguageService__stop$ = (function(t)
{
    Option__Iterate$ChildProcess_ChildProcess_((function(n)
    {
      return (n.kill("SIGKILL"));
    }), t.Child);
    return (new T___ctor$((new State__Off()), t.State, {Tag: 0.000000}));
});
LanguageService__tooltip$ = (function(fn,line,col,cb,service)
{
...
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _2314;
      return Seq__Enumerator$Object_Object_(f(_2314));
    }));
});
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _2223;
      return Seq__Enumerator$String_1String(f(_2223));
    }));
});
      ...
      var _ignored0 = (n.mousemove((function(e)
      {
        ...
        else
        {
          ...
          TooltipHandler__timer = {Tag: 1.000000, Value: (window.setTimeout((function(_arg1)
          {
            ...
            {
              return LanguageService__tooltip$(path, line, col, cb, _service);
            })(service);
          }), time))};
        };
      })));
...
LanguageService__create = LanguageService__get_create$();
