...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _3357;
      return Seq__Enumerator$Completion_Completion_(f(_3357));
    }));
});
Seq__Delay$Suggestion_Suggestion_ = (function(f)
{
    ...
    {
      var _3448;
      return Seq__Enumerator$Suggestion_Suggestion_(f(_3448));
    }));
});
