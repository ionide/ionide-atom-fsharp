...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _2786;
      return Seq__Enumerator$Completion_Completion_(f(_2786));
    }));
});
Seq__Delay$Suggestion_Suggestion_ = (function(f)
{
    ...
    {
      var _2877;
      return Seq__Enumerator$Suggestion_Suggestion_(f(_2877));
    }));
});
