...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _3400;
      return Seq__Enumerator$Completion_Completion_(f(_3400));
    }));
});
Seq__Delay$Suggestion_Suggestion_ = (function(f)
{
    ...
    {
      var _3491;
      return Seq__Enumerator$Suggestion_Suggestion_(f(_3491));
    }));
});
