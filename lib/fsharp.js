    ...
    var ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg3)
    {
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        ...
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _6160 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _6160 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _6160;
            ...
            return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.tabLength")).toString()), Seq__Delay$String_1String((function(___unitVar)
            {
              return Seq__Append$String_1String(Seq__Singleton$String_1String("--pageWidth"), Seq__Delay$String_1String((function(____unitVar)
              {
                return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.preferredLineLength")).toString()), Seq__Delay$String_1String((function(_____unitVar)
                {
                  ...
                  {
                    _4895 = Seq__Singleton$String_1String("--semicolonEOL");
                  }
                  else
                  {
                    _4895 = Seq__Empty$String_1String();
                  };
                  return Seq__Append$String_1String(_4895, Seq__Delay$String_1String((function(______unitVar)
                  {
                    var _4967;
                    if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceBeforeArgument"))) 
                    {
                      _4967 = Seq__Singleton$String_1String("--noSpaceBeforeArgument");
                    }
                    else
                    {
                      _4967 = Seq__Empty$String_1String();
                    };
                    return Seq__Append$String_1String(_4967, Seq__Delay$String_1String((function(_______unitVar)
                    {
                      var _4980;
                      if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceBeforeColon"))) 
                      {
                        _4980 = Seq__Singleton$String_1String("--noSpaceBeforeColon");
                      }
                      else
                      {
                        _4980 = Seq__Empty$String_1String();
                      };
                      return Seq__Append$String_1String(_4980, Seq__Delay$String_1String((function(________unitVar)
                      {
                        var _4993;
                        if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAfterComma"))) 
                        {
                          _4993 = Seq__Singleton$String_1String("--noSpaceAfterComma");
                        }
                        else
                        {
                          _4993 = Seq__Empty$String_1String();
                        };
                        return Seq__Append$String_1String(_4993, Seq__Delay$String_1String((function(_________unitVar)
                        {
                          var _5006;
                          if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAfterSemiColon"))) 
                          {
                            _5006 = Seq__Singleton$String_1String("--noSpaceAfterSemiColon");
                          }
                          else
                          {
                            _5006 = Seq__Empty$String_1String();
                          };
                          return Seq__Append$String_1String(_5006, Seq__Delay$String_1String((function(__________unitVar)
                          {
                            var _5019;
                            if ((((window.atom).config).get("atom-fsharp.FormatDocument.IndentOnTryWith"))) 
                            {
                              _5019 = Seq__Singleton$String_1String("--indentOnTryWith");
                            }
                            else
                            {
                              _5019 = Seq__Empty$String_1String();
                            };
                            return Seq__Append$String_1String(_5019, Seq__Delay$String_1String((function(___________unitVar)
                            {
                              var _5032;
                              if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAroundDelimiter"))) 
                              {
                                _5032 = Seq__Singleton$String_1String("--noSpaceAroundDelimiter");
                              }
                              else
                              {
                                _5032 = Seq__Empty$String_1String();
                              };
                              return Seq__Append$String_1String(_5032, Seq__Delay$String_1String((function(____________unitVar)
                              {
                                var _5045;
                                if ((((window.atom).config).get("atom-fsharp.FormatDocument.ReorderOpenDeclaration"))) 
                                {
                                  _5045 = Seq__Singleton$String_1String("--reorderOpenDeclaration");
                                }
                                else
                                {
                                  _5045 = Seq__Empty$String_1String();
                                };
                                return Seq__Append$String_1String(_5045, Seq__Delay$String_1String((function(_____________unitVar)
                                {
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _4683 = "highlight-symboluse-declaration";
        }
        else
        {
          _4683 = "highlight-symboluse";
        };
        var cls = _4683;
...
Interactive__handleLocation$ = (function(n)
{
    ...
    if (Process__isWin$()) 
    {
      _4273 = (path.join(n.Data, "fsi.exe"));
    }
    else
    {
      _4273 = "fsharpi";
    };
    Interactive__fsipath = _4273;
...
Process__exec$ = (function(location,linuxCmd,cmd)
{
    ...
    if (Process__isWin$()) 
    {
      _5385 = (child_process.execFile(location, cmd, options, (function(_arg3)
      {
        return (function(_arg2)
        {
          return (function(_arg1)
    ...
    else
    {
      ...
      _5385 = (child_process.execFile(linuxCmd, prms, options, (function(_arg6)
      {
...
Process__notice$ = (function(currentNotification,isError,text,details)
{
    ...
    if ((matchValue.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _2723 = (((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true))));
      }
      else
      {
        _2723 = (((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true))));
      };
      var n = _2723;
...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _4295 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _4295;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
...
Process__spawnWithNotifications$ = (function(location,linuxCmd,cmd)
{
    ...
    {
      _2520 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _2520;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
    var _2536;
    if (Process__isWin$()) 
    {
      _2536 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _2536 = (child_process.spawn(linuxCmd, prms, options));
    };
    var procs = _2536;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _5714;
      return Seq__Enumerator$Completion_Completion_(f(_5714));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _3812;
      return Seq__Enumerator$Object_Object_(f(_3812));
    }));
});
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _5067;
      return Seq__Enumerator$String_1String(f(_5067));
    }));
});
...
ToolbarHandler__format_data$ = (function(tinfo)
{
    ...
    if (String__StartsWith$(ti_, "type")) 
    {
      ...
      _2274 = ti_.substring(0, 0 + (_idx - 1));
    }
    else
    {
      _2274 = ti_;
