    ...
    var ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg3)
    {
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        ...
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _5289 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _5289 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _5289;
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _4573 = "highlight-symboluse-declaration";
        }
        else
        {
          _4573 = "highlight-symboluse";
        };
        var cls = _4573;
...
Interactive__handleLocation$ = (function(n)
{
    ...
    if (Process__isWin$()) 
    {
      _4188 = (path.join(n.Data, "fsi.exe"));
    }
    else
    {
      _4188 = "fsharpi";
    };
    Interactive__fsipath = _4188;
...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _4210 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _4210;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _4892;
      return Seq__Enumerator$Completion_Completion_(f(_4892));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _3727;
      return Seq__Enumerator$Object_Object_(f(_3727));
    }));
});
