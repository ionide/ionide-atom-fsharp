...
AsyncBuilder__Bind$String____Unit_String____Unit_ = (function(x,_arg1,f)
{
    var v = _arg1.Item;
...
AsyncBuilder__Zero$ = (function(x,unitVar1)
{
    ...
    {
      var _1972;
      return Async__invokeCont$Unit_Unit_(k, _1972);
    }));
});
...
Async_1_StartImmediate$ = (function(workflow,cancellationToken)
{
    ...
    {
      _2118 = (new CancellationToken___ctor$({Tag: 0.000000}));
    };
    var token = _2118;
    var f = workflow.Item;
    ...
    var __ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg4)
    {
      ...
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _13247 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _13247 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _13247;
          var _13257;
          if (((selected.length) > 0.000000)) 
          {
            _13257 = (selected.text());
          }
          else
          {
            if (flag) 
            {
              _13257 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").last()).find(" span.word-container .word")).text());
            }
            else
            {
              _13257 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").first()).find(" span.word-container .word")).text());
            };
          };
          var text = _13257;
    ...
    var ___ignored0 = Events__on$((new EventType__Helptext()), (function(n)
    {
      ...
      if (((o != undefined) && ((li.length) > 0.000000))) 
      {
        ...
        if ((List__Length$OverloadSignature_OverloadSignature_(AutocompleteProvider__helptextList) > 0)) 
        {
          ...
          var _____ignored0 = (AutocompleteProvider__helptext.offset(o));
        }
        else
        {
          ;
...
AutocompleteProvider__getSuggestion$ = (function(options)
{
    if ((((options.editor.buffer).file) != null)) 
    {
      ...
      {
        _4695 = ((col - 2) - options.prefix.length);
      }
      else
      {
        _4695 = col;
      ...
      return new Promise(function(resolve,reject){(function(unitVar0)
      {
        ...
        {
          if ((((AutocompleteProvider__isForced || Option__IsNone$Result_1_Completion___Result_1_Completion___(AutocompleteProvider__lastResult)) || (prefix == "")) || (AutocompleteProvider__lastRow != row))) 
          {
            Events__once$Object__Unit_Object__Unit_((new EventType__Errors()), (function(result)
            {
              Events__once$Result_1_Completion____Unit_Result_1_Completion____Unit_((new EventType__Completion()), (function(_result)
              {
                ...
                {
                  AutocompleteProvider__lastResult = {Tag: 1.000000, Value: (new Result_1_Completion_____ctor$Completion___("", GlyphMaps__unicode_map))};
                  _4760 = CompletionHelpers__glyph_completion$(prefix, GlyphMaps__unicode_map);
                }
                else
                {
                  AutocompleteProvider__lastResult = {Tag: 1.000000, Value: _result};
                  _4760 = CompletionHelpers__fsharp_completion$(prefix, _result.Data);
                };
                var r = _4760;
          ...
          else
          {
            ...
            if ((((options.editor.buffer).lines)[row_].charAt(col_) == "\\")) 
            {
              _13005 = CompletionHelpers__glyph_completion$(prefix, Option__GetValue$Result_1_Completion___Result_1_Completion___(AutocompleteProvider__lastResult).Data);
            }
            else
            {
              _13005 = CompletionHelpers__fsharp_completion$(prefix, Option__GetValue$Result_1_Completion___Result_1_Completion___(AutocompleteProvider__lastResult).Data);
            };
            var r = _13005;
            if ((Array__BoxedLength$(r) > 0)) 
            {
...
AutocompleteProvider__helptextSetText$ = (function(i)
{
    ...
    if ((List__Length$OverloadSignature_OverloadSignature_(AutocompleteProvider__helptextList) > 1)) 
    {
      ...
      var _ignored0 = (el.append((function(arg10)
      {
        var clo2 = clo1(arg10);
      ...
      })((i + 1))(List__Length$OverloadSignature_OverloadSignature_(AutocompleteProvider__helptextList))));
    }
    else
    {
      ;
    };
    var __ignored0 = (el.append(String__Replace$(String__Replace$(((ViewsHelpers__jq$("\u003cdiv/\u003e").text(text)).html()), "\\n", "\u003cbr /\u003e"), "\n", "\u003cbr /\u003e")));
});
...
CompletionHelpers__distanceCalc$Char_Char = (function(m,u,n,v)
{
    ...
    for (var _12740 = 1; _12740 <= (m - 1); _12740++)
    {
      (function(i)
      {
        d0[0] = i;
        ...
        for (var j = 1; j <= (n - 1); j++)
        {
          ...
          d0[j] = (1 + CompletionHelpers__min3$Int32_Int32(d1[j], d0[(j - 1)], (d1[(j - 1)] + _12699)));
          null;
        };
...
ErrorLinterProvider__lint$ = (function(editor)
{
    return new Promise(function(resolve,reject){(function(unitVar0)
    {
      Events__once$Result_1_Error____Unit_Result_1_Error____Unit_((new EventType__Errors()), (function(n)
      {
...
EventType__Lint = (function()
{
    var __this = this;
    __this.Tag = 14.000000;
    __this._CaseName = "Lint";
});
...
Events__emitEmpty$String_1String = (function(t,s)
{
    var name = Events__getName$(t);
    var _275;
    return (Events__emitter.emit(name, _275));
});
...
Events__once$Result_1_Completion____Unit_Result_1_Completion____Unit_ = (function(t,func)
{
    var name = Events__getName$(t);
    var s = {contents: {Tag: 0.000000}};
    s.contents = (function(arg0)
...
Events__once$Result_1_Declaration__OpenPromise_Result_1_Declaration__OpenPromise_ = (function(t,func)
{
    var name = Events__getName$(t);
    var s = {contents: {Tag: 0.000000}};
    s.contents = (function(arg0)
...
Events__once$Result_1_Error____Unit_Result_1_Error____Unit_ = (function(t,func)
{
    var name = Events__getName$(t);
    var s = {contents: {Tag: 0.000000}};
    s.contents = (function(arg0)
...
Events__parseAndEmit$Result_1_CompilerLocation_Result_1_CompilerLocation_ = (function(t,s)
{
    return Option__Iterate$Result_1_CompilerLocation_Result_1_CompilerLocation_((function(o)
    {
      var name = Events__getName$(t);
      return (Events__emitter.emit(name, o));
    }), Events__tryParse$Result_1_CompilerLocation_Result_1_CompilerLocation_(s));
});
Events__parseAndEmit$Result_1_Completion___Result_1_Completion___ = (function(t,s)
{
    return Option__Iterate$Result_1_Completion___Result_1_Completion___((function(o)
    {
      var name = Events__getName$(t);
      return (Events__emitter.emit(name, o));
    }), Events__tryParse$Result_1_Completion___Result_1_Completion___(s));
});
Events__parseAndEmit$Result_1_Error___Result_1_Error___ = (function(t,s)
{
    return Option__Iterate$Result_1_Error___Result_1_Error___((function(o)
    {
      var name = Events__getName$(t);
      return (Events__emitter.emit(name, o));
    }), Events__tryParse$Result_1_Error___Result_1_Error___(s));
});
Events__parseAndEmit$Result_1_Helptext_Result_1_Helptext_ = (function(t,s)
{
    return Option__Iterate$Result_1_Helptext_Result_1_Helptext_((function(o)
    {
      var name = Events__getName$(t);
      return (Events__emitter.emit(name, o));
    }), Events__tryParse$Result_1_Helptext_Result_1_Helptext_(s));
});
Events__parseAndEmit$Result_1_Lint___Result_1_Lint___ = (function(t,s)
{
    return Option__Iterate$Result_1_Lint___Result_1_Lint___((function(o)
    {
      var name = Events__getName$(t);
      return (Events__emitter.emit(name, o));
    }), Events__tryParse$Result_1_Lint___Result_1_Lint___(s));
});
Events__parseAndEmit$Result_1_OverloadSignature_____Result_1_OverloadSignature_____ = (function(t,s)
{
    return Option__Iterate$Result_1_OverloadSignature_____Result_1_OverloadSignature_____((function(o)
    {
      var name = Events__getName$(t);
      return (Events__emitter.emit(name, o));
    }), Events__tryParse$Result_1_OverloadSignature_____Result_1_OverloadSignature_____(s));
});
Events__parseAndEmit$Result_1_SymbolUses_Result_1_SymbolUses_ = (function(t,s)
{
    return Option__Iterate$Result_1_SymbolUses_Result_1_SymbolUses_((function(o)
    {
      var name = Events__getName$(t);
      return (Events__emitter.emit(name, o));
    }), Events__tryParse$Result_1_SymbolUses_Result_1_SymbolUses_(s));
});
Events__tryParse$Result_1_CompilerLocation_Result_1_CompilerLocation_ = (function(s)
{
    try
    {
...
Events__tryParse$Result_1_Completion___Result_1_Completion___ = (function(s)
{
    try
    {
      var res = (function(arg0)
...
Events__tryParse$Result_1_Error___Result_1_Error___ = (function(s)
{
    try
    {
      var res = (function(arg0)
...
Events__tryParse$Result_1_Helptext_Result_1_Helptext_ = (function(s)
{
    try
    {
      var res = (function(arg0)
...
Events__tryParse$Result_1_Lint___Result_1_Lint___ = (function(s)
{
    try
    {
      var res = (function(arg0)
...
Events__tryParse$Result_1_OverloadSignature_____Result_1_OverloadSignature_____ = (function(s)
{
    try
    {
      var res = (function(arg0)
...
Events__tryParse$Result_1_SymbolUses_Result_1_SymbolUses_ = (function(s)
{
    try
    {
      var res = (function(arg0)
...
{
    var _4651;
    return (((window.atom).workspace).open("atom://config/packages/ionide-fsharp", _4651));
});
...
FindDeclaration__handle$Object_Object_ = (function(e)
{
    ...
    return Events__once$Result_1_Declaration__OpenPromise_Result_1_Declaration__OpenPromise_((new EventType__FindDecl()), (function(data)
    {
            ...
            return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.tabLength")).toString()), Seq__Delay$String_1String((function(___unitVar)
            {
              return Seq__Append$String_1String(Seq__Singleton$String_1String("--pageWidth"), Seq__Delay$String_1String((function(____unitVar)
              {
                return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.preferredLineLength")).toString()), Seq__Delay$String_1String((function(_____unitVar)
                {
                  ...
                  {
                    _4173 = Seq__Singleton$String_1String("--semicolonEOL");
                  }
                  else
                  {
                    _4173 = Seq__Empty$String_1String();
                  };
                  return Seq__Append$String_1String(_4173, Seq__Delay$String_1String((function(______unitVar)
                  {
                    var _4245;
                    if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceBeforeArgument"))) 
                    {
                      _4245 = Seq__Singleton$String_1String("--noSpaceBeforeArgument");
                    }
                    else
                    {
                      _4245 = Seq__Empty$String_1String();
                    };
                    return Seq__Append$String_1String(_4245, Seq__Delay$String_1String((function(_______unitVar)
                    {
                      var _4258;
                      if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceBeforeColon"))) 
                      {
                        _4258 = Seq__Singleton$String_1String("--noSpaceBeforeColon");
                      }
                      else
                      {
                        _4258 = Seq__Empty$String_1String();
                      };
                      return Seq__Append$String_1String(_4258, Seq__Delay$String_1String((function(________unitVar)
                      {
                        var _4271;
                        if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAfterComma"))) 
                        {
                          _4271 = Seq__Singleton$String_1String("--noSpaceAfterComma");
                        }
                        else
                        {
                          _4271 = Seq__Empty$String_1String();
                        };
                        return Seq__Append$String_1String(_4271, Seq__Delay$String_1String((function(_________unitVar)
                        {
                          var _4284;
                          if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAfterSemiColon"))) 
                          {
                            _4284 = Seq__Singleton$String_1String("--noSpaceAfterSemiColon");
                          }
                          else
                          {
                            _4284 = Seq__Empty$String_1String();
                          };
                          return Seq__Append$String_1String(_4284, Seq__Delay$String_1String((function(__________unitVar)
                          {
                            var _4297;
                            if ((((window.atom).config).get("ionide-fsharp.FormatDocument.IndentOnTryWith"))) 
                            {
                              _4297 = Seq__Singleton$String_1String("--indentOnTryWith");
                            }
                            else
                            {
                              _4297 = Seq__Empty$String_1String();
                            };
                            return Seq__Append$String_1String(_4297, Seq__Delay$String_1String((function(___________unitVar)
                            {
                              var _4310;
                              if ((((window.atom).config).get("ionide-fsharp.FormatDocument.NoSpaceAroundDelimiter"))) 
                              {
                                _4310 = Seq__Singleton$String_1String("--noSpaceAroundDelimiter");
                              }
                              else
                              {
                                _4310 = Seq__Empty$String_1String();
                              };
                              return Seq__Append$String_1String(_4310, Seq__Delay$String_1String((function(____________unitVar)
                              {
                                var _4323;
                                if ((((window.atom).config).get("ionide-fsharp.FormatDocument.ReorderOpenDeclaration"))) 
                                {
                                  _4323 = Seq__Singleton$String_1String("--reorderOpenDeclaration");
                                }
                                else
                                {
                                  _4323 = Seq__Empty$String_1String();
                                };
                                return Seq__Append$String_1String(_4323, Seq__Delay$String_1String((function(_____________unitVar)
                                {
...
HelptextRequest___ctor$ = (function(Symbol)
{
    var __this = this;
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _3969 = "highlight-symboluse-declaration";
        }
        else
        {
          _3969 = "highlight-symboluse";
        };
        var cls = _3969;
...
LanguageService__compilerLocation$ = (function(unitVar0)
{
    var _823;
    return LanguageService__send$(LanguageService__request$Unit_Unit_(LanguageService__url$("compilerlocation"), _823));
});
LanguageService__completion$ = (function(fn,line,col)
{
    return LanguageService__send$(LanguageService__request$PositionRequest_PositionRequest_(LanguageService__url$("completion"), (new PositionRequest___ctor$(fn, line, col, ""))));
});
LanguageService__findDeclaration$ = (function(fn,line,col)
{
    return LanguageService__send$(LanguageService__request$PositionRequest_PositionRequest_(LanguageService__url$("finddeclaration"), (new PositionRequest___ctor$(fn, line, col, ""))));
});
...
{
    return LanguageService__send$(LanguageService__request$HelptextRequest_HelptextRequest_(LanguageService__url$("helptext"), (new HelptextRequest___ctor$(s))));
});
LanguageService__parse$ = (function(path,text)
{
    var lines = String__SplitWithoutOptions$(String__Replace$(text, "﻿", ""), ["\n"]);
    return LanguageService__send$(LanguageService__request$ParseRequest_ParseRequest_(LanguageService__url$("parse"), (new ParseRequest___ctor$(path, true, lines))));
});
...
LanguageService__parseResponse$ = (function(response)
{
    return Seq__Iterate$String_1String((function(s)
    {
      Events__log$String_1_String_1String_String("RESPONSE", s);
      ...
      else
      {
        ...
        else
        {
          ...
          {
            return Events__parseAndEmit$Result_1_Error___Result_1_Error___((new EventType__Errors()), s);
          }
          else
          {
            if ((s.indexOf("\"Kind\":\"completion\"") >= 0)) 
            {
              return Events__parseAndEmit$Result_1_Completion___Result_1_Completion___((new EventType__Completion()), s);
            }
            else
            {
              if ((s.indexOf("\"Kind\":\"symboluse\"") >= 0)) 
              {
                return Events__parseAndEmit$Result_1_SymbolUses_Result_1_SymbolUses_((new EventType__SymbolUse()), s);
              }
              else
              {
                if ((s.indexOf("\"Kind\":\"helptext\"") >= 0)) 
                {
                  return Events__parseAndEmit$Result_1_Helptext_Result_1_Helptext_((new EventType__Helptext()), s);
                }
                else
                {
                  if ((s.indexOf("\"Kind\":\"tooltip\"") >= 0)) 
                  {
                    ...
                    {
                      return Events__parseAndEmit$Result_1_OverloadSignature_____Result_1_OverloadSignature_____((new EventType__Toolbars()), s);
                    }
                    else
                    {
                      return Events__parseAndEmit$Result_1_OverloadSignature_____Result_1_OverloadSignature_____((new EventType__Tooltips()), s);
                    };
                  }
                  else
                  {
                    ...
                    {
                      return Events__parseAndEmit$Result_1_OverloadSignature_____Result_1_OverloadSignature_____((new EventType__FindDecl()), s);
                    }
                    else
                    {
                      if ((s.indexOf("\"Kind\":\"compilerlocation\"") >= 0)) 
                      {
                        return Events__parseAndEmit$Result_1_CompilerLocation_Result_1_CompilerLocation_((new EventType__CompilerLocation()), s);
                      }
                      else
                      {
                        if ((s.indexOf("\"Kind\":\"lint\"") >= 0)) 
                        {
                          return Events__parseAndEmit$Result_1_Lint___Result_1_Lint___((new EventType__Lint()), s);
                        }
                        else
                        {
                          ;
...
{
    return LanguageService__send$(LanguageService__request$ProjectRequest_ProjectRequest_(LanguageService__url$("project"), (new ProjectRequest___ctor$(s))));
});
LanguageService__request$HelptextRequest_HelptextRequest_ = (function(url,data)
{
...
LanguageService__request$Unit_Unit_ = (function(url,data)
{
    return AsyncBuilder__Delay$String___String___(Async__get_async$(), (function(unitVar)
    {
      var r = WebRequest__Create$(url);
...
LanguageService__send$ = (function(req)
{
    return Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$String____Unit_String____Unit_(Async__get_async$(), req, (function(_arg1)
      {
        var r = _arg1;
        LanguageService__parseResponse$(r);
...
LanguageService__start$ = (function(unitVar0)
{
    try
    {
      ...
      if (Process__isWin$()) 
      {
        _416 = "\\ionide-fsharp\\bin\\FsAutoComplete.Suave.exe";
      }
      else
      {
        _416 = "/ionide-fsharp/bin/FsAutoComplete.Suave.exe";
      ...
      LanguageService__compilerLocation$();
...
{
    return LanguageService__send$(LanguageService__request$PositionRequest_PositionRequest_(LanguageService__url$("symboluse"), (new PositionRequest___ctor$(fn, line, col, ""))));
});
LanguageService__toolbar$ = (function(fn,line,col)
{
    LanguageService__toolbarFlag = true;
    return LanguageService__send$(LanguageService__request$PositionRequest_PositionRequest_(LanguageService__url$("tooltip"), (new PositionRequest___ctor$(fn, line, col, ""))));
});
...
Option__GetValue$Result_1_CompilerLocation_Result_1_CompilerLocation_ = (function(option)
{
    return option.Value;;
});
...
Option__GetValue$Result_1_Helptext_Result_1_Helptext_ = (function(option)
{
    return option.Value;;
});
...
Option__IsNone$Result_1_Completion___Result_1_Completion___ = (function(option)
{
    return (!Option__IsSome$Result_1_Completion___Result_1_Completion___(option));
});
...
Option__IsSome$Result_1_Completion___Result_1_Completion___ = (function(option)
{
    return ((option.Tag == 1.000000) && true);
});
...
Option__Iterate$Result_1_CompilerLocation_Result_1_CompilerLocation_ = (function(f,inp)
{
    if ((inp.Tag == 1.000000)) 
    {
      var x = Option__GetValue$Result_1_CompilerLocation_Result_1_CompilerLocation_(inp);
      return f(x);
    }
    else
    {
...
Option__Iterate$Result_1_Completion___Result_1_Completion___ = (function(f,inp)
{
    if ((inp.Tag == 1.000000)) 
    {
      var x = Option__GetValue$Result_1_Completion___Result_1_Completion___(inp);
      return f(x);
    }
    else
    {
...
Option__Iterate$Result_1_Error___Result_1_Error___ = (function(f,inp)
{
    if ((inp.Tag == 1.000000)) 
    {
      var x = Option__GetValue$Result_1_Error___Result_1_Error___(inp);
      return f(x);
    }
    else
    {
...
Option__Iterate$Result_1_Helptext_Result_1_Helptext_ = (function(f,inp)
{
    if ((inp.Tag == 1.000000)) 
    {
      var x = Option__GetValue$Result_1_Helptext_Result_1_Helptext_(inp);
      return f(x);
    }
    else
    {
...
Option__Iterate$Result_1_Lint___Result_1_Lint___ = (function(f,inp)
{
    if ((inp.Tag == 1.000000)) 
    {
      var x = Option__GetValue$Result_1_Lint___Result_1_Lint___(inp);
      return f(x);
    }
    else
    {
...
{
    var editor = (((window.atom).workspace).getActiveTextEditor());
    if (Parser__parseProjectForEditor$(editor)) 
    {
      Events__once$Object__Unit_Object__Unit_((new EventType__Project()), (function(_arg1)
      {
        return LanguageService__parseEditor$(editor);
      }));
    }
    ...
    {
      var ignored0 = Parser__parseProjectForEditor$(ed);
...
Parser__parseProjectForEditor$ = (function(editor)
{
    return (((((((editor != undefined) && (editor["buffer"] != undefined)) && ((editor.buffer) != null)) && ((editor.buffer)["file"] != undefined)) && (((editor.buffer).file) != null)) && ViewsHelpers__isFSharpEditor$(editor)) && (function()
    {
      ...
      findFsProj = (function(dir)
      {
        if (((fs.existsSync(dir)) && ((fs.lstatSync(dir)).isDirectory()))) 
        {
          ...
          else
          {
            ...
            {
              _2361 = dir.substring(0, 0 + dir.lastIndexOf((path.sep)));
            }
            else
            {
              _2361 = "";
      ...
      if ((p != undefined)) 
      {
        ...
        {
          var r = Option__GetValue$String_1String(res);
          LanguageService__project$(r);
          return true;
        };
      }
      else
      {
        Events__emit$String_1String((new EventType__Status()), "Waiting for F# file");
        return false;
      };
    })());
});
...
Process__exec$ = (function(location,linuxCmd,cmd)
{
    ...
    if (Process__isWin$()) 
    {
      _4547 = (child_process.execFile(location, cmd, options, (function(_arg3)
      {
    ...
    else
    {
      ...
      _4547 = (child_process.execFile(linuxCmd, prms, options, (function(_arg6)
      {
...
Process__spawn$ = (function(location,linuxCmd,cmd)
{
    ...
    {
      _465 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _465;
    ...
    try
    {
      _688 = (new Options___ctor$(cwd));
    }
    catch(matchValue){
      _688 = (new Options___ctor$(null));
    };
    var options = _688;
    var _693;
    if (Process__isWin$()) 
    {
      _693 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _693 = (child_process.spawn(linuxCmd, prms, options));
    };
    var procs = _693;
    return procs;
});
...
Result_1_Completion_____ctor$Completion___ = (function(Kind,Data)
{
    var __this = this;
    __this.Kind = Kind;
    __this.Data = Data;
...
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _4345;
      return Seq__Enumerator$String_1String(f(_4345));
    }));
});
...
ToolbarHandler__cursorHandler$ = (function(o)
{
    ...
    if ((Array__BoxedLength$(o.Data) > 0)) 
    {
      ...
      var state = List__Empty$OverloadSignature_OverloadSignature_();
      _3597 = List__Head$OverloadSignature_OverloadSignature_((function(array)
      {
        return Array__Fold$OverloadSignature____FSharpList_1_OverloadSignature_OverloadSignature____FSharpList_1_OverloadSignature_(folder, state, array);
      })(o.Data)).Signature;
    }
      ...
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((Array__BoxedLength$(o.Data) > 0)) 
          {
            ...
            var state = List__Empty$OverloadSignature_OverloadSignature_();
            _3218 = List__Head$OverloadSignature_OverloadSignature_((function(array)
            {
              return Array__Fold$OverloadSignature____FSharpList_1_OverloadSignature_OverloadSignature____FSharpList_1_OverloadSignature_(folder, state, array);
            })(o.Data)).Signature;
          }
...
WebRequest__AsyncGetResponse$ = (function(req,unitVar1)
{
    return Async_1_FromContinuations$WebResponse_WebResponse_((function(tupledArg)
    {
      ...
      {
        _943 = UTF8Encoding__GetString$(Replacements__utf8Encoding$(), Stream__get_Contents$(req.requestStream));
      };
      var body = _943;
