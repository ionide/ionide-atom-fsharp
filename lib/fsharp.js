...
FAKE__notice$ = (function(isError,text,details)
{
    if ((FAKE__currentNotification.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _1740 = ((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true)));
      }
      else
      {
        _1740 = ((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true)));
      };
      var n = _1740;
...
FAKE__spawn$ = (function(location,cmd)
{
    ...
    {
      _1555 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _1555 = (child_process.spawn("mono", prms, options));
    };
    var procs = _1555;
...
HighlighterHandler__handle$ = (function(lst)
{
    ...
    var action = (function(item)
    {
      ...
      {
        _1349 = "highlight-warning";
      }
      else
      {
        _1349 = "highlight-error";
      };
      var cls = _1349;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _2608;
      return Seq__Enumerator$Completion_Completion_(f(_2608));
    }));
});
Seq__Delay$Suggestion_Suggestion_ = (function(f)
{
    ...
    {
      var _2699;
      return Seq__Enumerator$Suggestion_Suggestion_(f(_2699));
    }));
});
