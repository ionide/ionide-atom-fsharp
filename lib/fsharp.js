      ...
      return (function(arr)
      {
        ...
        else
        {
          ...
          if ((MatchCollection__get_Count$(regex) > 0)) 
          {
            ...
            }), Seq__OfList$Int32_Int32(Seq__ToList$Int32_Int32(Range__oneStep$Int32_Int32(1, (MatchCollection__get_Count$(regex) - 1)))));
          }
          else
          {
            var _ignored0 = (((window.atom).commands).add("atom-workspace", "FAKE: Build", (function(arg00_)
...
Interactive__handleLocation$ = (function(n)
{
    ...
    if (Process__isWin$()) 
    {
      _4263 = (path.join(n.Data, "fsi.exe"));
    }
    else
    {
      _4263 = "fsharpi";
    };
    Interactive__fsipath = _4263;
...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _4285 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _4285;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _4730;
      return Seq__Enumerator$Completion_Completion_(f(_4730));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _3802;
      return Seq__Enumerator$Object_Object_(f(_3802));
    }));
});
Seq__Delay$Suggestion_Suggestion_ = (function(f)
{
    ...
    {
      var _4821;
      return Seq__Enumerator$Suggestion_Suggestion_(f(_4821));
    }));
});
