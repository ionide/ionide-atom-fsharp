...
FAKE__notice$ = (function(isError,text,details)
{
    if ((FAKE__currentNotification.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _1705 = ((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true)));
      }
      else
      {
        _1705 = ((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true)));
      };
      var n = _1705;
...
FAKE__spawn$ = (function(location,cmd)
{
    ...
    {
      _1520 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _1520 = (child_process.spawn("mono", prms, options));
    };
    var procs = _1520;
...
HighlighterHandler__handle$ = (function(lst)
{
    ...
    var action = (function(item)
    {
      ...
      {
        _1314 = "highlight-warning";
      }
      else
      {
        _1314 = "highlight-error";
      };
      var cls = _1314;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _2565;
      return Seq__Enumerator$Completion_Completion_(f(_2565));
    }));
});
Seq__Delay$Suggestion_Suggestion_ = (function(f)
{
    ...
    {
      var _2656;
      return Seq__Enumerator$Suggestion_Suggestion_(f(_2656));
    }));
});
