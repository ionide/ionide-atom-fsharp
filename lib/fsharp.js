...
Events__emitEmpty$String_1String = (function(t,s)
{
    ...
    var _268;
    return Events__emitter.emit(name, _268);
});
...
{
    return FAKE__notice$(true, "FAKE error", "FAKE script not found");
});
...
FAKE__handle$Object_Object_ = (function(error,input)
{
    ...
    if (error) 
    {
      FAKE__notice$(true, "FAKE error", output);
    }
    else
    {
...
FAKE__notice$ = (function(isError,text,details)
{
    if ((FAKE__currentNotification.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _2537 = ((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true)));
      }
      else
      {
        _2537 = ((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true)));
      };
      var n = _2537;
...
FAKE__spawn$ = (function(location,cmd)
{
    ...
    if (String__StartsWith$(((window.process).platform), "win")) 
    {
      _2354 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _2354 = (child_process.spawn("sh", prms, options));
    };
    var procs = _2354;
...
HighlighterHandler__handle$ = (function(o)
{
    ...
    var action = (function(item)
    {
      ...
      {
        _1971 = "highlight-warning";
      }
      else
      {
        _1971 = "highlight-error";
      };
      var cls = _1971;
...
Interactive__handleLocation$ = (function(n)
{
    ...
    if (String__StartsWith$(((window.process).platform), "win")) 
    {
      _3005 = (path.join(n.Data, "fsi.exe"));
    }
    else
    {
      _3005 = "fsharpi";
    };
    Interactive__fsipath = _3005;
...
{
    var p = (((window.atom).project).getPaths())[0];
    var fs = (child_process.spawn(Interactive__fsipath, [], (new SpawnOption___ctor$(p))));
...
LanguageService__start$ = (function(unitVar0)
{
    ...
    if (String__StartsWith$(((window.process).platform), "win")) 
    {
      _279 = (child_process.spawn(location));
    }
    else
    {
      _279 = (child_process.spawn("mono", [location]));
    };
    var child = _279;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _3454;
      return Seq__Enumerator$Completion_Completion_(f(_3454));
    }));
});
Seq__Delay$Suggestion_Suggestion_ = (function(f)
{
    ...
    {
      var _3545;
      return Seq__Enumerator$Suggestion_Suggestion_(f(_3545));
    }));
});
...
SpawnOption___ctor$ = (function(cwd)
{
    var __this = this;
    __this.cwd = cwd;
});
    ...
    return Option__Iterate$JQueryMouseEventObject_JQueryMouseEventObject_((function(e)
    {
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          {
            _1821 = ((ViewsHelpers__jq$("\u003cdiv/\u003e").text(o.Data)).append(errTip(o.Data)));
          }
          else
          {
            _1821 = (ViewsHelpers__jq$("\u003cdiv/\u003e").text(errTip("")));
          };
          var _ignored0 = (n_.append(String__Replace$(String__Replace$((_1821.html()), "\\n", "\u003c/br\u003e"), "\n", "\u003c/br\u003e")));
