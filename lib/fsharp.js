    ...
    var ignored0 = (((window.atom).commands).add("atom-text-editor", "fsharp:autocomplete", (function(_arg3)
    {
      if (Option__IsNone$IEmitter_IEmitter_(AutocompleteProvider__emitter)) 
      {
        ...
        var handler = (function(flag)
        {
          ...
          if (flag) 
          {
            _6133 = ((ViewsHelpers__jq$("li.selected").prev()).find(" span.word-container .word"));
          }
          else
          {
            _6133 = ((ViewsHelpers__jq$("li.selected").next()).find(" span.word-container .word"));
          };
          var selected = _6133;
          var _6143;
          ...
          else
          {
            if (flag) 
            {
              _6143 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").last()).find(" span.word-container .word")).text());
            }
            else
            {
              _6143 = (((ViewsHelpers__jq$(".suggestion-list-scroller .list-group li").first()).find(" span.word-container .word")).text());
            };
          };
          var text = _6143;
...
Events__emitEmpty$String_1String = (function(t,s)
{
    ...
    var _299;
    return (Events__emitter.emit(name, _299));
});
            ...
            return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.tabLength")).toString()), Seq__Delay$String_1String((function(___unitVar)
            {
              return Seq__Append$String_1String(Seq__Singleton$String_1String("--pageWidth"), Seq__Delay$String_1String((function(____unitVar)
              {
                return Seq__Append$String_1String(Seq__Singleton$String_1String((((window.atom).config).get("editor.preferredLineLength")).toString()), Seq__Delay$String_1String((function(_____unitVar)
                {
                  ...
                  {
                    _4860 = Seq__Singleton$String_1String("--semicolonEOL");
                  }
                  else
                  {
                    _4860 = Seq__Empty$String_1String();
                  };
                  return Seq__Append$String_1String(_4860, Seq__Delay$String_1String((function(______unitVar)
                  {
                    var _4932;
                    if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceBeforeArgument"))) 
                    {
                      _4932 = Seq__Singleton$String_1String("--noSpaceBeforeArgument");
                    }
                    else
                    {
                      _4932 = Seq__Empty$String_1String();
                    };
                    return Seq__Append$String_1String(_4932, Seq__Delay$String_1String((function(_______unitVar)
                    {
                      var _4945;
                      if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceBeforeColon"))) 
                      {
                        _4945 = Seq__Singleton$String_1String("--noSpaceBeforeColon");
                      }
                      else
                      {
                        _4945 = Seq__Empty$String_1String();
                      };
                      return Seq__Append$String_1String(_4945, Seq__Delay$String_1String((function(________unitVar)
                      {
                        var _4958;
                        if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAfterComma"))) 
                        {
                          _4958 = Seq__Singleton$String_1String("--noSpaceAfterComma");
                        }
                        else
                        {
                          _4958 = Seq__Empty$String_1String();
                        };
                        return Seq__Append$String_1String(_4958, Seq__Delay$String_1String((function(_________unitVar)
                        {
                          var _4971;
                          if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAfterSemiColon"))) 
                          {
                            _4971 = Seq__Singleton$String_1String("--noSpaceAfterSemiColon");
                          }
                          else
                          {
                            _4971 = Seq__Empty$String_1String();
                          };
                          return Seq__Append$String_1String(_4971, Seq__Delay$String_1String((function(__________unitVar)
                          {
                            var _4984;
                            if ((((window.atom).config).get("atom-fsharp.FormatDocument.IndentOnTryWith"))) 
                            {
                              _4984 = Seq__Singleton$String_1String("--indentOnTryWith");
                            }
                            else
                            {
                              _4984 = Seq__Empty$String_1String();
                            };
                            return Seq__Append$String_1String(_4984, Seq__Delay$String_1String((function(___________unitVar)
                            {
                              var _4997;
                              if ((((window.atom).config).get("atom-fsharp.FormatDocument.NoSpaceAroundDelimiter"))) 
                              {
                                _4997 = Seq__Singleton$String_1String("--noSpaceAroundDelimiter");
                              }
                              else
                              {
                                _4997 = Seq__Empty$String_1String();
                              };
                              return Seq__Append$String_1String(_4997, Seq__Delay$String_1String((function(____________unitVar)
                              {
                                var _5010;
                                if ((((window.atom).config).get("atom-fsharp.FormatDocument.ReorderOpenDeclaration"))) 
                                {
                                  _5010 = Seq__Singleton$String_1String("--reorderOpenDeclaration");
                                }
                                else
                                {
                                  _5010 = Seq__Empty$String_1String();
                                };
                                return Seq__Append$String_1String(_5010, Seq__Delay$String_1String((function(_____________unitVar)
                                {
...
HighlightUse__showHighlight$ = (function(data)
{
    ...
    var action = (function(item)
    {
      if ((editor["markBufferRange"] != undefined)) 
      {
        ...
        {
          _4648 = "highlight-symboluse-declaration";
        }
        else
        {
          _4648 = "highlight-symboluse";
        };
        var cls = _4648;
...
Interactive__handleLocation$ = (function(n)
{
    ...
    if (Process__isWin$()) 
    {
      _4238 = (path.join(n.Data, "fsi.exe"));
    }
    else
    {
      _4238 = "fsharpi";
    };
    Interactive__fsipath = _4238;
      ...
      findFsProj = (function(dir)
      {
        if (((fs.lstatSync(dir)).isDirectory())) 
        {
          ...
          else
          {
            ...
            {
              _1281 = dir.substring(0, 0 + dir.lastIndexOf((path.sep)));
            }
            else
            {
              _1281 = "";
...
Process__exec$ = (function(location,linuxCmd,cmd)
{
    ...
    if (Process__isWin$()) 
    {
      _5350 = (child_process.execFile(location, cmd, options, (function(_arg3)
      {
        return (function(_arg2)
        {
          return (function(_arg1)
    ...
    else
    {
      ...
      _5350 = (child_process.execFile(linuxCmd, prms, options, (function(_arg6)
      {
...
Process__notice$ = (function(currentNotification,isError,text,details)
{
    ...
    if ((matchValue.Tag == 0.000000)) 
    {
      ...
      if (isError) 
      {
        _2688 = (((window.atom).notifications).addError(text, (new NotificationsOptions___ctor$(details, true))));
      }
      else
      {
        _2688 = (((window.atom).notifications).addInfo(text, (new NotificationsOptions___ctor$(details, true))));
      };
      var n = _2688;
...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _4260 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _4260;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
...
Process__spawnWithNotifications$ = (function(location,linuxCmd,cmd)
{
    ...
    {
      _2485 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _2485;
    var options = (new Options___ctor$((((window.atom).project).getPaths())[0]));
    var _2501;
    if (Process__isWin$()) 
    {
      _2501 = (child_process.spawn(location, cmd_, options));
    }
    else
    {
      ...
      _2501 = (child_process.spawn(linuxCmd, prms, options));
    };
    var procs = _2501;
...
Seq__Delay$Completion_Completion_ = (function(f)
{
    ...
    {
      var _5683;
      return Seq__Enumerator$Completion_Completion_(f(_5683));
    }));
});
Seq__Delay$Object_Object_ = (function(f)
{
    ...
    {
      var _3777;
      return Seq__Enumerator$Object_Object_(f(_3777));
    }));
});
Seq__Delay$String_1String = (function(f)
{
    ...
    {
      var _5032;
      return Seq__Enumerator$String_1String(f(_5032));
    }));
});
    ...
    return Option__Iterate$JQueryMouseEventObject_JQueryMouseEventObject_((function(e)
    {
      return (function(n)
      {
        if (((ViewsHelpers__jq$("body /deep/ span.fsharp:hover").length) > 0.000000)) 
        {
          ...
          if ((o.Data != "No tooltip information")) 
          {
            _1990 = ((ViewsHelpers__jq$("\u003cdiv/\u003e").text(o.Data)).append(errTip(o.Data)));
          }
          else
          {
            _1990 = (ViewsHelpers__jq$("\u003cdiv/\u003e").text(errTip("")));
          };
          var _ignored0 = (n_.append(String__Replace$(String__Replace$((_1990.html()), "\\n", "\u003c/br\u003e"), "\n", "\u003c/br\u003e")));
